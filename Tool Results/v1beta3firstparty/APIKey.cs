...
namespace GoogleSamplecSharpSample.Toolresultsv1beta3firstparty.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ToolresultsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ToolresultsService</returns>
        public static ToolresultsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Toolresults Service", ex);
            }
        }
    }
}
