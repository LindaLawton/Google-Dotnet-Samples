...
namespace GoogleSamplecSharpSample.Scriptv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ScriptService used to make requests against the Script API</returns>
        public static ScriptService GetScriptService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Script service failed.", ex);
            }
        }
        ...
        /// <returns>ScriptService used to make requests against the Script API</returns>
        private static ScriptService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
