...
namespace GoogleSamplecSharpSample.Scriptv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ScriptService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ScriptService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Script Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Script Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ScriptService failed" + ex.Message);
