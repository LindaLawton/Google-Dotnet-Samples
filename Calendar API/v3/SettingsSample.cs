...
//     Build date: 01/02/2017 22:32:02
...
namespace GoogleSamplecSharpSample.calendarv3.Methods
{
    ...
    public static class SettingsSample
    {
        ...
        public class SettingsListOptionalParms
        {
...
Optional. The default is to return all entries.
        ...
        public class SettingsWatchOptionalParms
        {
            /// Maximum number of entries returned on one result page. By default the value is 100 entries. The page size can never be larger than 250 entries. Optional.
            public int MaxResults { get; set; }  
            /// Token specifying which result page to return. Optional.
...
Optional. The default is to return all entries.
        ...
        /// Documentation https://developers.google.com/calendar/v3/reference/settings/watch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated calendar service.</param>  
        ...
        public static Channel Watch(calendarService service, Channel body, SettingsWatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Settings.Watch(body);

                // Applying optional parameters to the request.                
                request = (SettingsResource.WatchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Settings.Watch failed.", ex);
            }
        }
