...
namespace GoogleSamplecSharpSample.Dataprocv1beta1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static DataprocService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { DataprocService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new DataprocService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Dataproc Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account DataprocService failed" + ex.Message);
                throw new Exception("CreateServiceAccountDataprocFailed", ex);
			}
        }
        ...
        public static DataprocService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
