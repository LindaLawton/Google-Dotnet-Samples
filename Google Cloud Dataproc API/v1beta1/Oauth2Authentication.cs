...
namespace GoogleSamplecSharpSample.Dataprocv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DataprocService used to make requests against the Dataproc API</returns>
        public static DataprocService GetDataprocService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Dataproc service failed.", ex);
            }
        }
        ...
        /// <returns>DataprocService used to make requests against the Dataproc API</returns>
        private static DataprocService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
