...
namespace GoogleSamplecSharpSample.Dataprocv1beta1.Methods
{
    ...
    public static class JobsSample
    {
        ...
        /// Documentation https://developers.google.com/dataproc/v1beta1/reference/jobs/patch
        ...
        public static Job Patch(DataprocService service, string projectId, string jobId, Job body, JobsPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Jobs.Patch(body, projectId, jobId);
