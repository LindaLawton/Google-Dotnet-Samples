...
namespace GoogleSamplecSharpSample.dataprocv1.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/dataproc/v1/reference/operations/list
        ...
        /// Documentation https://developers.google.com/dataproc/v1/reference/operations/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dataproc service.</param>  
        ...
        /// Documentation https://developers.google.com/dataproc/v1/reference/operations/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dataproc service.</param>  
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        /// <returns>EmptyResponse</returns>
        public static Empty Cancel(dataprocService service, string name)
        {
            try
            {
                // Initial validation.
