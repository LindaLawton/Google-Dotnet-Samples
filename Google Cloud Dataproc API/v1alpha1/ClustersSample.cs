...
namespace GoogleSamplecSharpSample.dataprocv1alpha1.Methods
{
    ...
    public static class ClustersSample
    {
        ...
        /// Documentation https://developers.google.com/dataproc/v1alpha1/reference/clusters/create
        ...
        /// Documentation https://developers.google.com/dataproc/v1alpha1/reference/clusters/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dataproc service.</param>  
        /// <param name="projectId">[Required] The ID of the Google Cloud Platform project that the cluster belongs to.</param>
        ...
        /// Documentation https://developers.google.com/dataproc/v1alpha1/reference/clusters/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dataproc service.</param>  
        /// <param name="projectId">[Required] The ID of the Google Cloud Platform project that the cluster belongs to.</param>
        ...
        /// Documentation https://developers.google.com/dataproc/v1alpha1/reference/clusters/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dataproc service.</param>  
        /// <param name="projectId">[Required] The ID of the Google Cloud Platform project that the cluster belongs to.</param>
