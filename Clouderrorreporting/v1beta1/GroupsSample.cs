...
namespace GoogleSamplecSharpSample.Clouderrorreportingv1beta1.Methods
{
    ...
    public static class GroupsSample
    {
        ...
        /// Documentation https://developers.google.com/clouderrorreporting/v1beta1/reference/groups/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Clouderrorreporting service.</param>  
        /// <param name="groupName">[Required] The group resource name. Written as<code>projects/<var>projectID</var>/groups/<var>group_name</var></code>.Call<a href="/error-reporting/reference/rest/v1beta1/projects.groupStats/list"><code>groupStats.list</code></a> to return a list of groups belonging tothis project.Example: <code>projects/my-project-123/groups/my-group</code></param>
        /// <returns>ErrorGroupResponse</returns>
        public static ErrorGroup Get(ClouderrorreportingService service, string groupName)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Groups.Get(groupName).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/clouderrorreporting/v1beta1/reference/groups/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Clouderrorreporting service.</param>  
        /// <param name="name">The group resource name.Example: <code>projects/my-project-123/groups/my-groupid</code></param>
