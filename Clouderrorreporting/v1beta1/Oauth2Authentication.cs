...
namespace GoogleSamplecSharpSample.Clouderrorreportingv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ClouderrorreportingService used to make requests against the Clouderrorreporting API</returns>
        public static ClouderrorreportingService GetClouderrorreportingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Clouderrorreporting service failed.", ex);
            }
        }
        ...
        /// <returns>ClouderrorreportingService used to make requests against the Clouderrorreporting API</returns>
        private static ClouderrorreportingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Clouderrorreporting API service.
