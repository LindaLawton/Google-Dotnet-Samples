...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2betav2beta.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>Deploymentmanagerv2betaService used to make requests against the Deploymentmanagerv2beta API</returns>
        public static Deploymentmanagerv2betaService GetDeploymentmanagerv2betaService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Deploymentmanagerv2beta service failed.", ex);
            }
        }
        ...
        /// <returns>Deploymentmanagerv2betaService used to make requests against the Deploymentmanagerv2beta API</returns>
        private static Deploymentmanagerv2betaService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Deploymentmanagerv2beta API service.
                return new Deploymentmanagerv2betaService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Deploymentmanagerv2beta Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
