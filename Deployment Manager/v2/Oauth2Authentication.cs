...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DeploymentmanagerService used to make requests against the Deploymentmanager API</returns>
        public static DeploymentmanagerService GetDeploymentmanagerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Deploymentmanager service failed.", ex);
            }
        }
        ...
        /// <returns>DeploymentmanagerService used to make requests against the Deploymentmanager API</returns>
        private static DeploymentmanagerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Deploymentmanager API service.
                return new DeploymentmanagerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Deploymentmanager Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
