...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static DeploymentmanagerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DeploymentmanagerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Deploymentmanager Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Deploymentmanager service.
                    return new DeploymentmanagerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Deploymentmanager Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountDeploymentmanagerFailed", ex);
            }
        }
    }
}