...
namespace GoogleSamplecSharpSample.AdExchangeSellerv1_1.Methods
{
    ...
    public static class CustomchannelsSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v1.1/reference/customchannels/list
        ...
        public static CustomChannels List(AdExchangeSellerService service, string adClientId, string adUnitId, CustomchannelsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
