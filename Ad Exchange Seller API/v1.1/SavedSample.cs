...
namespace GoogleSamplecSharpSample.AdExchangeSellerv1_1.Methods
{
    ...
    public static class SavedSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v1.1/reference/saved/generate
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v1.1/reference/saved/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeSeller service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SavedReportsResponse</returns>
        public static SavedReports List(AdExchangeSellerService service, SavedListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
