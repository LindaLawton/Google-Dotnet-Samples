...
namespace GoogleSamplecSharpSample.AdExchangeSellerv1_1.Methods
{
    ...
    public static class AdunitsSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v1.1/reference/adunits/list
        ...
        public static AdUnits List(AdExchangeSellerService service, string adClientId, string customChannelId, AdunitsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
