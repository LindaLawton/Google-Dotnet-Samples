...
// About 
// 
// Unoffical sample for the AdExchangeSeller v2.0 API for C#. 
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.AdExchangeSeller.v2_0/ 
// Install Command: PM>  Install-Package Google.Apis.AdExchangeSeller.v2_0
//
//------------------------------------------------------------------------------  
using Google.Apis.AdExchangeSeller.v2_0;
using Google.Apis.AdExchangeSeller.v2_0.Data;
using System;

namespace GoogleSamplecSharpSample.AdExchangeSellerv2_0.Methods
{
    ...
    public static class SavedSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v2.0/reference/saved/generate
        ...
        public static Report Generate(AdExchangeSellerService service, string accountId, string savedReportId, SavedGenerateOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Saved.Generate(accountId, savedReportId);
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v2.0/reference/saved/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeSeller service.</param>  
        /// <param name="accountId">Account owning the saved reports.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SavedReportsResponse</returns>
        public static SavedReports List(AdExchangeSellerService service, string accountId, SavedListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Saved.List(accountId);
