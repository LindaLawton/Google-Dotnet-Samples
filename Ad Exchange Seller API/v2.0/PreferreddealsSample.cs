...
namespace GoogleSamplecSharpSample.AdExchangeSellerv2_0.Methods
{
    ...
    public static class PreferreddealsSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v2.0/reference/preferreddeals/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeSeller service.</param>  
        /// <param name="accountId">Account owning the deals.</param>
        /// <returns>PreferredDealsResponse</returns>
        public static PreferredDeals List(AdExchangeSellerService service, string accountId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Preferreddeals.List(accountId).Execute();
            }
            catch (Exception ex)
            {
