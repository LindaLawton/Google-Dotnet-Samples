...
using Google.Apis.CloudRuntimeConfig.v1.Data;
using System;

namespace GoogleSamplecSharpSample.CloudRuntimeConfigv1.Methods
{
...
corresponding to `Code.CANCELLED`. 
        /// Documentation https://developers.google.com/cloudruntimeconfig/v1/reference/operations/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudRuntimeConfig service.</param>  
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        /// <param name="body">A valid CloudRuntimeConfig v1 body.</param>
        /// <returns>EmptyResponse</returns>
        public static Empty Cancel(CloudRuntimeConfigService service, string name, CancelOperationRequest body)
        {
            try
            {
                // Initial validation.
