...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class I18nRegionsSample
    {

        public class I18nRegionsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/i18nRegions/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>I18nRegionListResponseResponse</returns>
        public static I18nRegionListResponse List(YouTubeService service, string part, I18nRegionsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.I18nRegions.List(part);

                // Applying optional parameters to the request.                
                request = (I18nRegionsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request I18nRegions.List failed.", ex);
            }
        }
