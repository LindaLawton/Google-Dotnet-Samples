...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class VideoCategoriesSample
    {

        public class VideoCategoriesListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/videoCategories/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>VideoCategoryListResponseResponse</returns>
        public static VideoCategoryListResponse List(YouTubeService service, string part, VideoCategoriesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.VideoCategories.List(part);

                // Applying optional parameters to the request.                
                request = (VideoCategoriesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request VideoCategories.List failed.", ex);
            }
        }
