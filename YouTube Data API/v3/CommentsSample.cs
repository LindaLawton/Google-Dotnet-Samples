    ...
    public static class CommentsSample
    {
        ...
        public static void Delete(YouTubeService service, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.Comments.Delete(id).Execute();
            }
            catch (Exception ex)
            {
...
Note: YouTube currently supports replies only for top-level comments. However, replies to replies may be supported in the future.
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CommentListResponseResponse</returns>
        ...
        public static void MarkAsSpam(YouTubeService service, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.Comments.MarkAsSpam(id).Execute();
            }
            catch (Exception ex)
            {
...
Note: This parameter is only valid if the moderationStatus parameter is also set to rejected.
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void SetModerationStatus(YouTubeService service, string id, string moderationStatus, CommentsSetModerationStatusOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
