...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(YouTubeService service, string id, LiveStreamsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
...
The part properties that you can include in the parameter value are id, snippet, cdn, and status.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LiveStreamResponse</returns>
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LiveStreamListResponseResponse</returns>
