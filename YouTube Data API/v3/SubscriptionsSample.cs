...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class SubscriptionsSample
    {
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/subscriptions/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="id">The id parameter specifies the YouTube subscription ID for the resource that is being deleted. In a subscription resource, the id property specifies the YouTube subscription ID.</param>
        public static void Delete(YouTubeService service, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.Subscriptions.Delete(id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/subscriptions/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        ...
        public static Subscription Insert(YouTubeService service, string part, Subscription body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Subscriptions.Insert(body, part).Execute();
            }
            catch (Exception ex)
            {
        ...
        public class SubscriptionsListOptionalParms
        {
            ...
            public bool MyRecentSubscribers { get; set; }  
...
This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/subscriptions/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="part">The part parameter specifies a comma-separated list of one or more subscription resource properties that the API response will include.
