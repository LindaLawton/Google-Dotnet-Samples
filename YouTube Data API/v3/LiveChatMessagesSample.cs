...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class LiveChatMessagesSample
    {


        /// <summary>
        /// Deletes a chat message. 
        /// Documentation https://developers.google.com/youtube/v3/reference/liveChatMessages/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="id">The id parameter specifies the YouTube chat message ID of the resource that is being deleted.</param>
        public static void Delete(YouTubeService service, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.LiveChatMessages.Delete(id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request LiveChatMessages.Delete failed.", ex);
            }
        }
        ...
        public class LiveChatMessagesListOptionalParms
        {
...
If localized resource details are available in that language, the resource's snippet.localized object will contain the localized values. However, if localized details are not available, the snippet.localized object will contain resource details in the resource's default language.
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/liveChatMessages/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="liveChatId">The liveChatId parameter specifies the ID of the chat whose messages will be returned.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LiveChatMessageListResponseResponse</returns>
        public static LiveChatMessageListResponse List(YouTubeService service, string liveChatId, string part, LiveChatMessagesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.LiveChatMessages.List(liveChatId, part);

                // Applying optional parameters to the request.                
                request = (LiveChatMessagesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request LiveChatMessages.List failed.", ex);
            }
        }
