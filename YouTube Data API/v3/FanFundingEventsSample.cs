...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class FanFundingEventsSample
    {

        public class FanFundingEventsListOptionalParms
        {
...
If localized resource details are available in that language, the resource's snippet.localized object will contain the localized values. However, if localized details are not available, the snippet.localized object will contain resource details in the resource's default language.
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/fanFundingEvents/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="part">The part parameter specifies the fanFundingEvent resource parts that the API response will include. Supported values are id and snippet.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>FanFundingEventListResponseResponse</returns>
        public static FanFundingEventListResponse List(YouTubeService service, string part, FanFundingEventsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.FanFundingEvents.List(part);

                // Applying optional parameters to the request.                
                request = (FanFundingEventsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request FanFundingEvents.List failed.", ex);
            }
        }
