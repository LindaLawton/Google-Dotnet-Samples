...
namespace GoogleSamplecSharpSample.YouTubev3.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static YouTubeService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "YouTube Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account YouTubeService failed" + ex.Message);
