...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class LiveChatBansSample
    {


        /// <summary>
        /// Removes a chat ban. 
        /// Documentation https://developers.google.com/youtube/v3/reference/liveChatBans/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated YouTube service.</param>  
        /// <param name="id">The id parameter identifies the chat ban to remove. The value uniquely identifies both the ban and the chat.</param>
        public static void Delete(YouTubeService service, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.LiveChatBans.Delete(id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request LiveChatBans.Delete failed.", ex);
            }
        }
