...
namespace GoogleSamplecSharpSample.YouTubev3.Methods
{
    ...
    public static class VideoAbuseReportReasonsSample
    {

        public class VideoAbuseReportReasonsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/youtube/v3/reference/videoAbuseReportReasons/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>VideoAbuseReportReasonListResponseResponse</returns>
        public static VideoAbuseReportReasonListResponse List(YouTubeService service, string part, VideoAbuseReportReasonsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.VideoAbuseReportReasons.List(part);

                // Applying optional parameters to the request.                
                request = (VideoAbuseReportReasonsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request VideoAbuseReportReasons.List failed.", ex);
            }
        }
