...
namespace GoogleSamplecSharpSample.Sqladminv1beta4.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SqladminService used to make requests against the Sqladmin API</returns>
        public static SqladminService GetSqladminService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Sqladmin service failed.", ex);
            }
        }
        ...
        /// <returns>SqladminService used to make requests against the Sqladmin API</returns>
        private static SqladminService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Sqladmin API service.
                return new SqladminService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Sqladmin Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
