...
namespace GoogleSamplecSharpSample.Sheetsv4.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static SheetsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
            ...
            {
                Console.WriteLine("Create service account SheetsService failed" + ex.Message);
