...
namespace GoogleSamplecSharpSample.AdExchangeBuyerv1_4.Methods
{
    ...
    public static class PretargetingConfigSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/pretargetingConfig/delete
        ...
        public static void Delete(AdExchangeBuyerService service, string accountId, string configId)
        {
            try
            {
                ...
                // Make the request.
                return service.PretargetingConfig.Delete(accountId, configId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/pretargetingConfig/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeBuyer service.</param>  
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/pretargetingConfig/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeBuyer service.</param>  
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/pretargetingConfig/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeBuyer service.</param>  
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/pretargetingConfig/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AdExchangeBuyer service.</param>  
        /// <param name="accountId">The account id to update the pretargeting config for.</param>
