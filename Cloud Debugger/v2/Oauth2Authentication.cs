...
namespace GoogleSamplecSharpSample.Clouddebuggerv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ClouddebuggerService used to make requests against the Clouddebugger API</returns>
        public static ClouddebuggerService GetClouddebuggerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Clouddebugger service failed.", ex);
            }
        }
        ...
        /// <returns>ClouddebuggerService used to make requests against the Clouddebugger API</returns>
        private static ClouddebuggerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Clouddebugger API service.
                return new ClouddebuggerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Clouddebugger Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
