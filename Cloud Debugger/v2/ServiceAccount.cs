...
namespace GoogleSamplecSharpSample.Clouddebuggerv2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ClouddebuggerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ClouddebuggerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Clouddebugger Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Clouddebugger service.
                    return new ClouddebuggerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Clouddebugger Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountClouddebuggerFailed", ex);
            }
        }
    }
}