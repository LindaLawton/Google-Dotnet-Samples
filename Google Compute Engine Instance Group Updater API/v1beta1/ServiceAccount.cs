...
namespace GoogleSamplecSharpSample.Replicapoolupdaterv1beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ReplicapoolupdaterService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
            ...
            {
                Console.WriteLine("Create service account ReplicapoolupdaterService failed" + ex.Message);
