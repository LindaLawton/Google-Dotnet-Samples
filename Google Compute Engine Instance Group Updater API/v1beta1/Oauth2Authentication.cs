...
namespace GoogleSamplecSharpSample.Replicapoolupdaterv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ReplicapoolupdaterService used to make requests against the Replicapoolupdater API</returns>
        public static ReplicapoolupdaterService GetReplicapoolupdaterService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Replicapoolupdater service failed.", ex);
            }
        }
        ...
        /// <returns>ReplicapoolupdaterService used to make requests against the Replicapoolupdater API</returns>
        private static ReplicapoolupdaterService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Replicapoolupdater API service.
