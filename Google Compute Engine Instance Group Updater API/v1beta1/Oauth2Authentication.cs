...
{  
    public static class Oauth2Example 
    {
        ...
        public static ReplicapoolupdaterService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { ReplicapoolupdaterService.Scope.Cloud-PlatformRead-Only,	//View your data across Google Cloud Platform services
                                                 ReplicapoolupdaterService.Scope.ReplicapoolReadonly,    	//View replica pools
                                                 ReplicapoolupdaterService.Scope.Cloud-Platform,          	//View and manage your data across Google Cloud Platform services
                                                 ReplicapoolupdaterService.Scope.Replicapool};           	//View and manage replica pools
                ...
                return new ReplicapoolupdaterService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Replicapoolupdater Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account ReplicapoolupdaterService failed" + ex.Message);
        ...
        public static ReplicapoolupdaterService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
