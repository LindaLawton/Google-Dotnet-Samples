...
namespace GoogleSamplecSharpSample.TagManagerv1.Methods
{
    ...
    public static class Reauthorize_environmentsSample
    {


        /// <summary>
        /// Re-generates the authorization code for a GTM Environment. 
        /// Documentation https://developers.google.com/tagmanager/v1/reference/reauthorize_environments/update
        ...
        public static Environment Update(TagManagerService service, string accountId, string containerId, string environmentId, Environment body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Reauthorize_environments.Update(body, accountId, containerId, environmentId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Reauthorize_environments.Update failed.", ex);
            }
        }
