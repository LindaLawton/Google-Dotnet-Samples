...
namespace GoogleSamplecSharpSample.TagManagerv1.Methods
{
    ...
    public static class VariablesSample
    {
        ...
        /// Documentation https://developers.google.com/tagmanager/v1/reference/variables/create
        ...
        public static Variable Create(TagManagerService service, string accountId, string containerId, Variable body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Variables.Create(body, accountId, containerId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/tagmanager/v1/reference/variables/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated TagManager service.</param>  
        /// <param name="accountId">The GTM Account ID.</param>
        ...
        public static void Delete(TagManagerService service, string accountId, string containerId, string variableId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Variables.Delete(accountId, containerId, variableId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Gets a GTM Variable. 
        /// Documentation https://developers.google.com/tagmanager/v1/reference/variables/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated TagManager service.</param>  
        /// <param name="accountId">The GTM Account ID.</param>
        ...
        /// <param name="variableId">The GTM Variable ID.</param>
        /// <returns>VariableResponse</returns>
        public static Variable Get(TagManagerService service, string accountId, string containerId, string variableId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Variables.Get(accountId, containerId, variableId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/tagmanager/v1/reference/variables/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated TagManager service.</param>  
        /// <param name="accountId">The GTM Account ID.</param>
        ...
        public static ListVariablesResponse List(TagManagerService service, string accountId, string containerId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Variables.List(accountId, containerId).Execute();
            }
            catch (Exception ex)
            {
