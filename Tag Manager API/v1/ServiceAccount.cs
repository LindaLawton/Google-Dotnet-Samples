...
namespace GoogleSamplecSharpSample.Tag Managerv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static Tag ManagerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new Tag ManagerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Tag Manager Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Tag Manager service.
                    return new Tag ManagerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Tag Manager Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account Tag ManagerService failed" + ex.Message);
