...
namespace GoogleSamplecSharpSample.TagManagerv1.Methods
{
    ...
    public static class Move_foldersSample
    {

        public class Move_foldersUpdateOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/tagmanager/v1/reference/move_folders/update
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Update(TagManagerService service, string accountId, string containerId, string folderId, Folder body, Move_foldersUpdateOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Move_folders.Update(body, accountId, containerId, folderId);

                // Applying optional parameters to the request.                
                request = (Move_foldersResource.UpdateRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Move_folders.Update failed.", ex);
            }
        }
