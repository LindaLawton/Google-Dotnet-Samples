...
namespace GoogleSamplecSharpSample.TagManagerv1.Methods
{
    ...
    public static class EntitiesSample
    {
        ...
        /// Documentation https://developers.google.com/tagmanager/v1/reference/entities/list
        ...
        public static FolderEntities List(TagManagerService service, string accountId, string containerId, string folderId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Entities.List(accountId, containerId, folderId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Entities.List failed.", ex);
            }
        }
