...
namespace GoogleSamplecSharpSample.Peoplev1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static PeopleService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new PeopleService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "People Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "People Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account PeopleService failed" + ex.Message);
