...
namespace GoogleSamplecSharpSample.Doubleclickbidmanagerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DoubleclickbidmanagerService used to make requests against the Doubleclickbidmanager API</returns>
        public static DoubleclickbidmanagerService GetDoubleclickbidmanagerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Doubleclickbidmanager service failed.", ex);
            }
        }
        ...
        /// <returns>DoubleclickbidmanagerService used to make requests against the Doubleclickbidmanager API</returns>
        private static DoubleclickbidmanagerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Doubleclickbidmanager API service.
                return new DoubleclickbidmanagerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Doubleclickbidmanager Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
