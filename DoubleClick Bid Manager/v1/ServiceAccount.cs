...
namespace GoogleSamplecSharpSample.Doubleclickbidmanagerv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static DoubleclickbidmanagerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DoubleclickbidmanagerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Doubleclickbidmanager Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Doubleclickbidmanager service.
                    return new DoubleclickbidmanagerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Doubleclickbidmanager Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountDoubleclickbidmanagerFailed", ex);
            }
        }
    }
}