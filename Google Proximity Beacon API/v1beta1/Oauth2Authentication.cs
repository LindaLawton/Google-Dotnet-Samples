...
namespace GoogleSamplecSharpSample.Proximitybeaconv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ProximitybeaconService used to make requests against the Proximitybeacon API</returns>
        public static ProximitybeaconService GetProximitybeaconService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Proximitybeacon service failed.", ex);
            }
        }
        ...
        /// <returns>ProximitybeaconService used to make requests against the Proximitybeacon API</returns>
        private static ProximitybeaconService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Proximitybeacon API service.
