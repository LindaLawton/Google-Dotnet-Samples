...
namespace GoogleSamplecSharpSample.Proximitybeaconv1beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ProximitybeaconService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ProximitybeaconService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Proximitybeacon Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Proximitybeacon service.
                    return new ProximitybeaconService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Proximitybeacon Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ProximitybeaconService failed" + ex.Message);
