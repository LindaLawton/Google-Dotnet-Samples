...
namespace GoogleSamplecSharpSample.Spannerv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static SpannerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new SpannerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Spanner Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Spanner Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountSpannerFailed", ex);
            }
        }
    }
}