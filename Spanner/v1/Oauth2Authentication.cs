...
namespace GoogleSamplecSharpSample.Spannerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SpannerService used to make requests against the Spanner API</returns>
        public static SpannerService GetSpannerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Spanner service failed.", ex);
            }
        }
        ...
        /// <returns>SpannerService used to make requests against the Spanner API</returns>
        private static SpannerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Spanner API service.
                return new SpannerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Spanner Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
