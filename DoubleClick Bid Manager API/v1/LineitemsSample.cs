...
// About 
// 
// Unoffical sample for the DoubleClickBidManager v1 API for C#. 
...
using Google.Apis.DoubleClickBidManager.v1.Data;
using System;

namespace GoogleSamplecSharpSample.DoubleClickBidManagerv1.Methods
{
  
    public static class LineitemsSample
    {


        /// <summary>
        /// Retrieves line items in CSV format. 
        /// Documentation https://developers.google.com/doubleclickbidmanager/v1/reference/lineitems/downloadlineitems
        ...
        /// <returns>DownloadLineItemsResponseResponse</returns>
        public static DownloadLineItemsResponse Downloadlineitems(DoubleClickBidManagerService service, DownloadLineItemsRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Lineitems.Downloadlineitems(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Lineitems.Downloadlineitems failed.", ex);
            }
        }
