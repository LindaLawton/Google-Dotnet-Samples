...
namespace GoogleSamplecSharpSample.DoubleClickBidManagerv1.Methods
{
    ...
    public static class QueriesSample
    {
        ...
        /// Documentation https://developers.google.com/doubleclickbidmanager/v1/reference/queries/deletequery
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated DoubleClickBidManager service.</param>  
        /// <param name="queryId">Query ID to delete.</param>
        public static void Deletequery(DoubleClickBidManagerService service, string queryId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Queries.Deletequery(queryId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Queries.Deletequery failed.", ex);
            }
        }
        ...
        public static void Runquery(DoubleClickBidManagerService service, string queryId, RunQueryRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.Queries.Runquery(body, queryId).Execute();
            }
            catch (Exception ex)
            {
