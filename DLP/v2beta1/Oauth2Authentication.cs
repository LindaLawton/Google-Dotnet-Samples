...
namespace GoogleSamplecSharpSample.Dlpv2beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DlpService used to make requests against the Dlp API</returns>
        public static DlpService GetDlpService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Dlp service failed.", ex);
            }
        }
        ...
        /// <returns>DlpService used to make requests against the Dlp API</returns>
        private static DlpService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Dlp API service.
                return new DlpService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Dlp Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
