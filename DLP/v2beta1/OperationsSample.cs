...
namespace GoogleSamplecSharpSample.Dlpv2beta1.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// <summary>
        /// Schedules a job scanning content in a Google Cloud Platform datarepository. 
        /// Documentation https://developers.google.com/dlp/v2beta1/reference/operations/create
        ...
        public static GoogleLongrunningOperation Create(DlpService service, GooglePrivacyDlpV2beta1CreateInspectOperationRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Operations.Create(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Operations.Create failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dlp/v2beta1/reference/operations/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dlp service.</param>  
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        /// <param name="body">A valid Dlp v2beta1 body.</param>
        /// <returns>GoogleProtobufEmptyResponse</returns>
        public static GoogleProtobufEmpty Cancel(DlpService service, string name, GoogleLongrunningCancelOperationRequest body)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/dlp/v2beta1/reference/operations/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dlp service.</param>  
        /// <param name="name">The name of the operation resource to be deleted.</param>
        /// <returns>GoogleProtobufEmptyResponse</returns>
        public static GoogleProtobufEmpty Delete(DlpService service, string name)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/dlp/v2beta1/reference/operations/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dlp service.</param>  
        /// <param name="name">The name of the operation resource.</param>
        /// <returns>GoogleLongrunningOperationResponse</returns>
        public static GoogleLongrunningOperation Get(DlpService service, string name)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/dlp/v2beta1/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dlp service.</param>  
        /// <param name="name">The name of the operation's parent resource.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>GoogleLongrunningListOperationsResponseResponse</returns>
        public static GoogleLongrunningListOperationsResponse List(DlpService service, string name, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
