...
namespace GoogleSamplecSharpSample.Gmailv1.Methods
{
    ...
    public static class HistorySample
    {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/history/list
        ...
        /// <returns>ListHistoryResponseResponse</returns>
        public static ListHistoryResponse List(GmailService service, string userId, HistoryListOptionalParms optional = null)
        {
            try
            {
                ...
                var request = service.History.List(userId);
