...
namespace GoogleSamplecSharpSample.gmailv1.Methods
{
    ...
    public static class LabelsSample
    {


        /// <summary>
        /// Creates a new label. 
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/create
        ...
        public static Label Create(gmailService service, string userId, Label body)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.Create(body, userId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated gmail service.</param>  
        /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated user.</param>
        ...
        public static void Delete(gmailService service, string userId, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.Delete(userId, id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated gmail service.</param>  
        /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated user.</param>
        ...
        public static Label Get(gmailService service, string userId, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.Get(userId, id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated gmail service.</param>  
        /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated user.</param>
        ...
        public static ListLabelsResponse List(gmailService service, string userId)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.List(userId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated gmail service.</param>  
        /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated user.</param>
        ...
        public static Label Patch(gmailService service, string userId, string id, Label body)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.Patch(body, userId, id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gmail/v1/reference/labels/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated gmail service.</param>  
        /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated user.</param>
        ...
        public static Label Update(gmailService service, string userId, string id, Label body)
        {
            try
            {
                ...
                // Make the request.
                return service.Labels.Update(body, userId, id).Execute();
            }
            catch (Exception ex)
            {
