...
namespace GoogleSamplecSharpSample.Identitytoolkitv3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>IdentitytoolkitService used to make requests against the Identitytoolkit API</returns>
        public static IdentitytoolkitService GetIdentitytoolkitService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Identitytoolkit service failed.", ex);
            }
        }
        ...
        /// <returns>IdentitytoolkitService used to make requests against the Identitytoolkit API</returns>
        private static IdentitytoolkitService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Identitytoolkit API service.
                return new IdentitytoolkitService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Identitytoolkit Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
