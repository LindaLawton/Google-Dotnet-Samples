...
namespace GoogleSamplecSharpSample.Identitytoolkitv3.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static IdentitytoolkitService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new IdentitytoolkitService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Identitytoolkit Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Identitytoolkit service.
                    return new IdentitytoolkitService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Identitytoolkit Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountIdentitytoolkitFailed", ex);
            }
        }
    }
}