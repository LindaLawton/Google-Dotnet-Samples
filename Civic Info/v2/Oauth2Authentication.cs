...
namespace GoogleSamplecSharpSample.Civicinfov2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CivicinfoService used to make requests against the Civicinfo API</returns>
        public static CivicinfoService GetCivicinfoService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Civicinfo service failed.", ex);
            }
        }
        ...
        /// <returns>CivicinfoService used to make requests against the Civicinfo API</returns>
        private static CivicinfoService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Civicinfo API service.
                return new CivicinfoService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Civicinfo Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
