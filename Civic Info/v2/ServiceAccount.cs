...
namespace GoogleSamplecSharpSample.Civicinfov2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CivicinfoService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CivicinfoService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Civicinfo Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Civicinfo service.
                    return new CivicinfoService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Civicinfo Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCivicinfoFailed", ex);
            }
        }
    }
}