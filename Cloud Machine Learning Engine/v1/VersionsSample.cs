...
namespace GoogleSamplecSharpSample.Cloudmachinelearningenginev1.Methods
{
    ...
    public static class VersionsSample
    {
        ...
        /// </summary>
        /// <param name="service">Authenticated Cloudmachinelearningengine service.</param>  
        /// <param name="name">Required. The name of the version to make the default for the model. Youcan get the names of all the versions of a model by calling[projects.models.versions.list](/ml-engine/reference/rest/v1/projects.models.versions/list).Authorization: `ml.models.update` permission is required on the parent model.</param>
        /// <param name="body">A valid Cloudmachinelearningengine v1 body.</param>
