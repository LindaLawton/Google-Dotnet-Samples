...
namespace GoogleSamplecSharpSample.Cloudmachinelearningenginev1beta1.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/cloudmachinelearningengine/v1beta1/reference/operations/get
        ...
        public static GoogleLongrunning__Operation Get(CloudmachinelearningengineService service, string name)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/cloudmachinelearningengine/v1beta1/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudmachinelearningengine service.</param>  
        /// <param name="name">The name of the operation's parent resource.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>GoogleLongrunning__ListOperationsResponseResponse</returns>
        public static GoogleLongrunning__ListOperationsResponse List(CloudmachinelearningengineService service, string name, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/cloudmachinelearningengine/v1beta1/reference/operations/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudmachinelearningengine service.</param>  
        /// <param name="name">The name of the operation resource to be cancelled.</param>
        /// <returns>GoogleProtobuf__EmptyResponse</returns>
        public static GoogleProtobuf__Empty Cancel(CloudmachinelearningengineService service, string name)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/cloudmachinelearningengine/v1beta1/reference/operations/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudmachinelearningengine service.</param>  
        /// <param name="name">The name of the operation resource to be deleted.</param>
        /// <returns>GoogleProtobuf__EmptyResponse</returns>
        public static GoogleProtobuf__Empty Delete(CloudmachinelearningengineService service, string name)
        {
            try
            {
                // Initial validation.
