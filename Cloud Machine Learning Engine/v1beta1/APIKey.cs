...
namespace GoogleSamplecSharpSample.Cloudmachinelearningenginev1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudmachinelearningengineService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudmachinelearningengineService</returns>
        public static CloudmachinelearningengineService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudmachinelearningengine Service", ex);
            }
        }
    }
}
