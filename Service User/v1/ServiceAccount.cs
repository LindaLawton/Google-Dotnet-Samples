...
namespace GoogleSamplecSharpSample.Serviceuserv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ServiceuserService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ServiceuserService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Serviceuser Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Serviceuser service.
                    return new ServiceuserService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Serviceuser Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountServiceuserFailed", ex);
            }
        }
    }
}