...
namespace GoogleSamplecSharpSample.Serviceuserv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ServiceuserService used to make requests against the Serviceuser API</returns>
        public static ServiceuserService GetServiceuserService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Serviceuser service failed.", ex);
            }
        }
        ...
        /// <returns>ServiceuserService used to make requests against the Serviceuser API</returns>
        private static ServiceuserService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Serviceuser API service.
                return new ServiceuserService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Serviceuser Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
