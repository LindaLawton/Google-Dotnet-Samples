    ...
    public static class RoleAssignmentsSample
    {
        ...
        public static void Delete(directoryService service, string customer, string roleAssignmentId)
        {
            try
            {
                ...
                // Make the request.
                return service.RoleAssignments.Delete(customer, roleAssignmentId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="service">Authenticated directory service.</param>  
        /// <param name="customer">Immutable ID of the Google Apps account.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>RoleAssignmentsResponse</returns>
