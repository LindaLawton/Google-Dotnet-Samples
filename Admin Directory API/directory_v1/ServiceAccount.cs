...
namespace GoogleSamplecSharpSample.directorydirectory_v1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static directoryService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
            ...
            {
                Console.WriteLine("Create service account directoryService failed" + ex.Message);
