...
namespace GoogleSamplecSharpSample.directorydirectory_v1.Methods
{
    ...
    public static class PhotosSample
    {
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/photos/delete
        ...
        public static void Delete(directoryService service, string userKey)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Photos.Delete(userKey).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Photos.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/photos/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated directory service.</param>  
        /// <param name="userKey">Email or immutable Id of the user</param>
        /// <returns>UserPhotoResponse</returns>
        public static UserPhoto Get(directoryService service, string userKey)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Photos.Get(userKey).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Photos.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/photos/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated directory service.</param>  
        /// <param name="userKey">Email or immutable Id of the user</param>
        ...
        /// <returns>UserPhotoResponse</returns>
        public static UserPhoto Patch(directoryService service, string userKey, UserPhoto body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Photos.Patch(body, userKey).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Photos.Patch failed.", ex);
            }
        }
