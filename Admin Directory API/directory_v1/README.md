...
Generated date: 01/02/2017 22:31:41 
...
Location: https://www.nuget.org/packages/Google.Apis.admin.directory_v1/ 
Install Command: PM>  Install-Package Google.Apis.admin.directory_v1

```
PM> Install-Package Google.Apis.admin.directory_v1
```
