    ...
    public static class DomainAliasesSample
    {
        ...
        public static void Delete(directoryService service, string customer, string domainAliasName)
        {
            try
            {
                ...
                // Make the request.
                return service.DomainAliases.Delete(customer, domainAliasName).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="service">Authenticated directory service.</param>  
        /// <param name="customer">Immutable id of the Google Apps account.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DomainAliasesResponse</returns>
