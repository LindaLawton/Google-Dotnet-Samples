...
namespace GoogleSamplecSharpSample.directorydirectory_v1.Methods
{
    ...
    public static class AliasesSample
    {
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/aliases/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated directory service.</param>  
        /// <param name="userKey">Email or immutable Id of the user</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AliasesResponse</returns>
        public static Aliases List(directoryService service, string userKey, AliasesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Aliases.List(userKey);
        ...
        public class AliasesWatchOptionalParms
        {
            /// Event on which subscription is intended (if subscribing)
            public string Event { get; set; }  
