    ...
    public static class InappproductsSample
    {
        ...
        public static void Delete(AndroidPublisherService service, string packageName, string sku)
        {
            try
            {
                ...
                // Make the request.
                return service.Inappproducts.Delete(packageName, sku).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>InappproductsListResponseResponse</returns>
