...
namespace GoogleSamplecSharpSample.AndroidPublisherv1_1.Methods
{
    ...
    public static class InapppurchasesSample
    {


        /// <summary>
        /// Checks the purchase and consumption status of an inapp item. 
        /// Documentation https://developers.google.com/androidpublisher/v1.1/reference/inapppurchases/get
        ...
        public static InappPurchase Get(AndroidPublisherService service, string packageName, string productId, string token)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Inapppurchases.Get(packageName, productId, token).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Inapppurchases.Get failed.", ex);
            }
        }
