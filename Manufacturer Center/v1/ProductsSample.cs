...
namespace GoogleSamplecSharpSample.Manufacturercenterv1.Methods
{
    ...
    public static class ProductsSample
    {
        ...
        /// <summary>
        /// Gets the product from a Manufacturer Center account, including productissues.A recently updated product takes some time to be processed before anychanges are visible. While some issues may be available once the producthas been processed, other issues may take days to appear. 
