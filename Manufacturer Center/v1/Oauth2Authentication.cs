...
namespace GoogleSamplecSharpSample.Manufacturercenterv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ManufacturercenterService used to make requests against the Manufacturercenter API</returns>
        public static ManufacturercenterService GetManufacturercenterService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Manufacturercenter service failed.", ex);
            }
        }
        ...
        /// <returns>ManufacturercenterService used to make requests against the Manufacturercenter API</returns>
        private static ManufacturercenterService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Manufacturercenter API service.
                return new ManufacturercenterService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Manufacturercenter Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
