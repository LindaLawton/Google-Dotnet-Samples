...
namespace GoogleSamplecSharpSample.Bigquerydatatransferv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static BigquerydatatransferService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new BigquerydatatransferService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Bigquerydatatransfer Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Bigquerydatatransfer service.
                    return new BigquerydatatransferService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Bigquerydatatransfer Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountBigquerydatatransferFailed", ex);
            }
        }
    }
}