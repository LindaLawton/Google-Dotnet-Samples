...
namespace GoogleSamplecSharpSample.Bigquerydatatransferv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>BigquerydatatransferService used to make requests against the Bigquerydatatransfer API</returns>
        public static BigquerydatatransferService GetBigquerydatatransferService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Bigquerydatatransfer service failed.", ex);
            }
        }
        ...
        /// <returns>BigquerydatatransferService used to make requests against the Bigquerydatatransfer API</returns>
        private static BigquerydatatransferService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Bigquerydatatransfer API service.
                return new BigquerydatatransferService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Bigquerydatatransfer Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
