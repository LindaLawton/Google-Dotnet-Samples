...
namespace GoogleSamplecSharpSample.Firebaserulesv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static FirebaserulesService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new FirebaserulesService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Firebaserules Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Firebaserules service.
                    return new FirebaserulesService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Firebaserules Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountFirebaserulesFailed", ex);
            }
        }
    }
}