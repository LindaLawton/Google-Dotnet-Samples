...
namespace GoogleSamplecSharpSample.Firebaserulesv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>FirebaserulesService used to make requests against the Firebaserules API</returns>
        public static FirebaserulesService GetFirebaserulesService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Firebaserules service failed.", ex);
            }
        }
        ...
        /// <returns>FirebaserulesService used to make requests against the Firebaserules API</returns>
        private static FirebaserulesService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Firebaserules API service.
                return new FirebaserulesService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Firebaserules Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
