...
namespace GoogleSamplecSharpSample.Translatev2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static TranslateService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new TranslateService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Translate Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Translate service.
                    return new TranslateService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Translate Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountTranslateFailed", ex);
            }
        }
    }
}