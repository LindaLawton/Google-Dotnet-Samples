...
namespace GoogleSamplecSharpSample.Translatev2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>TranslateService used to make requests against the Translate API</returns>
        public static TranslateService GetTranslateService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Translate service failed.", ex);
            }
        }
        ...
        /// <returns>TranslateService used to make requests against the Translate API</returns>
        private static TranslateService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Translate API service.
                return new TranslateService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Translate Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
