...
namespace GoogleSamplecSharpSample.Datastorev1beta3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DatastoreService used to make requests against the Datastore API</returns>
        public static DatastoreService GetDatastoreService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Datastore service failed.", ex);
            }
        }
        ...
        /// <returns>DatastoreService used to make requests against the Datastore API</returns>
        private static DatastoreService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
