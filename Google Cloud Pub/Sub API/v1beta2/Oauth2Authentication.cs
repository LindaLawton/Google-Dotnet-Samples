...
//     Build date: 01/02/2017 22:34:09
...
namespace GoogleSamplecSharpSample.Pubsubv1beta2.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static PubsubService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { PubsubService.Scope.Cloud-Platform,	//View and manage your data across Google Cloud Platform services
                                                 PubsubService.Scope.Pubsub};      	//View and manage Pub/Sub topics and subscriptions
                ...
                return new PubsubService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Pubsub Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account PubsubService failed" + ex.Message);
        ...
        public static PubsubService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
