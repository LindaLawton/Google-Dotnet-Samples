...
namespace GoogleSamplecSharpSample.Pubsubv1beta2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static PubsubService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
            ...
            {
                Console.WriteLine("Create service account PubsubService failed" + ex.Message);
