...
namespace GoogleSamplecSharpSample.Containerv1.Methods
{
    ...
    public static class NodePoolsSample
    {
        ...
        /// Documentation https://developers.google.com/container/v1/reference/nodePools/setSize
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).</param>
        /// <param name="zone">The name of the Google Compute Engine[zone](/compute/docs/zones#available) in which the clusterresides.</param>
        /// <param name="clusterId">The name of the cluster to update.</param>
        /// <param name="nodePoolId">The name of the node pool to update.</param>
        /// <param name="body">A valid Container v1 body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SetSize(ContainerService service, string projectId, string zone, string clusterId, string nodePoolId, SetNodePoolSizeRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.NodePools.SetSize(body, projectId, zone, clusterId, nodePoolId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request NodePools.SetSize failed.", ex);
            }
        }

        /// <summary>
        /// Sets the NodeManagement options for a node pool. 
        /// Documentation https://developers.google.com/container/v1/reference/nodePools/setManagement
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).</param>
        ...
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://developers.google.com/console/help/new/#projectnumber).</param>
        /// <param name="zone">The name of the Google Compute Engine[zone](/compute/docs/zones#available) in which the clusterresides.</param>
        ...
        /// Documentation https://developers.google.com/container/v1/reference/nodePools/rollback
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).</param>
        /// <param name="zone">The name of the Google Compute Engine[zone](/compute/docs/zones#available) in which the clusterresides.</param>
        /// <param name="clusterId">The name of the cluster to rollback.</param>
        /// <param name="nodePoolId">The name of the node pool to rollback.</param>
        /// <param name="body">A valid Container v1 body.</param>
        /// <returns>OperationResponse</returns>
        ...
        /// Documentation https://developers.google.com/container/v1/reference/nodePools/autoscaling
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).</param>
        ...
        /// <param name="nodePoolId">The name of the node pool to upgrade.</param>
        /// <param name="body">A valid Container v1 body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Autoscaling(ContainerService service, string projectId, string zone, string clusterId, string nodePoolId, SetNodePoolAutoscalingRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.NodePools.Autoscaling(body, projectId, zone, clusterId, nodePoolId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request NodePools.Autoscaling failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/container/v1/reference/nodePools/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Container service.</param>  
        /// <param name="projectId">The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).</param>
        ...
        /// <param name="body">A valid Container v1 body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Update(ContainerService service, string projectId, string zone, string clusterId, string nodePoolId, UpdateNodePoolRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.NodePools.Update(body, projectId, zone, clusterId, nodePoolId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request NodePools.Update failed.", ex);
            }
        }
