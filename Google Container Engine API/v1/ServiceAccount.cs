...
namespace GoogleSamplecSharpSample.Containerv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ContainerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ContainerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Container Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Container Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ContainerService failed" + ex.Message);
