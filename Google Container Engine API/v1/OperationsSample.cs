...
namespace GoogleSamplecSharpSample.Containerv1.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/container/v1/reference/operations/cancel
        ...
        /// <param name="zone">The name of the Google Compute Engine[zone](/compute/docs/zones#available) in which the operation resides.</param>
        ...
        public static Empty Cancel(ContainerService service, string projectId, string zone, string operationId, CancelOperationRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Operations.Cancel(body, projectId, zone, operationId).Execute();
            }
            catch (Exception ex)
            {
