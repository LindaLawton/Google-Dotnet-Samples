...
namespace GoogleSamplecSharpSample.Containerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ContainerService used to make requests against the Container API</returns>
        public static ContainerService GetContainerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Container service failed.", ex);
            }
        }
        ...
        /// <returns>ContainerService used to make requests against the Container API</returns>
        private static ContainerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
