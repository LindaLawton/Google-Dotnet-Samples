...
namespace GoogleSamplecSharpSample.Containerv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static ContainerService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { ContainerService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new ContainerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Container Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account ContainerService failed" + ex.Message);
                throw new Exception("CreateServiceAccountContainerFailed", ex);
			}
        }
        ...
        public static ContainerService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
