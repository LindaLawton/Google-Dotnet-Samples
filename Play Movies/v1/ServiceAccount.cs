...
namespace GoogleSamplecSharpSample.Playmoviesv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static PlaymoviesService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new PlaymoviesService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Playmovies Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Playmovies service.
                    return new PlaymoviesService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Playmovies Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountPlaymoviesFailed", ex);
            }
        }
    }
}