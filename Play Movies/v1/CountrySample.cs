...
namespace GoogleSamplecSharpSample.Playmoviesv1.Methods
{
    ...
    public static class CountrySample
    {


        /// <summary>
        /// Get a StoreInfo given its video id and country.See _Authentication and Authorization rules_ and_Get methods rules_ for more information about this method. 
        /// Documentation https://developers.google.com/playmovies/v1/reference/country/get
        ...
        /// <param name="videoId">REQUIRED. Video ID.</param>
        /// <param name="country">REQUIRED. Edit country.</param>
        /// <returns>StoreInfoResponse</returns>
        public static StoreInfo Get(PlaymoviesService service, string accountId, string videoId, string country)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Country.Get(accountId, videoId, country).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Country.Get failed.", ex);
            }
        }
