...
namespace GoogleSamplecSharpSample.Playmoviesv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PlaymoviesService used to make requests against the Playmovies API</returns>
        public static PlaymoviesService GetPlaymoviesService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Playmovies service failed.", ex);
            }
        }
        ...
        /// <returns>PlaymoviesService used to make requests against the Playmovies API</returns>
        private static PlaymoviesService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Playmovies API service.
                return new PlaymoviesService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Playmovies Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
