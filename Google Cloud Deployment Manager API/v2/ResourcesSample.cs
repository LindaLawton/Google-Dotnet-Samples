...
namespace GoogleSamplecSharpSample.DeploymentManagerv2.Methods
{
    ...
    public static class ResourcesSample
    {


        /// <summary>
        /// Gets information about a single resource. 
        /// Documentation https://developers.google.com/deploymentmanager/v2/reference/resources/get
        ...
        public static Resource Get(DeploymentManagerService service, string project, string deployment, string resource)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Resources.Get(project, deployment, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Resources.Get failed.", ex);
            }
        }

        public class ResourcesListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/deploymentmanager/v2/reference/resources/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated DeploymentManager service.</param>  
        /// <param name="project">The project ID for this request.</param>
        /// <param name="deployment">The name of the deployment for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ResourcesListResponseResponse</returns>
        public static ResourcesListResponse List(DeploymentManagerService service, string project, string deployment, ResourcesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Resources.List(project, deployment);

                // Applying optional parameters to the request.                
                request = (ResourcesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Resources.List failed.", ex);
            }
        }
