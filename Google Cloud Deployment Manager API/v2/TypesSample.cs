...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/deploymentmanager/v2/reference/types/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TypesListResponseResponse</returns>
        public static TypesListResponse List(DeploymentManagerService service, string project, TypesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
