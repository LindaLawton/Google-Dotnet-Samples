...
namespace GoogleSamplecSharpSample.Plusv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static PlusService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { PlusService.Scope.UserinfoProfile,	//View your basic profile info
                                                 PlusService.Scope.UserinfoEmail,  	//View your email address
                                                 PlusService.Scope.PlusLogin,      	//Know the list of people in your circles, your age range, and language
                ...
                return new PlusService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Plus Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account PlusService failed" + ex.Message);
                throw new Exception("CreateServiceAccountPlusFailed", ex);
			}
        }
