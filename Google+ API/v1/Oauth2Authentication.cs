...
namespace GoogleSamplecSharpSample.Plusv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PlusService used to make requests against the Plus API</returns>
        public static PlusService GetPlusService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Plus service failed.", ex);
            }
        }
        ...
        /// <returns>PlusService used to make requests against the Plus API</returns>
        private static PlusService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
