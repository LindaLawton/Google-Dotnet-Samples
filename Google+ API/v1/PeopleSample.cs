...
//     Build date: 01/02/2017 22:33:56
...
namespace GoogleSamplecSharpSample.plusv1.Methods
{
    ...
    public static class PeopleSample
    {
        ...
        /// Documentation https://developers.google.com/plus/v1/reference/people/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated plus service.</param>  
        ...
        public static PeopleFeed List(plusService service, string userId, string collection, PeopleListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        public class PeopleSearchOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/plus/v1/reference/people/search
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated plus service.</param>  
        /// <param name="query">Specify a query string for full text search of public text in all profiles.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>PeopleFeedResponse</returns>
        public static PeopleFeed Search(plusService service, string query, PeopleSearchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.People.Search(query);

                // Applying optional parameters to the request.                
                request = (PeopleResource.SearchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request People.Search failed.", ex);
            }
        }
