...
namespace GoogleSamplecSharpSample.Booksv1.Methods
{
    ...
    public static class AnnotationDataSample
    {

        public class AnnotationDataGetOptionalParms
        {
            /// For the dictionary layer. Whether or not to allow web definitions.
            public bool? AllowWebDefinitions { get; set; }  
        ...
        /// <returns>AnnotationdataResponse</returns>
        ...
        public class AnnotationDataListOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>AnnotationsdataResponse</returns>
