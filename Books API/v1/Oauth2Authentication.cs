...
namespace GoogleSamplecSharpSample.Booksv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static BooksService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { BooksService.Scope.Books};	//Manage your books
                ...
                return new BooksService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Books Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account BooksService failed" + ex.Message);
                throw new Exception("CreateServiceAccountBooksFailed", ex);
			}
        }
        ...
        public static BooksService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
