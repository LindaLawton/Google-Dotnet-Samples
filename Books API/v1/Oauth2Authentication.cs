...
namespace GoogleSamplecSharpSample.Booksv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>BooksService used to make requests against the Books API</returns>
        public static BooksService GetBooksService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Books service failed.", ex);
            }
        }
        ...
        /// <returns>BooksService used to make requests against the Books API</returns>
        private static BooksService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
