...
//     Build date: 01/02/2017 22:32:00
...
namespace GoogleSamplecSharpSample.Booksv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static BooksService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new BooksService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Books Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Books Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account BooksService failed" + ex.Message);
