...
namespace GoogleSamplecSharpSample.booksv1.Methods
{
    ...
    public static class MembershipSample
    {

        public class MembershipGetOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/books/v1/reference/membership/get
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SeriesmembershipResponse</returns>
        public static Seriesmembership Get(booksService service, string series_id, MembershipGetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                if (series_id == null)
                    throw new ArgumentNullException(series_id);

                // Building the initial request.
                var request = service.Membership.Get(series_id);

                // Applying optional parameters to the request.                
                request = (MembershipResource.GetRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Membership.Get failed.", ex);
            }
        }
