...
namespace GoogleSamplecSharpSample.booksv1.Methods
{
    ...
    public static class AnnotationsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(booksService service, string annotationId, AnnotationsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// </summary>
        /// <param name="service">Authenticated books service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AnnotationsResponse</returns>
