...
namespace GoogleSamplecSharpSample.booksv1.Methods
{
    ...
    public static class MybooksSample
    {

        public class MybooksListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/books/v1/reference/mybooks/list
        ...
        public static Volumes List(booksService service, MybooksListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Mybooks.List();

                // Applying optional parameters to the request.                
                request = (MybooksResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Mybooks.List failed.", ex);
            }
        }
