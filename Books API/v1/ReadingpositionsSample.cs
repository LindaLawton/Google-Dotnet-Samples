...
namespace GoogleSamplecSharpSample.Booksv1.Methods
{
    ...
    public static class ReadingpositionsSample
    {
        ...
        /// <returns>ReadingPositionResponse</returns>
        ...
        /// <param name="optional">Optional paramaters.</param>
        public static void SetPosition(BooksService service, string volumeId, string timestamp, string position, ReadingpositionsSetPositionOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
