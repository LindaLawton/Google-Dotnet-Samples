...
namespace GoogleSamplecSharpSample.booksv1.Methods
{
    ...
    public static class PromoofferSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Accept(booksService service, PromoofferAcceptOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// </summary>
        /// <param name="service">Authenticated books service.</param>  
        /// <param name="optional">Optional paramaters.</param>        public static void Dismiss(booksService service, PromoofferDismissOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// </summary>
        /// <param name="service">Authenticated books service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>OffersResponse</returns>
