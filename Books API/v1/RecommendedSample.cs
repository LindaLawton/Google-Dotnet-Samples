...
namespace GoogleSamplecSharpSample.Booksv1.Methods
{
    ...
    public static class RecommendedSample
    {

        public class RecommendedListOptionalParms
        {
        ...
        public class RecommendedRateOptionalParms
        {
            /// ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating recommendations.
            public string Locale { get; set; }  
            /// String to identify the originator of this request.
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>BooksVolumesRecommendedRateResponseResponse</returns>
