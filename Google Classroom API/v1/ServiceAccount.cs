...
namespace GoogleSamplecSharpSample.Classroomv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ClassroomService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ClassroomService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Classroom Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Classroom service.
                    return new ClassroomService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Classroom Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ClassroomService failed" + ex.Message);
