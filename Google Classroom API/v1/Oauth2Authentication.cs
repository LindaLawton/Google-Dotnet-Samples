...
namespace GoogleSamplecSharpSample.Classroomv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ClassroomService used to make requests against the Classroom API</returns>
        public static ClassroomService GetClassroomService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Classroom service failed.", ex);
            }
        }
        ...
        /// <returns>ClassroomService used to make requests against the Classroom API</returns>
        private static ClassroomService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
