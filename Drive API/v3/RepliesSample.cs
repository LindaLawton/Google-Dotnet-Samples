...
namespace GoogleSamplecSharpSample.drivev3.Methods
{
    ...
    public static class RepliesSample
    {
        ...
        /// <returns>ReplyResponse</returns>
        public static Reply Create(driveService service, string fileId, string commentId, Reply body)
        {
            try
            {
                // Initial validation.
            ...
            {
                throw new Exception("Request Replies.Create failed.", ex);
            }
        }
        ...
        public static void Delete(driveService service, string fileId, string commentId, string replyId)
        {
            try
            {
                ...
                // Make the request.
                return service.Replies.Delete(fileId, commentId, replyId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="fileId">The ID of the file.</param>
        /// <param name="commentId">The ID of the comment.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ReplyListResponse</returns>
        public static ReplyList List(driveService service, string fileId, string commentId, RepliesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// <param name="body">A valid drive v3 body.</param>
        /// <returns>ReplyResponse</returns>
        public static Reply Update(driveService service, string fileId, string commentId, string replyId, Reply body)
        {
            try
            {
                // Initial validation.
