    ...
    public static class ParentsSample
    {
        ...
        public static void Delete(driveService service, string fileId, string parentId)
        {
            try
            {
                ...
                // Make the request.
                return service.Parents.Delete(fileId, parentId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <returns>ParentReferenceResponse</returns>
        public static ParentReference Insert(driveService service, string fileId, ParentReference body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Parents.Insert(body, fileId).Execute();
            }
            catch (Exception ex)
            {
