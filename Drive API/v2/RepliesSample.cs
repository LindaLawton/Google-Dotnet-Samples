...
namespace GoogleSamplecSharpSample.drivev2.Methods
{
    ...
    public static class RepliesSample
    {
        ...
        /// <param name="commentId">The ID of the comment.</param>
        /// <param name="replyId">The ID of the reply.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CommentReplyResponse</returns>
        ...
        /// <param name="fileId">The ID of the file.</param>
        /// <param name="commentId">The ID of the comment.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CommentReplyListResponse</returns>
