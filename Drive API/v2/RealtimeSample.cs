...
namespace GoogleSamplecSharpSample.drivev2.Methods
{
    ...
    public static class RealtimeSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Get(driveService service, string fileId, RealtimeGetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// <param name="service">Authenticated drive service.</param>  
        /// <param name="fileId">The ID of the file that the Realtime API data model is associated with.</param>
        /// <param name="optional">Optional paramaters.</param>        public static void Update(driveService service, string fileId, RealtimeUpdateOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
