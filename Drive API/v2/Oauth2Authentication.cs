...
namespace GoogleSamplecSharpSample.Drivev2.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static DriveService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { DriveService.Scope.DriveMetadataReadonly,	//View metadata for files in your Google Drive
                                                 DriveService.Scope.DrivePhotosReadonly,  	//View the photos, videos and albums in your Google Photos
                                                 DriveService.Scope.DriveAppsReadonly,    	//View your Google Drive apps
