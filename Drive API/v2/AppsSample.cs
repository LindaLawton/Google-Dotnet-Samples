...
namespace GoogleSamplecSharpSample.drivev2.Methods
{
    ...
    public static class AppsSample
    {
        ...
        public class AppsListOptionalParms
        {
            ...
            public string AppFilterExtensions { get; set; }  
            ...
            public string AppFilterMimeTypes { get; set; }  
        ...
        /// Documentation https://developers.google.com/drive/v2/reference/apps/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated drive service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AppListResponse</returns>
        public static AppList List(driveService service, AppsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Apps.List();

                // Applying optional parameters to the request.                
                request = (AppsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Apps.List failed.", ex);
            }
        }
