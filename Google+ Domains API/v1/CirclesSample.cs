...
namespace GoogleSamplecSharpSample.plusDomainsv1.Methods
{
    ...
    public static class CirclesSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CircleFeedResponse</returns>
        ...
        public static void Remove(plusDomainsService service, string circleId)
        {
            try
            {
                ...
                // Make the request.
                return service.Circles.Remove(circleId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void RemovePeople(plusDomainsService service, string circleId, CirclesRemovePeopleOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
