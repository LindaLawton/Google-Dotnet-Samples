...
namespace GoogleSamplecSharpSample.Plusdomainsv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static PlusdomainsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
            ...
            {
                Console.WriteLine("Create service account PlusdomainsService failed" + ex.Message);
