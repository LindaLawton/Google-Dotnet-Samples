...
//     Build date: 01/02/2017 22:33:58
...
{  
    public static class Oauth2Example 
    {
        ...
        public static PlusdomainsService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { PlusdomainsService.Scope.PlusCirclesWrite,	//Manage your circles and add people and pages. People and pages you add to your circles will be notified. Others may see this information publicly. People you add to circles can use Hangouts with you.
                                                 PlusdomainsService.Scope.PlusProfilesRead,	//View your own Google+ profile and profiles visible to you
                                                 PlusdomainsService.Scope.PlusCirclesRead, 	//View your circles and the people and pages in them
                                                 ...
                                                 PlusdomainsService.Scope.PlusLogin,        	//Know the list of people in your circles, your age range, and language
                ...
                return new PlusdomainsService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Plusdomains Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account PlusdomainsService failed" + ex.Message);
