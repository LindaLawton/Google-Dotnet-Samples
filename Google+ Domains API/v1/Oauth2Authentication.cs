...
namespace GoogleSamplecSharpSample.Plusdomainsv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PlusdomainsService used to make requests against the Plusdomains API</returns>
        public static PlusdomainsService GetPlusdomainsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Plusdomains service failed.", ex);
            }
        }
        ...
        /// <returns>PlusdomainsService used to make requests against the Plusdomains API</returns>
        private static PlusdomainsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Plusdomains API service.
