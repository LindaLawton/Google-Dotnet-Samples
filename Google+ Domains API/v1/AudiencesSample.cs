...
namespace GoogleSamplecSharpSample.plusDomainsv1.Methods
{
    ...
    public static class AudiencesSample
    {

        public class AudiencesListOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AudiencesFeedResponse</returns>
