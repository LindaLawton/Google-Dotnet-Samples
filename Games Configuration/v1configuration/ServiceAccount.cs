...
namespace GoogleSamplecSharpSample.Gamesconfigurationv1configuration.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static GamesconfigurationService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new GamesconfigurationService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Gamesconfiguration Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Gamesconfiguration service.
                    return new GamesconfigurationService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Gamesconfiguration Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountGamesconfigurationFailed", ex);
            }
        }
    }
}