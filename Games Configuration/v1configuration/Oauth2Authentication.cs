...
namespace GoogleSamplecSharpSample.Gamesconfigurationv1configuration.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GamesconfigurationService used to make requests against the Gamesconfiguration API</returns>
        public static GamesconfigurationService GetGamesconfigurationService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Gamesconfiguration service failed.", ex);
            }
        }
        ...
        /// <returns>GamesconfigurationService used to make requests against the Gamesconfiguration API</returns>
        private static GamesconfigurationService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Gamesconfiguration API service.
                return new GamesconfigurationService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Gamesconfiguration Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
