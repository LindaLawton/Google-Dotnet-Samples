...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static DeploymentmanageralphaService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DeploymentmanageralphaService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Deploymentmanageralpha Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Deploymentmanageralpha service.
                    return new DeploymentmanageralphaService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Deploymentmanageralpha Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountDeploymentmanageralphaFailed", ex);
            }
        }
    }
}