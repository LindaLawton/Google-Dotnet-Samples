...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DeploymentmanageralphaService used to make requests against the Deploymentmanageralpha API</returns>
        public static DeploymentmanageralphaService GetDeploymentmanageralphaService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Deploymentmanageralpha service failed.", ex);
            }
        }
        ...
        /// <returns>DeploymentmanageralphaService used to make requests against the Deploymentmanageralpha API</returns>
        private static DeploymentmanageralphaService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Deploymentmanageralpha API service.
                return new DeploymentmanageralphaService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Deploymentmanageralpha Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
