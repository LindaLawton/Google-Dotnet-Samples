...
namespace GoogleSamplecSharpSample.Visionv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>VisionService used to make requests against the Vision API</returns>
        public static VisionService GetVisionService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Vision service failed.", ex);
            }
        }
        ...
        /// <returns>VisionService used to make requests against the Vision API</returns>
        private static VisionService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
