...
namespace GoogleSamplecSharpSample.Replicapoolv1beta2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ReplicapoolService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ReplicapoolService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Replicapool Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Replicapool service.
                    return new ReplicapoolService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Replicapool Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ReplicapoolService failed" + ex.Message);
