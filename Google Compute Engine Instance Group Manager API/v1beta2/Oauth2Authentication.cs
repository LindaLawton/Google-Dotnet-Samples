...
namespace GoogleSamplecSharpSample.Replicapoolv1beta2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ReplicapoolService used to make requests against the Replicapool API</returns>
        public static ReplicapoolService GetReplicapoolService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Replicapool service failed.", ex);
            }
        }
        ...
        /// <returns>ReplicapoolService used to make requests against the Replicapool API</returns>
        private static ReplicapoolService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Replicapool API service.
