...
namespace GoogleSamplecSharpSample.Androidpublisherv2.Methods
{
    ...
    public static class DetailsSample
    {
        ...
        /// Documentation https://developers.google.com/androidpublisher/v2/reference/details/get
        ...
        public static AppDetails Get(AndroidpublisherService service, string packageName, string editId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Details.Get(packageName, editId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Details.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/androidpublisher/v2/reference/details/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Androidpublisher service.</param>  
        /// <param name="packageName">Unique identifier for the Android app that is being updated; for example, "com.spiffygame".</param>
        ...
        /// <param name="body">A valid Androidpublisher v2 body.</param>
        /// <returns>AppDetailsResponse</returns>
        public static AppDetails Update(AndroidpublisherService service, string packageName, string editId, AppDetails body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Details.Update(body, packageName, editId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Details.Update failed.", ex);
            }
        }
