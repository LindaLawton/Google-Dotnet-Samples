...
namespace GoogleSamplecSharpSample.Cloudbillingv1.Methods
{
    ...
    public static class ProjectsSample
    {
        ...
        {
            /// Requested page size. The maximum page size is 100; this is also thedefault.
        ...
        /// <summary>
        /// Lists the projects associated with a billing account. The currentauthenticated user must be an [owner of the billingaccount](https://support.google.com/cloud/answer/4430947). 
        /// Documentation https://developers.google.com/cloudbilling/v1/reference/projects/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudbilling service.</param>  
        /// <param name="name">The resource name of the billing account associated with the projects thatyou want to list. For example, `billingAccounts/012345-567890-ABCDEF`.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>ListProjectBillingInfoResponseResponse</returns>
        public static ListProjectBillingInfoResponse List(CloudbillingService service, string name, ProjectsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Projects.List(name);
