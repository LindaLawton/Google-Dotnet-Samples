...
namespace GoogleSamplecSharpSample.Cloudbillingv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static CloudbillingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CloudbillingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Cloudbilling Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Cloudbilling service.
                    return new CloudbillingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Cloudbilling Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account CloudbillingService failed" + ex.Message);
