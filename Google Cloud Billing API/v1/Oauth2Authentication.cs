...
{  
    public static class Oauth2Example 
    {
        ...
        public static CloudbillingService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { CloudbillingService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new CloudbillingService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Cloudbilling Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account CloudbillingService failed" + ex.Message);
                throw new Exception("CreateServiceAccountCloudbillingFailed", ex);
			}
        }
        ...
        public static CloudbillingService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
