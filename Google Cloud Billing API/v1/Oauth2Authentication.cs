...
namespace GoogleSamplecSharpSample.Cloudbillingv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudbillingService used to make requests against the Cloudbilling API</returns>
        public static CloudbillingService GetCloudbillingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudbilling service failed.", ex);
            }
        }
        ...
        /// <returns>CloudbillingService used to make requests against the Cloudbilling API</returns>
        private static CloudbillingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudbilling API service.
