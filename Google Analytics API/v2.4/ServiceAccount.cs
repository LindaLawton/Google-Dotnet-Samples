...
//
//------------------------------------------------------------------------------  
using Google.Apis.Analytics.v2.4;
...
namespace GoogleSamplecSharpSample.Analyticsv2.4.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static AnalyticsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
