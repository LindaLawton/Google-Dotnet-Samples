...
namespace GoogleSamplecSharpSample.analyticsv2_4.Methods
{
    ...
    public static class GoalsSample
    {
        ...
        /// Documentation https://developers.google.com/analytics/v2.4/reference/goals/list
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void List(analyticsService service, string accountId, string webPropertyId, string profileId, GoalsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
