...
namespace GoogleSamplecSharpSample.analyticsv2_4.Methods
{
    ...
    public static class AccountsSample
    {
        ...
        /// Documentation https://developers.google.com/analytics/v2.4/reference/accounts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        /// <param name="optional">Optional paramaters.</param>        public static void List(analyticsService service, AccountsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Accounts.List();
