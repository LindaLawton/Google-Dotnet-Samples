...
namespace GoogleSamplecSharpSample.analyticsv2_4.Methods
{
    ...
    public static class WebpropertiesSample
    {
        ...
        /// Documentation https://developers.google.com/analytics/v2.4/reference/webproperties/list
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void List(analyticsService service, string accountId, WebpropertiesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
