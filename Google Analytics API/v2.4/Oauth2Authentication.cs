...
namespace GoogleSamplecSharpSample.Analyticsv2.4.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static AnalyticsService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { AnalyticsService.Scope.AnalyticsReadonly,	//View your Google Analytics data
            ...
            {
                Console.WriteLine("Create Oauth2 account AnalyticsService failed" + ex.Message);
