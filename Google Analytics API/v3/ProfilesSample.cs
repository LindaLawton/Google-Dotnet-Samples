...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class ProfilesSample
    {


        /// <summary>
        /// Deletes a view (profile). 
        /// Documentation https://developers.google.com/analytics/v3/reference/profiles/delete
        ...
        public static void Delete(analyticsService service, string accountId, string webPropertyId, string profileId)
        {
            try
            {
                ...
                // Make the request.
                return service.Profiles.Delete(accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Profiles.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profiles/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        public static Profile Get(analyticsService service, string accountId, string webPropertyId, string profileId)
        {
            try
            {
                ...
                // Make the request.
                return service.Profiles.Get(accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Profiles.Get failed.", ex);
            }
        }
        ...
        public class ProfilesListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profiles/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ProfilesResponse</returns>
        public static Profiles List(analyticsService service, string accountId, string webPropertyId, ProfilesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Profiles.List(accountId, webPropertyId);

                // Applying optional parameters to the request.                
                request = (ProfilesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Profiles.List failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profiles/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        /// <param name="body">A valid analytics v3 body.</param>
        /// <returns>ProfileResponse</returns>
        public static Profile Patch(analyticsService service, string accountId, string webPropertyId, string profileId, Profile body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Profiles.Patch(body, accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Profiles.Patch failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profiles/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        /// <param name="accountId">Account ID to which the view (profile) belongs</param>
        ...
        /// <param name="body">A valid analytics v3 body.</param>
        /// <returns>ProfileResponse</returns>
        public static Profile Update(analyticsService service, string accountId, string webPropertyId, string profileId, Profile body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Profiles.Update(body, accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Profiles.Update failed.", ex);
            }
        }
