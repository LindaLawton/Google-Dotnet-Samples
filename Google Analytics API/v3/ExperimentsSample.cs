...
namespace GoogleSamplecSharpSample.Analyticsv3.Methods
{
    ...
    public static class ExperimentsSample
    {
        ...
        public static void Delete(AnalyticsService service, string accountId, string webPropertyId, string profileId, string experimentId)
        {
            try
            {
                ...
                // Make the request.
                 service.Experiments.Delete(accountId, webPropertyId, profileId, experimentId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/experiments/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Analytics service.</param>  
        ...
        public static Experiment Get(AnalyticsService service, string accountId, string webPropertyId, string profileId, string experimentId)
        {
            try
            {
                ...
                // Make the request.
                return service.Experiments.Get(accountId, webPropertyId, profileId, experimentId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Experiments.Get failed.", ex);
            }
        }

        /// <summary>
        /// Create a new experiment. 
        /// Documentation https://developers.google.com/analytics/v3/reference/experiments/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Analytics service.</param>  
        ...
        /// <returns>ExperimentResponse</returns>
        public static Experiment Insert(AnalyticsService service, string accountId, string webPropertyId, string profileId, Experiment body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Experiments.Insert(body, accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Experiments.Insert failed.", ex);
            }
        }
        public class ExperimentsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/experiments/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Analytics service.</param>  
        ...
        public static Experiments List(AnalyticsService service, string accountId, string webPropertyId, string profileId, ExperimentsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Experiments.List(accountId, webPropertyId, profileId);

                // Applying optional parameters to the request.                
                request = (ExperimentsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Experiments.List failed.", ex);
            }
        }

        /// <summary>
        /// Update an existing experiment. This method supports patch semantics. 
        /// Documentation https://developers.google.com/analytics/v3/reference/experiments/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Analytics service.</param>  
        ...
        /// <param name="body">A valid Analytics v3 body.</param>
        /// <returns>ExperimentResponse</returns>
        public static Experiment Patch(AnalyticsService service, string accountId, string webPropertyId, string profileId, string experimentId, Experiment body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Experiments.Patch(body, accountId, webPropertyId, profileId, experimentId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Experiments.Patch failed.", ex);
            }
        }

        /// <summary>
        /// Update an existing experiment. 
        /// Documentation https://developers.google.com/analytics/v3/reference/experiments/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Analytics service.</param>  
        /// <param name="accountId">Account ID of the experiment to update.</param>
        ...
        /// <param name="body">A valid Analytics v3 body.</param>
        /// <returns>ExperimentResponse</returns>
        public static Experiment Update(AnalyticsService service, string accountId, string webPropertyId, string profileId, string experimentId, Experiment body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Experiments.Update(body, accountId, webPropertyId, profileId, experimentId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Experiments.Update failed.", ex);
            }
        }
