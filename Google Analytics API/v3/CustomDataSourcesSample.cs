...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class CustomDataSourcesSample
    {

        public class CustomDataSourcesListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/customDataSources/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CustomDataSourcesResponse</returns>
        public static CustomDataSources List(analyticsService service, string accountId, string webPropertyId, CustomDataSourcesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.CustomDataSources.List(accountId, webPropertyId);

                // Applying optional parameters to the request.                
                request = (CustomDataSourcesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request CustomDataSources.List failed.", ex);
            }
        }
