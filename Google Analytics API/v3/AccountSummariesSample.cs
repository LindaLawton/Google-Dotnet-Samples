...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class AccountSummariesSample
    {

        public class AccountSummariesListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/accountSummaries/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AccountSummariesResponse</returns>
        public static AccountSummaries List(analyticsService service, AccountSummariesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                request = (AccountSummariesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request AccountSummaries.List failed.", ex);
            }
        }
