...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class GaSample
    {
        ...
        public class GaGetOptionalParms
        {
            ...
            public bool Include-empty-rows { get; set; }  
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>GaDataResponse</returns>
        public static GaData Get(analyticsService service, string ids, string start-date, string end-date, string metrics, GaGetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Ga.Get(ids, start-date, end-date, metrics);

                // Applying optional parameters to the request.                
                request = (GaResource.GetRequest)SampleHelpers.ApplyOptionalParms(request, optional);
