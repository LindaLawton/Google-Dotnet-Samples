...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class ProfileUserLinksSample
    {


        /// <summary>
        /// Removes a user from the given view (profile). 
        /// Documentation https://developers.google.com/analytics/v3/reference/profileUserLinks/delete
        ...
        public static void Delete(analyticsService service, string accountId, string webPropertyId, string profileId, string linkId)
        {
            try
            {
                ...
                // Make the request.
                return service.ProfileUserLinks.Delete(accountId, webPropertyId, profileId, linkId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ProfileUserLinks.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profileUserLinks/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        public static EntityUserLink Insert(analyticsService service, string accountId, string webPropertyId, string profileId, EntityUserLink body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.ProfileUserLinks.Insert(body, accountId, webPropertyId, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ProfileUserLinks.Insert failed.", ex);
            }
        }

        public class ProfileUserLinksListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profileUserLinks/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        public static EntityUserLinks List(analyticsService service, string accountId, string webPropertyId, string profileId, ProfileUserLinksListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.ProfileUserLinks.List(accountId, webPropertyId, profileId);

                // Applying optional parameters to the request.                
                request = (ProfileUserLinksResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request ProfileUserLinks.List failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/profileUserLinks/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        ...
        /// <param name="body">A valid analytics v3 body.</param>
        /// <returns>EntityUserLinkResponse</returns>
        public static EntityUserLink Update(analyticsService service, string accountId, string webPropertyId, string profileId, string linkId, EntityUserLink body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.ProfileUserLinks.Update(body, accountId, webPropertyId, profileId, linkId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ProfileUserLinks.Update failed.", ex);
            }
        }
