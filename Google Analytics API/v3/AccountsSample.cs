...
namespace GoogleSamplecSharpSample.analyticsv3.Methods
{
    ...
    public static class AccountsSample
    {
        ...
        /// Documentation https://developers.google.com/analytics/v3/reference/accounts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated analytics service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>AccountsResponse</returns>
        public static Accounts List(analyticsService service, AccountsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
