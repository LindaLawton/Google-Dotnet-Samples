    ...
    public static class WebPropertyAdWordsLinksSample
    {
        ...
        public static void Delete(analyticsService service, string accountId, string webPropertyId, string webPropertyAdWordsLinkId)
        {
            try
            {
                ...
                // Make the request.
                return service.WebPropertyAdWordsLinks.Delete(accountId, webPropertyId, webPropertyAdWordsLinkId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>EntityAdWordsLinksResponse</returns>
