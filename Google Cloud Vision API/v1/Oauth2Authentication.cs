...
//     Build date: 01/02/2017 22:34:54
...
// About 
// 
// Unoffical sample for the Vision v1 API for C#. 
...
namespace GoogleSamplecSharpSample.Visionv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static VisionService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { VisionService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new VisionService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Vision Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account VisionService failed" + ex.Message);
                throw new Exception("CreateServiceAccountVisionFailed", ex);
			}
        }
        ...
        public static VisionService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
