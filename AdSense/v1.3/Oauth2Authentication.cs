...
namespace GoogleSamplecSharpSample.Adsensev1.3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AdsenseService used to make requests against the Adsense API</returns>
        public static AdsenseService GetAdsenseService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Adsense service failed.", ex);
            }
        }
        ...
        /// <returns>AdsenseService used to make requests against the Adsense API</returns>
        private static AdsenseService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
