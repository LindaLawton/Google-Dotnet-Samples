...
{  
    public static class Oauth2Example 
    {
        ...
        public static BloggerService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { BloggerService.Scope.Blogger};	//Manage your Blogger account
            ...
            {
                Console.WriteLine("Create Oauth2 account BloggerService failed" + ex.Message);
