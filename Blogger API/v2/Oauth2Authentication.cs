...
namespace GoogleSamplecSharpSample.Bloggerv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>BloggerService used to make requests against the Blogger API</returns>
        public static BloggerService GetBloggerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Blogger service failed.", ex);
            }
        }
        ...
        /// <returns>BloggerService used to make requests against the Blogger API</returns>
        private static BloggerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                return new BloggerService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Blogger Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
