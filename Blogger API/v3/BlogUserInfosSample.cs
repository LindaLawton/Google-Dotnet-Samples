...
namespace GoogleSamplecSharpSample.bloggerv3.Methods
{
    ...
    public static class BlogUserInfosSample
    {

        public class BlogUserInfosGetOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/blogger/v3/reference/blogUserInfos/get
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>BlogUserInfoResponse</returns>
        public static BlogUserInfo Get(bloggerService service, string userId, string blogId, BlogUserInfosGetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.BlogUserInfos.Get(userId, blogId);

                // Applying optional parameters to the request.                
                request = (BlogUserInfosResource.GetRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request BlogUserInfos.Get failed.", ex);
            }
        }
