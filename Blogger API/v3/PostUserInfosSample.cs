...
namespace GoogleSamplecSharpSample.bloggerv3.Methods
{
    ...
    public static class PostUserInfosSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>PostUserInfoResponse</returns>
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>PostUserInfosListResponse</returns>
