...
namespace GoogleSamplecSharpSample.Adexperiencereportv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static AdexperiencereportService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AdexperiencereportService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Adexperiencereport Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Adexperiencereport service.
                    return new AdexperiencereportService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Adexperiencereport Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountAdexperiencereportFailed", ex);
            }
        }
    }
}