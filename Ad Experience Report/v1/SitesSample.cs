...
namespace GoogleSamplecSharpSample.Adexperiencereportv1.Methods
{
    ...
    public static class SitesSample
    {
        ...
        /// <param name="name">The required site name. It should be a site property registered in SearchConsole. The server will return an error of BAD_REQUEST if this field isnot filled in.</param>
