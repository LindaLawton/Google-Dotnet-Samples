...
namespace Daimto.Google.Sample.Analytics
{
    public class DaimtoAnalyticsAuthenticationHelper
    {
        ...
        /// <param name="serviceAccountEmail">From Google Developer console https://console.developers.google.com</param>
        /// <param name="keyFilePath">Location of the Service account key file downloaded from Google Developer console https://console.developers.google.com</param>
        /// <returns>instance of AnalyticsReportingService</returns>
        public static AnalyticsReportingService AuthenticateReportingServiceAccount(string serviceAccountEmail, string keyFilePath)
        {
            // check the file exists
            if (!File.Exists(keyFilePath))
            {
            ...
            string[] scopes = new string[] { AnalyticsReportingService.Scope.Analytics,  // view and manage your analytics data
                                             AnalyticsReportingService.Scope.AnalyticsReadonly};     // View analytics data            
            ...
            try
            {
                ...
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Reporting API Sample",
                });
                return service;
            }
            catch (Exception ex)
