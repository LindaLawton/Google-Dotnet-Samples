...
//     Build date: 01/02/2017 22:33:39
...
{  
    public static class Oauth2Example 
    {
        ...
        public static LicensingService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { LicensingService.Scope.AppsLicensing};	//View and manage Google Apps licenses for your domain
                ...
                return new LicensingService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Licensing Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account LicensingService failed" + ex.Message);
                throw new Exception("CreateServiceAccountLicensingFailed", ex);
			}
        }
        ...
        public static LicensingService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
