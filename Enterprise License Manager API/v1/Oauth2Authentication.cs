...
namespace GoogleSamplecSharpSample.Licensingv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>LicensingService used to make requests against the Licensing API</returns>
        public static LicensingService GetLicensingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Licensing service failed.", ex);
            }
        }
        ...
        /// <returns>LicensingService used to make requests against the Licensing API</returns>
        private static LicensingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
