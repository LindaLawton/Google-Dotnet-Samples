...
namespace GoogleSamplecSharpSample.Licensingv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static LicensingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new LicensingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Licensing Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Licensing Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account LicensingService failed" + ex.Message);
