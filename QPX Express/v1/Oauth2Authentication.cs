...
// About 
// 
// Unoffical sample for the Qpxexpress v1 API for C#. 
...
namespace GoogleSamplecSharpSample.Qpxexpressv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>QpxexpressService used to make requests against the Qpxexpress API</returns>
        public static QpxexpressService GetQpxexpressService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Qpxexpress service failed.", ex);
            }
        }
        ...
        /// <returns>QpxexpressService used to make requests against the Qpxexpress API</returns>
        private static QpxexpressService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Qpxexpress API service.
                return new QpxexpressService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Qpxexpress Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
