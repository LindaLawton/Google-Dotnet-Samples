...
namespace GoogleSamplecSharpSample.Qpxexpressv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static QpxexpressService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new QpxexpressService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Qpxexpress Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Qpxexpress service.
                    return new QpxexpressService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Qpxexpress Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountQpxexpressFailed", ex);
            }
        }
    }
}