...
namespace GoogleSamplecSharpSample.Oauth2v2.Auth
{
    public static class Oauth2Example
    {
        ...
        public static Oauth2Service GetOauth2Service(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
        ...
        /// <returns>Oauth2Service used to make requests against the Oauth2 API</returns>
        private static Oauth2Service GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
