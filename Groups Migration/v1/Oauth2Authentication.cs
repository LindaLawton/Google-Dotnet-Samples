...
// About 
// 
// Unoffical sample for the Groupsmigration v1 API for C#. 
...
namespace GoogleSamplecSharpSample.Groupsmigrationv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GroupsmigrationService used to make requests against the Groupsmigration API</returns>
        public static GroupsmigrationService GetGroupsmigrationService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Groupsmigration service failed.", ex);
            }
        }
        ...
        /// <returns>GroupsmigrationService used to make requests against the Groupsmigration API</returns>
        private static GroupsmigrationService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Groupsmigration API service.
                return new GroupsmigrationService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Groupsmigration Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
