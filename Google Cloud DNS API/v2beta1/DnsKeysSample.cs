...
namespace GoogleSamplecSharpSample.dnsv2beta1.Methods
{
    ...
    public static class DnsKeysSample
    {

        public class DnsKeysGetOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DnsKeyResponse</returns>
        ...
        public class DnsKeysListOptionalParms
        {
            /// An optional comma-separated list of digest types to compute and display for key signing keys. If omitted, the recommended digest type will be computed and displayed.
            public string DigestType { get; set; }  
        ...
        /// Documentation https://developers.google.com/dns/v2beta1/reference/dnsKeys/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dns service.</param>  
        /// <param name="project">Identifies the project addressed by this request.</param>
        /// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or id.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DnsKeysListResponseResponse</returns>
        public static DnsKeysListResponse List(dnsService service, string project, string managedZone, DnsKeysListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.DnsKeys.List(project, managedZone);

                // Applying optional parameters to the request.                
                request = (DnsKeysResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request DnsKeys.List failed.", ex);
            }
        }
