...
namespace GoogleSamplecSharpSample.dnsv2beta1.Methods
{
    ...
    public static class ResourceRecordSetsSample
    {

        public class ResourceRecordSetsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/dns/v2beta1/reference/resourceRecordSets/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ResourceRecordSetsListResponseResponse</returns>
        public static ResourceRecordSetsListResponse List(dnsService service, string project, string managedZone, ResourceRecordSetsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.ResourceRecordSets.List(project, managedZone);

                // Applying optional parameters to the request.                
                request = (ResourceRecordSetsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request ResourceRecordSets.List failed.", ex);
            }
        }
