...
namespace GoogleSamplecSharpSample.Dnsv2beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static DnsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DnsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Dns Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Dns Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account DnsService failed" + ex.Message);
