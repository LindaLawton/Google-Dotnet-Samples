...
namespace GoogleSamplecSharpSample.Dnsv2beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DnsService used to make requests against the Dns API</returns>
        public static DnsService GetDnsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Dns service failed.", ex);
            }
        }
        ...
        /// <returns>DnsService used to make requests against the Dns API</returns>
        private static DnsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
