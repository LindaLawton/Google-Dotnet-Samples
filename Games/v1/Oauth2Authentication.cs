...
namespace GoogleSamplecSharpSample.Gamesv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GamesService used to make requests against the Games API</returns>
        public static GamesService GetGamesService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Games service failed.", ex);
            }
        }
        ...
        /// <returns>GamesService used to make requests against the Games API</returns>
        private static GamesService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
