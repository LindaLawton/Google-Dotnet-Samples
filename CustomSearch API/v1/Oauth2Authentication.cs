...
namespace GoogleSamplecSharpSample.Customsearchv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CustomsearchService used to make requests against the Customsearch API</returns>
        public static CustomsearchService GetCustomsearchService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Customsearch service failed.", ex);
            }
        }
        ...
        /// <returns>CustomsearchService used to make requests against the Customsearch API</returns>
        private static CustomsearchService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Customsearch API service.
                return new CustomsearchService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Customsearch Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
