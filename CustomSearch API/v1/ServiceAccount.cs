...
namespace GoogleSamplecSharpSample.Customsearchv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CustomsearchService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CustomsearchService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Customsearch Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Customsearch service.
                    return new CustomsearchService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Customsearch Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCustomsearchFailed", ex);
            }
        }
    }
}