...
namespace GoogleSamplecSharpSample.Cloudvideointelligencev1beta1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CloudvideointelligenceService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CloudvideointelligenceService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Cloudvideointelligence Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Cloudvideointelligence service.
                    return new CloudvideointelligenceService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Cloudvideointelligence Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCloudvideointelligenceFailed", ex);
            }
        }
    }
}