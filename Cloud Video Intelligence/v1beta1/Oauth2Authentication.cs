...
namespace GoogleSamplecSharpSample.Cloudvideointelligencev1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudvideointelligenceService used to make requests against the Cloudvideointelligence API</returns>
        public static CloudvideointelligenceService GetCloudvideointelligenceService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudvideointelligence service failed.", ex);
            }
        }
        ...
        /// <returns>CloudvideointelligenceService used to make requests against the Cloudvideointelligence API</returns>
        private static CloudvideointelligenceService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudvideointelligence API service.
                return new CloudvideointelligenceService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudvideointelligence Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
