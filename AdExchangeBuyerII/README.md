...
These samples show how to access the [Ad Exchange Buyer API II](https://developers.google.com/ad-exchange/buyer-rest/guides/client-access/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
