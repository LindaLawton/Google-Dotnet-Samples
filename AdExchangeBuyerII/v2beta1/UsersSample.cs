...
namespace GoogleSamplecSharpSample.Adexchangebuyeriiv2beta1.Methods
{
    ...
    public static class UsersSample
    {
        ...
        /// <param name="clientAccountId">Numerical account ID of the client buyer that the user to be retrievedis associated with. (required)</param>
        ...
        {
            /// A token identifying a page of results the server should return.Typically, this is the value ofListClientUsersResponse.nextPageTokenreturned from the previous call to theaccounts.clients.users.list method.
        ...
        /// <summary>
        /// Lists all the known client users for a specifiedsponsor buyer account ID. 
        ...
        /// <param name="clientAccountId">The account ID of the client buyer to list users for. (required)You must specify either a string representation of anumerical account identifier or the `-` characterto list all the client users for all the clientsof a given sponsor buyer.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>ListClientUsersResponseResponse</returns>
        ...
        /// <param name="service">Authenticated Adexchangebuyerii service.</param>  
        /// <param name="accountId">Numerical account ID of the client's sponsor buyer. (required)</param>
        /// <param name="clientAccountId">Numerical account ID of the client buyerthat the user to be retrieved is associated with. (required)</param>
        /// <param name="userId">Numerical identifier of the user to retrieve. (required)</param>
        /// <returns>ClientUserResponse</returns>
