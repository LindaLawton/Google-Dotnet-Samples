...
namespace GoogleSamplecSharpSample.Adexchangebuyeriiv2beta1.Methods
{
    ...
    public static class InvitationsSample
    {
        ...
        /// <param name="clientAccountId">Numerical account ID of the client buyer that the user invitationto be retrieved is associated with. (required)</param>
        ...
        {
            /// A token identifying a page of results the server should return.Typically, this is the value ofListClientUserInvitationsResponse.nextPageTokenreturned from the previous call to theclients.invitations.listmethod.
        ...
        /// <param name="service">Authenticated Adexchangebuyerii service.</param>  
        /// <param name="accountId">Numerical account ID of the client's sponsor buyer. (required)</param>
        /// <param name="clientAccountId">Numerical account ID of the client buyer to list invitations for.(required)You must either specify a string representation of anumerical account identifier or the `-` characterto list all the invitations for all the clientsof a given sponsor buyer.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>ListClientUserInvitationsResponseResponse</returns>
        ...
        /// <summary>
        /// Creates and sends out an email invitation to accessan Ad Exchange client buyer account. 
        /// Documentation https://developers.google.com/adexchangebuyerii/v2beta1/reference/invitations/create
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adexchangebuyerii service.</param>  
        /// <param name="accountId">Numerical account ID of the client's sponsor buyer. (required)</param>
        /// <param name="clientAccountId">Numerical account ID of the client buyer that the usershould be associated with. (required)</param>
