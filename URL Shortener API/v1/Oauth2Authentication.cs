...
namespace GoogleSamplecSharpSample.Urlshortenerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>UrlshortenerService used to make requests against the Urlshortener API</returns>
        public static UrlshortenerService GetUrlshortenerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Urlshortener service failed.", ex);
            }
        }
        ...
        /// <returns>UrlshortenerService used to make requests against the Urlshortener API</returns>
        private static UrlshortenerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Urlshortener API service.
