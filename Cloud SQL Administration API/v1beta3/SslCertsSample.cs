...
namespace GoogleSamplecSharpSample.SQLAdminv1beta3.Methods
{
    ...
    public static class SslCertsSample
    {
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/sslCerts/delete
        ...
        /// <returns>SslCertsDeleteResponseResponse</returns>
        public static SslCertsDeleteResponse Delete(SQLAdminService service, string project, string instance, string sha1Fingerprint)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/sslCerts/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated SQLAdmin service.</param>  
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/sslCerts/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated SQLAdmin service.</param>  
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/sslCerts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated SQLAdmin service.</param>  
