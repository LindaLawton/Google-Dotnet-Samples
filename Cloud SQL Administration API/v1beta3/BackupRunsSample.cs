...
namespace GoogleSamplecSharpSample.SQLAdminv1beta3.Methods
{
    ...
    public static class BackupRunsSample
    {
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/backupRuns/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated SQLAdmin service.</param>  
        /// <param name="project">Project ID of the project that contains the instance.</param>
        /// <param name="instance">Cloud SQL instance ID. This does not include the project ID.</param>
        /// <param name="backupConfiguration">Identifier for the backup configuration. This gets generated automatically when a backup configuration is created.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>BackupRunsListResponseResponse</returns>
        public static BackupRunsListResponse List(SQLAdminService service, string project, string instance, string backupConfiguration, BackupRunsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.BackupRuns.List(project, instance, backupConfiguration);
