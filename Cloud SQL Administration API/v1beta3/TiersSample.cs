...
namespace GoogleSamplecSharpSample.SQLAdminv1beta3.Methods
{
    ...
    public static class TiersSample
    {


        /// <summary>
        /// Lists service tiers that can be used to create Google Cloud SQL instances. 
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/tiers/list
        ...
        /// <returns>TiersListResponseResponse</returns>
        public static TiersListResponse List(SQLAdminService service, string project)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Tiers.List(project).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Tiers.List failed.", ex);
            }
        }
