...
namespace GoogleSamplecSharpSample.Predictionv1.5.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PredictionService used to make requests against the Prediction API</returns>
        public static PredictionService GetPredictionService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Prediction service failed.", ex);
            }
        }
        ...
        /// <returns>PredictionService used to make requests against the Prediction API</returns>
        private static PredictionService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
