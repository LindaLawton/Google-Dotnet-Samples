...
// About 
// 
// Unoffical sample for the Webfonts v1 API for C#. 
...
namespace GoogleSamplecSharpSample.Webfontsv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>WebfontsService used to make requests against the Webfonts API</returns>
        public static WebfontsService GetWebfontsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Webfonts service failed.", ex);
            }
        }
        ...
        /// <returns>WebfontsService used to make requests against the Webfonts API</returns>
        private static WebfontsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Webfonts API service.
                return new WebfontsService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Webfonts Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
