...
namespace GoogleSamplecSharpSample.webfontsv1.Methods
{
  
    public static class WebfontsSample
    {

        public class WebfontsListOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>WebfontListResponse</returns>
