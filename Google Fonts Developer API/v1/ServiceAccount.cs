...
namespace GoogleSamplecSharpSample.Webfontsv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static WebfontsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new WebfontsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Webfonts Service account Authentication Sample",
                    });
                }
            ...
            {                
                throw new Exception("CreateServiceAccountWebfontsFailed", ex);
            }
        }
    }
}