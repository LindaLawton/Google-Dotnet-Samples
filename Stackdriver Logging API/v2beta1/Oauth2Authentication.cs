...
{  
    public static class Oauth2Example 
    {
        ...
        public static LoggingService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { LoggingService.Scope.Cloud-PlatformRead-Only,	//View your data across Google Cloud Platform services
                                                 LoggingService.Scope.Cloud-Platform,          	//View and manage your data across Google Cloud Platform services
                                                 LoggingService.Scope.LoggingWrite,           	//Submit log data for your projects
                                                 LoggingService.Scope.LoggingAdmin,           	//Administrate log data for your projects
                                                 LoggingService.Scope.LoggingRead};          	//View log data for your projects
            ...
            {
                Console.WriteLine("Create Oauth2 account LoggingService failed" + ex.Message);
                throw new Exception("CreateServiceAccountLoggingFailed", ex);
			}
        }
        ...
        public static LoggingService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
