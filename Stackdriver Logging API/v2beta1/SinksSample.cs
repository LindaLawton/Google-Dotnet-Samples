...
//     Build date: 01/02/2017 22:33:43
...
It is an error if the old value was true and the new value is false.
        ...
        /// Documentation https://developers.google.com/logging/v2beta1/reference/sinks/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Logging service.</param>  
        /// <param name="sinkName">Required. The full resource name of the sink to update, including the parent resource and the sink identifier:
"projects/[PROJECT_ID]/sinks/[SINK_ID]"
"organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
Example: "projects/my-project-id/sinks/my-sink-id".</param>
        /// <param name="body">A valid Logging v2beta1 body.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LogSinkResponse</returns>
        ...
        /// <summary>
        /// Gets a sink. 
        /// Documentation https://developers.google.com/logging/v2beta1/reference/sinks/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Logging service.</param>  
...
Example: "projects/my-project-id/sinks/my-sink-id".</param>
        ...
        /// Documentation https://developers.google.com/logging/v2beta1/reference/sinks/create
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Logging service.</param>  
...
Examples: "projects/my-logging-project", "organizations/123456789".</param>
        ...
        /// <summary>
        /// Lists sinks. 
        /// Documentation https://developers.google.com/logging/v2beta1/reference/sinks/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Logging service.</param>  
        /// <param name="parent">Required. The parent resource whose sinks are to be listed. Examples: "projects/my-logging-project", "organizations/123456789".</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ListSinksResponseResponse</returns>
        ...
        /// Documentation https://developers.google.com/logging/v2beta1/reference/sinks/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Logging service.</param>  
        /// <param name="sinkName">Required. The full resource name of the sink to delete, including the parent resource and the sink identifier:
"projects/[PROJECT_ID]/sinks/[SINK_ID]"
"organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
It is an error if the sink does not exist. Example: "projects/my-project-id/sinks/my-sink-id". It is an error if the sink does not exist.</param>
