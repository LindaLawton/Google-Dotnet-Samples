...
namespace GoogleSamplecSharpSample.Loggingv2beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static LoggingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new LoggingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Logging Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Logging Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account LoggingService failed" + ex.Message);
