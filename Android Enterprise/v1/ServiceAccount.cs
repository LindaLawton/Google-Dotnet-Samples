...
namespace GoogleSamplecSharpSample.Androidenterprisev1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static AndroidenterpriseService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AndroidenterpriseService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Androidenterprise Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Androidenterprise service.
                    return new AndroidenterpriseService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Androidenterprise Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountAndroidenterpriseFailed", ex);
            }
        }
    }
}