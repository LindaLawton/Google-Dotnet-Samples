...
namespace GoogleSamplecSharpSample.Cloudtracev2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudtraceService used to make requests against the Cloudtrace API</returns>
        public static CloudtraceService GetCloudtraceService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudtrace service failed.", ex);
            }
        }
        ...
        /// <returns>CloudtraceService used to make requests against the Cloudtrace API</returns>
        private static CloudtraceService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudtrace API service.
                return new CloudtraceService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudtrace Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
