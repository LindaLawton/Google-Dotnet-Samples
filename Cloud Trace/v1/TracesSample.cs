...
namespace GoogleSamplecSharpSample.Cloudtracev1.Methods
{
    ...
    public static class TracesSample
    {
        ...
        public class TracesListOptionalParms
        {
            ...
            /// End of the time interval (inclusive) during which the trace data wascollected from the application.
            public string EndTime { get; set; }  
            /// Token identifying the page of results to return. If provided, use thevalue of the `next_page_token` field from a previous request. Optional.
            public string PageToken { get; set; }  
            /// Start of the time interval (inclusive) during which the trace data wascollected from the application.
            public string StartTime { get; set; }  
            /// Maximum number of traces to return. If not specified or <= 0, theimplementation selects a reasonable value.  The implementation mayreturn fewer traces than the requested page size. Optional.
        ...
        /// <returns>ListTracesResponseResponse</returns>
