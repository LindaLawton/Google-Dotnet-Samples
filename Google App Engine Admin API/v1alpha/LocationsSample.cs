...
namespace GoogleSamplecSharpSample.Appenginev1alpha.Methods
{
    ...
    public static class LocationsSample
    {
        ...
        /// Documentation https://developers.google.com/appengine/v1alpha/reference/locations/get
        ...
        /// Documentation https://developers.google.com/appengine/v1alpha/reference/locations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
