...
namespace GoogleSamplecSharpSample.Appenginev1alpha.Methods
{
    ...
    public static class AuthorizedDomainsSample
    {

        public class AuthorizedDomainsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/appengine/v1alpha/reference/authorizedDomains/list
        ...
        /// <returns>ListAuthorizedDomainsResponseResponse</returns>
        public static ListAuthorizedDomainsResponse List(AppengineService service, string appsId, AuthorizedDomainsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.AuthorizedDomains.List(appsId);

                // Applying optional parameters to the request.                
                request = (AuthorizedDomainsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request AuthorizedDomains.List failed.", ex);
            }
        }
