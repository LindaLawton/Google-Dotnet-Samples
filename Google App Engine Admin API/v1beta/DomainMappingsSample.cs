...
namespace GoogleSamplecSharpSample.Appenginev1beta.Methods
{
    ...
    public static class DomainMappingsSample
    {
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/domainMappings/delete
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/domainMappings/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/domainMappings/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/domainMappings/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/domainMappings/create
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        /// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
