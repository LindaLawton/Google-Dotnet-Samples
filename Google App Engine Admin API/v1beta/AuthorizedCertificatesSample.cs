...
namespace GoogleSamplecSharpSample.Appenginev1beta.Methods
{
    ...
    public static class AuthorizedCertificatesSample
    {
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/authorizedCertificates/delete
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/authorizedCertificates/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/authorizedCertificates/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/authorizedCertificates/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1beta/reference/authorizedCertificates/create
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Appengine service.</param>  
        /// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
