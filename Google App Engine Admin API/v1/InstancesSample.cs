...
namespace GoogleSamplecSharpSample.appenginev1.Methods
{
    ...
    public static class InstancesSample
    {
        ...
        /// Documentation https://developers.google.com/appengine/v1/reference/instances/list
        ...
        /// Documentation https://developers.google.com/appengine/v1/reference/instances/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated appengine service.</param>  
        ...
        /// Documentation https://developers.google.com/appengine/v1/reference/instances/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated appengine service.</param>  
        /// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1.</param>
        ...
        /// Documentation https://developers.google.com/appengine/v1/reference/instances/debug
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated appengine service.</param>  
        /// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1.</param>
