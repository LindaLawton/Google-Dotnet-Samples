...
namespace GoogleSamplecSharpSample.Appenginev1beta4.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AppengineService used to make requests against the Appengine API</returns>
        public static AppengineService GetAppengineService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Appengine service failed.", ex);
            }
        }
        ...
        /// <returns>AppengineService used to make requests against the Appengine API</returns>
        private static AppengineService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
