...
namespace GoogleSamplecSharpSample.webmastersv3.Methods
{
    ...
    public static class SitesSample
    {
        ...
        /// Documentation https://developers.google.com/webmasters/v3/reference/sites/add
        ...
        public static void Add(webmastersService service, string siteUrl)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Sites.Add(siteUrl).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/webmasters/v3/reference/sites/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated webmasters service.</param>  
        /// <param name="siteUrl">The URI of the property as defined in Search Console. Examples: http://www.example.com/ or android-app://com.example/</param>
        /// <returns>WmxSiteResponse</returns>
        public static WmxSite Get(webmastersService service, string siteUrl)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Sites.Get(siteUrl).Execute();
            }
            catch (Exception ex)
            {
