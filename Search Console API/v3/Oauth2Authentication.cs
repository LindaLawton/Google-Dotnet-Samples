...
namespace GoogleSamplecSharpSample.Webmastersv3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>WebmastersService used to make requests against the Webmasters API</returns>
        public static WebmastersService GetWebmastersService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Webmasters service failed.", ex);
            }
        }
        ...
        /// <returns>WebmastersService used to make requests against the Webmasters API</returns>
        private static WebmastersService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
