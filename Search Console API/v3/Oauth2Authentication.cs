...
//     Build date: 01/02/2017 22:34:57
...
namespace GoogleSamplecSharpSample.Webmastersv3.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static WebmastersService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { WebmastersService.Scope.WebmastersReadonly,	//View Search Console data for your verified sites
                                                 WebmastersService.Scope.Webmasters};       	//View and manage Search Console data for your verified sites
                ...
                return new WebmastersService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Webmasters Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account WebmastersService failed" + ex.Message);
                throw new Exception("CreateServiceAccountWebmastersFailed", ex);
			}
        }
