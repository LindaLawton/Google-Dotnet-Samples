...
namespace GoogleSamplecSharpSample.Webmastersv3.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static WebmastersService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new WebmastersService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Webmasters Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Webmasters Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account WebmastersService failed" + ex.Message);
