...
namespace GoogleSamplecSharpSample.Adexchangesellerv1_1.Methods
{
    ...
    public static class PreferreddealsSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangeseller/v1.1/reference/preferreddeals/get
        ...
        public static PreferredDeal Get(AdexchangesellerService service, string dealId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Preferreddeals.Get(dealId).Execute();
            }
            catch (Exception ex)
            {
