...
namespace GoogleSamplecSharpSample.YouTube Reportingv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static YouTube ReportingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new YouTube ReportingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "YouTube Reporting Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  YouTube Reporting service.
                    return new YouTube ReportingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "YouTube Reporting Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account YouTube ReportingService failed" + ex.Message);
