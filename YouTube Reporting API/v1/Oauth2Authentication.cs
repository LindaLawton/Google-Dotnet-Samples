...
{  
    public static class Oauth2Example 
    {
        ...
        public static YouTube ReportingService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { YouTube ReportingService.Scope.Yt-Analytics-MonetaryReadonly,	//View monetary and non-monetary YouTube Analytics reports for your YouTube content
                                                 YouTube ReportingService.Scope.Yt-AnalyticsReadonly};       	//View YouTube Analytics reports for your YouTube content
                ...
                return new YouTube ReportingService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "YouTube Reporting Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account YouTube ReportingService failed" + ex.Message);
                throw new Exception("CreateServiceAccountYouTube ReportingFailed", ex);
			}
        }
        ...
        public static YouTube ReportingService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
