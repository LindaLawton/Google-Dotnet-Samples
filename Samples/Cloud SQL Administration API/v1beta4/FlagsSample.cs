...
namespace GoogleSamplecSharpSample.Sqladminv1beta4.Methods
{
    ...
    public static class FlagsSample
    {

        public class FlagsListOptionalParms
        {
        ...
        public static FlagsListResponse List(SqladminService service, FlagsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Flags.List();

                // Applying optional parameters to the request.                
                request = (FlagsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
