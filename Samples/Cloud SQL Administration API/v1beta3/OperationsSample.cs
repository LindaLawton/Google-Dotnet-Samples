...
namespace GoogleSamplecSharpSample.Sqladminv1beta3.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/operations/get
        ...
        /// <returns>InstanceOperationResponse</returns>
        public static InstanceOperation Get(SqladminService service, string project, string instance, string operation)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Operations.Get(project, instance, operation).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/sqladmin/v1beta3/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Sqladmin service.</param>  
        /// <param name="project">Project ID of the project that contains the instance.</param>
        ...
        /// <returns>OperationsListResponseResponse</returns>
