...
namespace GoogleSamplecSharpSample.Plusdomainsv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PlusdomainsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PlusdomainsService</returns>
        public static PlusdomainsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Plusdomains Service", ex);
            }
        }
    }
}
