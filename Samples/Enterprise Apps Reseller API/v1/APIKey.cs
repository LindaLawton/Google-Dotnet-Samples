...
namespace GoogleSamplecSharpSample.Resellerv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ResellerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ResellerService</returns>
        public static ResellerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Reseller Service", ex);
            }
        }
    }
}
