...
namespace GoogleSamplecSharpSample.Firebaserulesv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid FirebaserulesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>FirebaserulesService</returns>
        public static FirebaserulesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Firebaserules Service", ex);
            }
        }
    }
}
