...
namespace GoogleSamplecSharpSample.Appsactivityv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AppsactivityService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AppsactivityService</returns>
        public static AppsactivityService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Appsactivity Service", ex);
            }
        }
    }
}
