...
# Unoffical Google Play Game Services Management API Samples for .NET  
...
These samples show how to access the [Google Play Game Services Management API](https://developers.google.com/games/services) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
