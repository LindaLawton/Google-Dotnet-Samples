    ...
    public static class QuestsSample
    {
        ...
        public static void Reset(GamesmanagementService service, string questId)
        {
            try
            {
                ...
                // Make the request.
                 service.Quests.Reset(questId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/quests/resetAll
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Gamesmanagement service.</param>  
        public static void ResetAll(GamesmanagementService service)
        {
            try
            {
                ...
                // Make the request.
                 service.Quests.ResetAll().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Quests.ResetAll failed.", ex);
            }
        }

        /// <summary>
        /// Resets all draft quests for all players. This method is only available to user accounts for your developer console. 
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/quests/resetAllForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Gamesmanagement service.</param>  
        public static void ResetAllForAllPlayers(GamesmanagementService service)
        {
            try
            {
                ...
                // Make the request.
                 service.Quests.ResetAllForAllPlayers().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Quests.ResetAllForAllPlayers failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/quests/resetForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Gamesmanagement service.</param>  
        /// <param name="questId">The ID of the quest.</param>
        public static void ResetForAllPlayers(GamesmanagementService service, string questId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                 service.Quests.ResetForAllPlayers(questId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Quests.ResetForAllPlayers failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/quests/resetMultipleForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Gamesmanagement service.</param>  
        /// <param name="body">A valid Gamesmanagement v1management body.</param>
        public static void ResetMultipleForAllPlayers(GamesmanagementService service, QuestsResetMultipleForAllRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                 service.Quests.ResetMultipleForAllPlayers(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Quests.ResetMultipleForAllPlayers failed.", ex);
            }
        }
