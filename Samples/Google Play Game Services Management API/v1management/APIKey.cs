...
namespace GoogleSamplecSharpSample.Gamesmanagementv1management.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GamesmanagementService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GamesmanagementService</returns>
        public static GamesmanagementService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Gamesmanagement Service", ex);
            }
        }
    }
}
