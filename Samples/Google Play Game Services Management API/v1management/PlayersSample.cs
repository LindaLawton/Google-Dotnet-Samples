...
namespace GoogleSamplecSharpSample.Gamesmanagementv1management.Methods
{
    ...
    public static class PlayersSample
    {
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/players/hide
        ...
        public static void Hide(GamesmanagementService service, string applicationId, string playerId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                 service.Players.Hide(applicationId, playerId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Players.Hide failed.", ex);
            }
        }
        ...
        public static void Unhide(GamesmanagementService service, string applicationId, string playerId)
        {
            try
            {
                ...
                // Make the request.
                 service.Players.Unhide(applicationId, playerId).Execute();
            }
            catch (Exception ex)
            {
