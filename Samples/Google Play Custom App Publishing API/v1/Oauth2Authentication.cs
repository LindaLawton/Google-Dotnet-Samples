...
// About 
// 
// Unoffical sample for the Playcustomapp v1 API for C#. 
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.Playcustomapp.v1/ 
...
namespace GoogleSamplecSharpSample.Playcustomappv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PlaycustomappService used to make requests against the Playcustomapp API</returns>
        public static PlaycustomappService GetPlaycustomappService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Playcustomapp service failed.", ex);
            }
        }
        ...
        /// <returns>PlaycustomappService used to make requests against the Playcustomapp API</returns>
        private static PlaycustomappService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Playcustomapp API service.
                return new PlaycustomappService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Playcustomapp Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
