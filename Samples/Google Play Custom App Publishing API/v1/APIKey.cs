...
namespace GoogleSamplecSharpSample.Playcustomappv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PlaycustomappService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PlaycustomappService</returns>
        public static PlaycustomappService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Playcustomapp Service", ex);
            }
        }
    }
}
