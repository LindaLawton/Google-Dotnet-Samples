...
namespace GoogleSamplecSharpSample.Scriptv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ScriptService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ScriptService</returns>
        public static ScriptService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Script Service", ex);
            }
        }
    }
}
