...
These samples show how to access the [Cloud Tasks API](https://cloud.google.com/cloud-tasks/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
