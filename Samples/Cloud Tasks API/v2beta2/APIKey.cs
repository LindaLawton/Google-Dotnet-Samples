...
namespace GoogleSamplecSharpSample.Cloudtasksv2beta2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudtasksService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudtasksService</returns>
        public static CloudtasksService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudtasks Service", ex);
            }
        }
    }
}
