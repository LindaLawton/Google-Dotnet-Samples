...
namespace GoogleSamplecSharpSample.Cloudtasksv2beta2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CloudtasksService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CloudtasksService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Cloudtasks Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Cloudtasks service.
                    return new CloudtasksService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Cloudtasks Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCloudtasksFailed", ex);
            }
        }
    }
}