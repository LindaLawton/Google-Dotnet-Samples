...
namespace GoogleSamplecSharpSample.Cloudtasksv2beta2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudtasksService used to make requests against the Cloudtasks API</returns>
        public static CloudtasksService GetCloudtasksService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudtasks service failed.", ex);
            }
        }
        ...
        /// <returns>CloudtasksService used to make requests against the Cloudtasks API</returns>
        private static CloudtasksService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudtasks API service.
                return new CloudtasksService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudtasks Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
