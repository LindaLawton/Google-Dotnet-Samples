...
namespace GoogleSamplecSharpSample.Serviceuserv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ServiceuserService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ServiceuserService</returns>
        public static ServiceuserService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Serviceuser Service", ex);
            }
        }
    }
}
