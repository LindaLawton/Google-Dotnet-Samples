...
These samples show how to access the [Enterprise License Manager API](https://developers.google.com/google-apps/licensing/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
