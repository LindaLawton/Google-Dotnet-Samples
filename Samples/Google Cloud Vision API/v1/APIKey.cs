...
namespace GoogleSamplecSharpSample.Visionv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid VisionService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>VisionService</returns>
        public static VisionService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Vision Service", ex);
            }
        }
    }
}
