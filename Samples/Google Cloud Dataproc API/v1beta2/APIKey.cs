...
namespace GoogleSamplecSharpSample.Dataprocv1beta2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DataprocService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DataprocService</returns>
        public static DataprocService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Dataproc Service", ex);
            }
        }
    }
}
