...
namespace GoogleSamplecSharpSample.Datatransferdatatransfer_v1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DatatransferService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DatatransferService</returns>
        public static DatatransferService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Datatransfer Service", ex);
            }
        }
    }
}
