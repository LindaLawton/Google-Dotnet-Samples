...
namespace GoogleSamplecSharpSample.Datatransferdatatransfer_v1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DatatransferService used to make requests against the Datatransfer API</returns>
        public static DatatransferService GetDatatransferService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Datatransfer service failed.", ex);
            }
        }
        ...
        /// <returns>DatatransferService used to make requests against the Datatransfer API</returns>
        private static DatatransferService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Datatransfer API service.
