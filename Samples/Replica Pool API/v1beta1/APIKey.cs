...
namespace GoogleSamplecSharpSample.Replicapoolv1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ReplicapoolService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ReplicapoolService</returns>
        public static ReplicapoolService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Replicapool Service", ex);
            }
        }
    }
}
