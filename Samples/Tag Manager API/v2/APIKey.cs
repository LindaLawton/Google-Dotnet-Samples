...
namespace GoogleSamplecSharpSample.Tagmanagerv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid TagmanagerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>TagmanagerService</returns>
        public static TagmanagerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Tagmanager Service", ex);
            }
        }
    }
}
