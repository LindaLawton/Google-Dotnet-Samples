...
namespace GoogleSamplecSharpSample.Webmastersv3.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid WebmastersService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>WebmastersService</returns>
        public static WebmastersService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Webmasters Service", ex);
            }
        }
    }
}
