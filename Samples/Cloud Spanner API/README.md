...
These samples show how to access the [Cloud Spanner API](https://cloud.google.com/spanner/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
