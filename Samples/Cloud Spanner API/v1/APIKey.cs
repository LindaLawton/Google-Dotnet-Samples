...
namespace GoogleSamplecSharpSample.Spannerv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SpannerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SpannerService</returns>
        public static SpannerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Spanner Service", ex);
            }
        }
    }
}
