...
namespace GoogleSamplecSharpSample.Urlshortenerv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid UrlshortenerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>UrlshortenerService</returns>
        public static UrlshortenerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Urlshortener Service", ex);
            }
        }
    }
}
