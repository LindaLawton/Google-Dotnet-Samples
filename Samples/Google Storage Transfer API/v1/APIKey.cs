...
namespace GoogleSamplecSharpSample.Storagetransferv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid StoragetransferService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>StoragetransferService</returns>
        public static StoragetransferService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Storagetransfer Service", ex);
            }
        }
    }
}
