...
namespace GoogleSamplecSharpSample.Proximitybeaconv1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ProximitybeaconService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ProximitybeaconService</returns>
        public static ProximitybeaconService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Proximitybeacon Service", ex);
            }
        }
    }
}
