...
namespace GoogleSamplecSharpSample.Reportsreports_v1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ReportsService used to make requests against the Reports API</returns>
        public static ReportsService GetReportsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Reports service failed.", ex);
            }
        }
        ...
        /// <returns>ReportsService used to make requests against the Reports API</returns>
        private static ReportsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
