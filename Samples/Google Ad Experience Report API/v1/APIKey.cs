...
namespace GoogleSamplecSharpSample.Adexperiencereportv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AdexperiencereportService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AdexperiencereportService</returns>
        public static AdexperiencereportService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Adexperiencereport Service", ex);
            }
        }
    }
}
