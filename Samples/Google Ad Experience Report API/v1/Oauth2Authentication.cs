...
namespace GoogleSamplecSharpSample.Adexperiencereportv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AdexperiencereportService used to make requests against the Adexperiencereport API</returns>
        public static AdexperiencereportService GetAdexperiencereportService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Adexperiencereport service failed.", ex);
            }
        }
        ...
        /// <returns>AdexperiencereportService used to make requests against the Adexperiencereport API</returns>
        private static AdexperiencereportService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Adexperiencereport API service.
                return new AdexperiencereportService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Adexperiencereport Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
