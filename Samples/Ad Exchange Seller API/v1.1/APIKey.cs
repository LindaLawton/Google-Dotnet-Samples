...
namespace GoogleSamplecSharpSample.Adexchangesellerv1.1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AdexchangesellerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AdexchangesellerService</returns>
        public static AdexchangesellerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Adexchangeseller Service", ex);
            }
        }
    }
}
