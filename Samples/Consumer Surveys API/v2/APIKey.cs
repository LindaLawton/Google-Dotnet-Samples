...
namespace GoogleSamplecSharpSample.Consumersurveysv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ConsumersurveysService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ConsumersurveysService</returns>
        public static ConsumersurveysService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Consumersurveys Service", ex);
            }
        }
    }
}
