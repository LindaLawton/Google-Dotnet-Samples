...
namespace GoogleSamplecSharpSample.Adexchangebuyeriiv2beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AdexchangebuyeriiService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AdexchangebuyeriiService</returns>
        public static AdexchangebuyeriiService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Adexchangebuyerii Service", ex);
            }
        }
    }
}
