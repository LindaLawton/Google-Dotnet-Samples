...
namespace GoogleSamplecSharpSample.Adexchangebuyeriiv2beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AdexchangebuyeriiService used to make requests against the Adexchangebuyerii API</returns>
        public static AdexchangebuyeriiService GetAdexchangebuyeriiService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Adexchangebuyerii service failed.", ex);
            }
        }
        ...
        /// <returns>AdexchangebuyeriiService used to make requests against the Adexchangebuyerii API</returns>
        private static AdexchangebuyeriiService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Adexchangebuyerii API service.
