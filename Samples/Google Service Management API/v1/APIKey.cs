...
namespace GoogleSamplecSharpSample.Servicemanagementv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ServicemanagementService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ServicemanagementService</returns>
        public static ServicemanagementService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Servicemanagement Service", ex);
            }
        }
    }
}
