...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2betav2beta.Methods
{
    ...
    public static class ResourcesSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanagerv2beta/v2beta/reference/resources/get
        ...
        public static Resource Get(Deploymentmanagerv2betaService service, string project, string deployment, string resource)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanagerv2beta/v2beta/reference/resources/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanagerv2beta service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        /// <returns>ResourcesListResponseResponse</returns>
        public static ResourcesListResponse List(Deploymentmanagerv2betaService service, string project, string deployment, ResourcesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
