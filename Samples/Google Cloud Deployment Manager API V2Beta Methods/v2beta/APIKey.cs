...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2betav2beta.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid Deploymentmanagerv2betaService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>Deploymentmanagerv2betaService</returns>
        public static Deploymentmanagerv2betaService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Deploymentmanagerv2beta Service", ex);
            }
        }
    }
}
