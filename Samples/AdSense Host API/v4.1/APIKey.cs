...
namespace GoogleSamplecSharpSample.Adsensehostv4.1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AdsensehostService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AdsensehostService</returns>
        public static AdsensehostService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Adsensehost Service", ex);
            }
        }
    }
}
