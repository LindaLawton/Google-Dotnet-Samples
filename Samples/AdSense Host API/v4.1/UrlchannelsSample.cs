...
namespace GoogleSamplecSharpSample.Adsensehostv4_1.Methods
{
    ...
    public static class UrlchannelsSample
    {
        ...
        /// Documentation https://developers.google.com/adsensehost/v4.1/reference/urlchannels/delete
        ...
        public static UrlChannel Delete(AdsensehostService service, string adClientId, string urlChannelId)
        {
            try
            {
                // Initial validation.
                ...
                if (urlChannelId == null)
                    throw new ArgumentNullException(urlChannelId);

                // Make the request.
                return service.Urlchannels.Delete(adClientId, urlChannelId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Urlchannels.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/adsensehost/v4.1/reference/urlchannels/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adsensehost service.</param>  
        ...
        public static UrlChannels List(AdsensehostService service, string adClientId, UrlchannelsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
