...
using Google.Apis.Adsensehost.v4.1;
...
namespace GoogleSamplecSharpSample.Adsensehostv4.1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AdsensehostService used to make requests against the Adsensehost API</returns>
        public static AdsensehostService GetAdsensehostService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Adsensehost service failed.", ex);
            }
        }
        ...
        /// <returns>AdsensehostService used to make requests against the Adsensehost API</returns>
        private static AdsensehostService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Adsensehost API service.
                return new AdsensehostService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Adsensehost Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
