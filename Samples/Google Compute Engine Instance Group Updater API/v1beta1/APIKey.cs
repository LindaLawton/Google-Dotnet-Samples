...
namespace GoogleSamplecSharpSample.Replicapoolupdaterv1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ReplicapoolupdaterService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ReplicapoolupdaterService</returns>
        public static ReplicapoolupdaterService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Replicapoolupdater Service", ex);
            }
        }
    }
}
