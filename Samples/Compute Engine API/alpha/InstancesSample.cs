...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class InstancesSample
    {
        ...
        public class InstancesGetGuestAttributesOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/getGuestAttributes
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>GuestAttributesResponse</returns>
        public static GuestAttributes GetGuestAttributes(ComputeService service, string project, string zone, string instance, InstancesGetGuestAttributesOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Instances.GetGuestAttributes(project, zone, instance);

                // Applying optional parameters to the request.                
                request = (InstancesResource.GetGuestAttributesRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Instances.GetGuestAttributes failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/listReferrers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class InstancesSetDeletionProtectionOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/setDeletionProtection
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SetDeletionProtection(ComputeService service, string project, string zone, string resource, InstancesSetDeletionProtectionOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Instances.SetDeletionProtection(project, zone, resource);

                // Applying optional parameters to the request.                
                request = (InstancesResource.SetDeletionProtectionRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Instances.SetDeletionProtection failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/setMachineResources
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/setMinCpuPlatform
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/simulateMaintenanceEvent
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="instance">Name of the instance scoping this request.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SimulateMaintenanceEvent(ComputeService service, string project, string zone, string instance)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Instances.SimulateMaintenanceEvent(project, zone, instance).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Instances.SimulateMaintenanceEvent failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instances/updateNetworkInterface
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
