...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class InterconnectAttachmentsSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/aggregatedList
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/getIamPolicy
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static Policy GetIamPolicy(ComputeService service, string project, string region, string resource)
        {
            try
            {
                ...
                // Make the request.
                return service.InterconnectAttachments.GetIamPolicy(project, region, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request InterconnectAttachments.GetIamPolicy failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/setIamPolicy
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static Policy SetIamPolicy(ComputeService service, string project, string region, string resource, Policy body)
        {
            try
            {
                ...
                // Make the request.
                return service.InterconnectAttachments.SetIamPolicy(body, project, region, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request InterconnectAttachments.SetIamPolicy failed.", ex);
            }
        }

        /// <summary>
        /// Returns permissions that a caller has on the specified resource. 
        /// Documentation https://developers.google.com/compute/alpha/reference/interconnectAttachments/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
