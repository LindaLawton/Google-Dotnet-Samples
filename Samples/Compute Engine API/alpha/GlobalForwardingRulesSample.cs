...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class GlobalForwardingRulesSample
    {

        public class GlobalForwardingRulesDeleteOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/delete
        ...
        public static Operation Delete(ComputeService service, string project, string forwardingRule, GlobalForwardingRulesDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.GlobalForwardingRules.Delete(project, forwardingRule);

                // Applying optional parameters to the request.                
                request = (GlobalForwardingRulesResource.DeleteRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request GlobalForwardingRules.Delete failed.", ex);
            }
        }

        /// <summary>
        /// Returns the specified GlobalForwardingRule resource. Get a list of available forwarding rules by making a list() request. 
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class GlobalForwardingRulesInsertOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        public class GlobalForwardingRulesListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class GlobalForwardingRulesPatchOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(ComputeService service, string project, string forwardingRule, ForwardingRule body, GlobalForwardingRulesPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.GlobalForwardingRules.Patch(body, project, forwardingRule);

                // Applying optional parameters to the request.                
                request = (GlobalForwardingRulesResource.PatchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request GlobalForwardingRules.Patch failed.", ex);
            }
        }

        /// <summary>
        /// Sets the labels on the specified resource. To learn more about labels, read the Labeling Resources documentation. 
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/setLabels
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static Operation SetLabels(ComputeService service, string project, string resource, GlobalSetLabelsRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.GlobalForwardingRules.SetLabels(body, project, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request GlobalForwardingRules.SetLabels failed.", ex);
            }
        }
        public class GlobalForwardingRulesSetTargetOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/setTarget
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SetTarget(ComputeService service, string project, string forwardingRule, TargetReference body, GlobalForwardingRulesSetTargetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.GlobalForwardingRules.SetTarget(body, project, forwardingRule);

                // Applying optional parameters to the request.                
                request = (GlobalForwardingRulesResource.SetTargetRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request GlobalForwardingRules.SetTarget failed.", ex);
            }
        }

        /// <summary>
        /// Returns permissions that a caller has on the specified resource. 
        /// Documentation https://developers.google.com/compute/alpha/reference/globalForwardingRules/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static TestPermissionsResponse TestIamPermissions(ComputeService service, string project, string resource, TestPermissionsRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.GlobalForwardingRules.TestIamPermissions(body, project, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request GlobalForwardingRules.TestIamPermissions failed.", ex);
            }
        }
