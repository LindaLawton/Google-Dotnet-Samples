...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class HttpsHealthChecksSample
    {

        public class HttpsHealthChecksDeleteOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/delete
        ...
        public static Operation Delete(ComputeService service, string project, string httpsHealthCheck, HttpsHealthChecksDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.HttpsHealthChecks.Delete(project, httpsHealthCheck);

                // Applying optional parameters to the request.                
                request = (HttpsHealthChecksResource.DeleteRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request HttpsHealthChecks.Delete failed.", ex);
            }
        }

        /// <summary>
        /// Returns the specified HttpsHealthCheck resource. Get a list of available HTTPS health checks by making a list() request. 
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class HttpsHealthChecksInsertOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        public class HttpsHealthChecksListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>HttpsHealthCheckListResponse</returns>
        public static HttpsHealthCheckList List(ComputeService service, string project, HttpsHealthChecksListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.HttpsHealthChecks.List(project);

                // Applying optional parameters to the request.                
                request = (HttpsHealthChecksResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request HttpsHealthChecks.List failed.", ex);
            }
        }
        public class HttpsHealthChecksPatchOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(ComputeService service, string project, string httpsHealthCheck, HttpsHealthCheck body, HttpsHealthChecksPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.HttpsHealthChecks.Patch(body, project, httpsHealthCheck);

                // Applying optional parameters to the request.                
                request = (HttpsHealthChecksResource.PatchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request HttpsHealthChecks.Patch failed.", ex);
            }
        }

        /// <summary>
        /// Returns permissions that a caller has on the specified resource. 
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static TestPermissionsResponse TestIamPermissions(ComputeService service, string project, string resource, TestPermissionsRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.HttpsHealthChecks.TestIamPermissions(body, project, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request HttpsHealthChecks.TestIamPermissions failed.", ex);
            }
        }
        public class HttpsHealthChecksUpdateOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/httpsHealthChecks/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
