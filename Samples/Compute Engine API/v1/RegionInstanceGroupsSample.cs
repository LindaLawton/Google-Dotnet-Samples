...
namespace GoogleSamplecSharpSample.Computev1.Methods
{
    ...
    public static class RegionInstanceGroupsSample
    {
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/regionInstanceGroups/get
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/regionInstanceGroups/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/regionInstanceGroups/listInstances
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/regionInstanceGroups/setNamedPorts
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
