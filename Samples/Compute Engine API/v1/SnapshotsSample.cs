...
namespace GoogleSamplecSharpSample.Computev1.Methods
{
    ...
    public static class SnapshotsSample
    {
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/snapshots/delete
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/snapshots/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/snapshots/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/v1/reference/snapshots/setLabels
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
