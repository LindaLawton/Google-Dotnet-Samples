...
namespace GoogleSamplecSharpSample.Qpxexpressv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid QpxexpressService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>QpxexpressService</returns>
        public static QpxexpressService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Qpxexpress Service", ex);
            }
        }
    }
}
