...
namespace GoogleSamplecSharpSample.Webfontsv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid WebfontsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>WebfontsService</returns>
        public static WebfontsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Webfonts Service", ex);
            }
        }
    }
}
