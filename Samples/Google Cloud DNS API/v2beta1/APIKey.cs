...
namespace GoogleSamplecSharpSample.Dnsv2beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DnsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DnsService</returns>
        public static DnsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Dns Service", ex);
            }
        }
    }
}
