...
namespace GoogleSamplecSharpSample.Cloudmonitoringv2beta2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudmonitoringService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudmonitoringService</returns>
        public static CloudmonitoringService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudmonitoring Service", ex);
            }
        }
    }
}
