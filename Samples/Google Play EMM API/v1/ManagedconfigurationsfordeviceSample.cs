...
namespace GoogleSamplecSharpSample.Androidenterprisev1.Methods
{
    ...
    public static class ManagedconfigurationsfordeviceSample
    {
        ...
        public static void Delete(AndroidenterpriseService service, string enterpriseId, string userId, string deviceId, string managedConfigurationForDeviceId)
        {
            try
            {
                ...
                // Make the request.
                 service.Managedconfigurationsfordevice.Delete(enterpriseId, userId, deviceId, managedConfigurationForDeviceId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/managedconfigurationsfordevice/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Androidenterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        public static ManagedConfiguration Get(AndroidenterpriseService service, string enterpriseId, string userId, string deviceId, string managedConfigurationForDeviceId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Managedconfigurationsfordevice.Get(enterpriseId, userId, deviceId, managedConfigurationForDeviceId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Managedconfigurationsfordevice.Get failed.", ex);
            }
        }

        /// <summary>
        /// Lists all the per-device managed configurations for the specified device. Only the ID is set. 
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/managedconfigurationsfordevice/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Androidenterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        /// <param name="userId">The ID of the user.</param>
        /// <param name="deviceId">The Android ID of the device.</param>
        /// <returns>ManagedConfigurationsForDeviceListResponseResponse</returns>
        public static ManagedConfigurationsForDeviceListResponse List(AndroidenterpriseService service, string enterpriseId, string userId, string deviceId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Managedconfigurationsfordevice.List(enterpriseId, userId, deviceId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Managedconfigurationsfordevice.List failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/managedconfigurationsfordevice/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Androidenterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        /// <returns>ManagedConfigurationResponse</returns>
        public static ManagedConfiguration Patch(AndroidenterpriseService service, string enterpriseId, string userId, string deviceId, string managedConfigurationForDeviceId, ManagedConfiguration body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Managedconfigurationsfordevice.Patch(body, enterpriseId, userId, deviceId, managedConfigurationForDeviceId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Managedconfigurationsfordevice.Patch failed.", ex);
            }
        }
