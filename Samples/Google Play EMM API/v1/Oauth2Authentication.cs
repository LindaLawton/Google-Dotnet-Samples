...
namespace GoogleSamplecSharpSample.Androidenterprisev1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AndroidenterpriseService used to make requests against the Androidenterprise API</returns>
        public static AndroidenterpriseService GetAndroidenterpriseService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Androidenterprise service failed.", ex);
            }
        }
        ...
        /// <returns>AndroidenterpriseService used to make requests against the Androidenterprise API</returns>
        private static AndroidenterpriseService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Androidenterprise API service.
                return new AndroidenterpriseService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Androidenterprise Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
