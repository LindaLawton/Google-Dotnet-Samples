...
namespace GoogleSamplecSharpSample.Androidenterprisev1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AndroidenterpriseService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AndroidenterpriseService</returns>
        public static AndroidenterpriseService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Androidenterprise Service", ex);
            }
        }
    }
}
