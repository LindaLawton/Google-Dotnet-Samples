...
namespace GoogleSamplecSharpSample.Cloudtracev2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudtraceService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudtraceService</returns>
        public static CloudtraceService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudtrace Service", ex);
            }
        }
    }
}
