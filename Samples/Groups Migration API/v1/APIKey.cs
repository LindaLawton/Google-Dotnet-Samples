...
namespace GoogleSamplecSharpSample.Groupsmigrationv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GroupsmigrationService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GroupsmigrationService</returns>
        public static GroupsmigrationService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Groupsmigration Service", ex);
            }
        }
    }
}
