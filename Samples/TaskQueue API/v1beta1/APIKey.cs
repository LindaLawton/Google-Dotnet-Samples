...
namespace GoogleSamplecSharpSample.Taskqueuev1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid TaskqueueService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>TaskqueueService</returns>
        public static TaskqueueService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Taskqueue Service", ex);
            }
        }
    }
}
