...
namespace GoogleSamplecSharpSample.Servicecontrolv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ServicecontrolService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ServicecontrolService</returns>
        public static ServicecontrolService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Servicecontrol Service", ex);
            }
        }
    }
}
