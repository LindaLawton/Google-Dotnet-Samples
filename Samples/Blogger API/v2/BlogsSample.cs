...
namespace GoogleSamplecSharpSample.Bloggerv2.Methods
{
    ...
    public static class BlogsSample
    {
        ...
        /// <summary>
        /// Gets one blog by id. 
        /// Documentation https://developers.google.com/blogger/v2/reference/blogs/get
        ...
        public static Blog Get(BloggerService service, string blogId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Blogs.Get(blogId).Execute();
            }
            catch (Exception ex)
            {
