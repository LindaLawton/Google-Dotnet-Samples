...
namespace GoogleSamplecSharpSample.Bloggerv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid BloggerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>BloggerService</returns>
        public static BloggerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Blogger Service", ex);
            }
        }
    }
}
