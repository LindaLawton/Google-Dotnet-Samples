...
namespace GoogleSamplecSharpSample.Bloggerv3.Methods
{
    ...
    public static class UsersSample
    {
        ...
        /// <summary>
        /// Gets one user by ID. 
        /// Documentation https://developers.google.com/blogger/v3/reference/users/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Blogger service.</param>  
        /// <param name="userId">The ID of the user to get.</param>
        /// <returns>UserResponse</returns>
        public static User Get(BloggerService service, string userId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Users.Get(userId).Execute();
            }
            catch (Exception ex)
            {
