...
namespace GoogleSamplecSharpSample.Cloudosloginv1beta.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudosloginService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudosloginService</returns>
        public static CloudosloginService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudoslogin Service", ex);
            }
        }
    }
}
