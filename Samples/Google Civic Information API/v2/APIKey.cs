...
namespace GoogleSamplecSharpSample.Civicinfov2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CivicinfoService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CivicinfoService</returns>
        public static CivicinfoService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Civicinfo Service", ex);
            }
        }
    }
}
