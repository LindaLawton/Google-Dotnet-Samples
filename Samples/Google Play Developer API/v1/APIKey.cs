...
namespace GoogleSamplecSharpSample.Androidpublisherv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AndroidpublisherService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AndroidpublisherService</returns>
        public static AndroidpublisherService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Androidpublisher Service", ex);
            }
        }
    }
}
