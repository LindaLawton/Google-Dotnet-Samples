...
namespace GoogleSamplecSharpSample.Vaultv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid VaultService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>VaultService</returns>
        public static VaultService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Vault Service", ex);
            }
        }
    }
}
