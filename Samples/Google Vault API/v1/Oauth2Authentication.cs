...
// About 
// 
// Unoffical sample for the Vault v1 API for C#. 
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.Vault.v1/ 
...
namespace GoogleSamplecSharpSample.Vaultv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>VaultService used to make requests against the Vault API</returns>
        public static VaultService GetVaultService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Vault service failed.", ex);
            }
        }
        ...
        /// <returns>VaultService used to make requests against the Vault API</returns>
        private static VaultService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                return new VaultService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Vault Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
