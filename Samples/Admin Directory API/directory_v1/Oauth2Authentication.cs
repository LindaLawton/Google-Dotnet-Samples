...
namespace GoogleSamplecSharpSample.Directorydirectory_v1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DirectoryService used to make requests against the Directory API</returns>
        public static DirectoryService GetDirectoryService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Directory service failed.", ex);
            }
        }
        ...
        /// <returns>DirectoryService used to make requests against the Directory API</returns>
        private static DirectoryService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
