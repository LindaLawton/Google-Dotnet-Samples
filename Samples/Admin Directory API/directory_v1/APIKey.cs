...
namespace GoogleSamplecSharpSample.Directorydirectory_v1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DirectoryService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DirectoryService</returns>
        public static DirectoryService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Directory Service", ex);
            }
        }
    }
}
