...
namespace GoogleSamplecSharpSample.Directorydirectory_v1.Methods
{
    ...
    public static class VerificationCodesSample
    {


        /// <summary>
        /// Generate new backup verification codes for the user. 
        /// Documentation https://developers.google.com/directory/directory_v1/reference/verificationCodes/generate
        ...
        public static void Generate(DirectoryService service, string userKey)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                 service.VerificationCodes.Generate(userKey).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request VerificationCodes.Generate failed.", ex);
            }
        }
        ...
        public static void Invalidate(DirectoryService service, string userKey)
        {
            try
            {
                ...
                // Make the request.
                 service.VerificationCodes.Invalidate(userKey).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/verificationCodes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Directory service.</param>  
        ...
        /// <returns>VerificationCodesResponse</returns>
        public static VerificationCodes List(DirectoryService service, string userKey)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.VerificationCodes.List(userKey).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request VerificationCodes.List failed.", ex);
            }
        }
