...
namespace GoogleSamplecSharpSample.Directorydirectory_v1.Methods
{
    ...
    public static class CustomersSample
    {
        ...
        /// Documentation https://developers.google.com/directory/directory_v1/reference/customers/get
        ...
        public static Customer Get(DirectoryService service, string customerKey)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Customers.Get(customerKey).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Updates a customer. 
        /// Documentation https://developers.google.com/directory/directory_v1/reference/customers/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Directory service.</param>  
        /// <param name="customerKey">Id of the customer to be updated</param>
        /// <param name="body">A valid Directory directory_v1 body.</param>
        /// <returns>CustomerResponse</returns>
        public static Customer Update(DirectoryService service, string customerKey, Customer body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Customers.Update(body, customerKey).Execute();
            }
            catch (Exception ex)
            {
