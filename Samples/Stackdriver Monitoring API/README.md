...
These samples show how to access the [Stackdriver Monitoring API](https://cloud.google.com/monitoring/api/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
