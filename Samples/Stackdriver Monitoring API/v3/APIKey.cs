...
namespace GoogleSamplecSharpSample.Monitoringv3.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid MonitoringService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>MonitoringService</returns>
        public static MonitoringService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Monitoring Service", ex);
            }
        }
    }
}
