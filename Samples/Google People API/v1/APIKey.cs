...
namespace GoogleSamplecSharpSample.Peopleservicev1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PeopleserviceService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PeopleserviceService</returns>
        public static PeopleserviceService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Peopleservice Service", ex);
            }
        }
    }
}
