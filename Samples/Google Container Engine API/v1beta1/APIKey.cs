...
namespace GoogleSamplecSharpSample.Containerv1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ContainerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ContainerService</returns>
        public static ContainerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Container Service", ex);
            }
        }
    }
}
