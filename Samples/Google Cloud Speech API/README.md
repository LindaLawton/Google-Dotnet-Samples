...
These samples show how to access the [Google Cloud Speech API](https://cloud.google.com/speech/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
