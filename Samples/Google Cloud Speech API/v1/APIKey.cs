...
namespace GoogleSamplecSharpSample.Speechv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SpeechService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SpeechService</returns>
        public static SpeechService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Speech Service", ex);
            }
        }
    }
}
