...
namespace GoogleSamplecSharpSample.Cloudiotv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudiotService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudiotService</returns>
        public static CloudiotService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudiot Service", ex);
            }
        }
    }
}
