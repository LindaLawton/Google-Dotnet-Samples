...
// About 
// 
// Unoffical sample for the Cloudiot v1 API for C#. 
...
//
// Discovery Doc  https://www.googleapis.com/discovery/v1/apis/Cloudiot/v1/rest
//
//------------------------------------------------------------------------------
// Installation
//
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.Cloudiot.v1/ 
...
namespace GoogleSamplecSharpSample.Cloudiotv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudiotService used to make requests against the Cloudiot API</returns>
        public static CloudiotService GetCloudiotService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudiot service failed.", ex);
            }
        }
        ...
        /// <returns>CloudiotService used to make requests against the Cloudiot API</returns>
        private static CloudiotService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudiot API service.
                return new CloudiotService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudiot Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
