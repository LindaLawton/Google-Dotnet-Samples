...
# Unoffical Google Cloud IoT API Samples for .NET  
...
These samples show how to access the [Google Cloud IoT API](https://cloud.google.com/iot) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
