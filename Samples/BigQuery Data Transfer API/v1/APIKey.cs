...
namespace GoogleSamplecSharpSample.Bigquerydatatransferv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid BigquerydatatransferService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>BigquerydatatransferService</returns>
        public static BigquerydatatransferService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Bigquerydatatransfer Service", ex);
            }
        }
    }
}
