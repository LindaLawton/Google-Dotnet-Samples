...
namespace GoogleSamplecSharpSample.Discoveryv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DiscoveryService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DiscoveryService</returns>
        public static DiscoveryService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Discovery Service", ex);
            }
        }
    }
}
