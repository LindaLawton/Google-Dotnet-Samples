...
namespace GoogleSamplecSharpSample.Plusv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PlusService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PlusService</returns>
        public static PlusService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Plus Service", ex);
            }
        }
    }
}
