...
These samples show how to access the [Google Classroom API](https://developers.google.com/classroom/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
