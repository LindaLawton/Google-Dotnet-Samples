...
namespace GoogleSamplecSharpSample.Classroomv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ClassroomService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ClassroomService</returns>
        public static ClassroomService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Classroom Service", ex);
            }
        }
    }
}
