...
namespace GoogleSamplecSharpSample.Analyticsv2.4.Auth
{
    public static class Oauth2Example
    {
        ...
        public static AnalyticsService GetAnalyticsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Analytics service failed.", ex);
            }
        }
