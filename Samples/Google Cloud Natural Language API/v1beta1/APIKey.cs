...
namespace GoogleSamplecSharpSample.Cloudnaturallanguagev1beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudnaturallanguageService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudnaturallanguageService</returns>
        public static CloudnaturallanguageService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudnaturallanguage Service", ex);
            }
        }
    }
}
