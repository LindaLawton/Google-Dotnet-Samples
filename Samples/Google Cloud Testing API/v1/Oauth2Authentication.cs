...
namespace GoogleSamplecSharpSample.Testingv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>TestingService used to make requests against the Testing API</returns>
        public static TestingService GetTestingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Testing service failed.", ex);
            }
        }
        ...
        /// <returns>TestingService used to make requests against the Testing API</returns>
        private static TestingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Testing API service.
                return new TestingService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Testing Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
