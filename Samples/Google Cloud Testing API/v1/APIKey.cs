...
namespace GoogleSamplecSharpSample.Testingv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid TestingService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>TestingService</returns>
        public static TestingService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Testing Service", ex);
            }
        }
    }
}
