...
namespace GoogleSamplecSharpSample.Testingv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static TestingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new TestingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Testing Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Testing Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountTestingFailed", ex);
            }
        }
    }
}