...
namespace GoogleSamplecSharpSample.Gamesconfigurationv1configuration.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GamesconfigurationService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GamesconfigurationService</returns>
        public static GamesconfigurationService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Gamesconfiguration Service", ex);
            }
        }
    }
}
