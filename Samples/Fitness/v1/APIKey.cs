...
namespace GoogleSamplecSharpSample.Fitnessv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid FitnessService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>FitnessService</returns>
        public static FitnessService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Fitness Service", ex);
            }
        }
    }
}
