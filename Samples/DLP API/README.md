![DLP API](http://www.google.com/images/icons/product/search-32.gif)
...
These samples show how to access the [DLP API](https://cloud.google.com/dlp/docs/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
