...
namespace GoogleSamplecSharpSample.Dlpv2beta1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DlpService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DlpService</returns>
        public static DlpService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Dlp Service", ex);
            }
        }
    }
}
