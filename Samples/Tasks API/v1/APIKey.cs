...
namespace GoogleSamplecSharpSample.Tasksv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid TasksService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>TasksService</returns>
        public static TasksService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Tasks Service", ex);
            }
        }
    }
}
