...
namespace GoogleSamplecSharpSample.Firebaseremoteconfigv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid FirebaseremoteconfigService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>FirebaseremoteconfigService</returns>
        public static FirebaseremoteconfigService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Firebaseremoteconfig Service", ex);
            }
        }
    }
}
