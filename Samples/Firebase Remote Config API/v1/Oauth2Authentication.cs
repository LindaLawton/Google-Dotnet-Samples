...
namespace GoogleSamplecSharpSample.Firebaseremoteconfigv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>FirebaseremoteconfigService used to make requests against the Firebaseremoteconfig API</returns>
        public static FirebaseremoteconfigService GetFirebaseremoteconfigService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Firebaseremoteconfig service failed.", ex);
            }
        }
        ...
        /// <returns>FirebaseremoteconfigService used to make requests against the Firebaseremoteconfig API</returns>
        private static FirebaseremoteconfigService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Firebaseremoteconfig API service.
                return new FirebaseremoteconfigService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Firebaseremoteconfig Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
