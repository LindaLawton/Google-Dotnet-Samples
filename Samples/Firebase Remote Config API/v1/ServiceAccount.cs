...
namespace GoogleSamplecSharpSample.Firebaseremoteconfigv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static FirebaseremoteconfigService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new FirebaseremoteconfigService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Firebaseremoteconfig Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Firebaseremoteconfig service.
                    return new FirebaseremoteconfigService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Firebaseremoteconfig Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountFirebaseremoteconfigFailed", ex);
            }
        }
    }
}