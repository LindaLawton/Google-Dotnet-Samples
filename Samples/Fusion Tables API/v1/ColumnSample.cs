...
namespace GoogleSamplecSharpSample.Fusiontablesv1.Methods
{
    ...
    public static class ColumnSample
    {
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/column/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Fusiontables service.</param>  
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/column/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Fusiontables service.</param>  
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/column/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Fusiontables service.</param>  
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/column/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Fusiontables service.</param>  
        /// <param name="tableId">Table for which the column is being updated.</param>
