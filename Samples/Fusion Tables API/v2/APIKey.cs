...
namespace GoogleSamplecSharpSample.Fusiontablesv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid FusiontablesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>FusiontablesService</returns>
        public static FusiontablesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Fusiontables Service", ex);
            }
        }
    }
}
