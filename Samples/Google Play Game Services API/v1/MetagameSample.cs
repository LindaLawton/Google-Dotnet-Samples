...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class MetagameSample
    {

        public class MetagameGetMetagameConfigOptionalParms
        {
        ...
        public class MetagameListCategoriesByPlayerOptionalParms
        {
            /// The last-seen mutation timestamp.
            public string ConsistencyToken { get; set; }  
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>CategoryListResponseResponse</returns>
