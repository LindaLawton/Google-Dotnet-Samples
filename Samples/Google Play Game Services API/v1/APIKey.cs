...
namespace GoogleSamplecSharpSample.Gamesv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GamesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GamesService</returns>
        public static GamesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Games Service", ex);
            }
        }
    }
}
