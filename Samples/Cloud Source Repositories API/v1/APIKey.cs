...
namespace GoogleSamplecSharpSample.Cloudsourcerepositoriesv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudsourcerepositoriesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudsourcerepositoriesService</returns>
        public static CloudsourcerepositoriesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudsourcerepositories Service", ex);
            }
        }
    }
}
