...
These samples show how to access the [Stackdriver Debugger API](http://cloud.google.com/debugger) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
