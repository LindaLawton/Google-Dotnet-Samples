...
These samples show how to access the [DoubleClick Search API](https://developers.google.com/doubleclick-search/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
