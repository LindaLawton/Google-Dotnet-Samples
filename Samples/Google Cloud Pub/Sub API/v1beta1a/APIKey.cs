...
namespace GoogleSamplecSharpSample.Pubsubv1beta1a.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PubsubService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PubsubService</returns>
        public static PubsubService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Pubsub Service", ex);
            }
        }
    }
}
