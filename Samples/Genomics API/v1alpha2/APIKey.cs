...
namespace GoogleSamplecSharpSample.Genomicsv1alpha2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GenomicsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GenomicsService</returns>
        public static GenomicsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Genomics Service", ex);
            }
        }
    }
}
