...
namespace GoogleSamplecSharpSample.Dfareportingv2_7.Methods
{
    ...
    public static class DirectorySiteContactsSample
    {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.7/reference/directorySiteContacts/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.7/reference/directorySiteContacts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
