...
namespace GoogleSamplecSharpSample.Dfareportingv2.7.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DfareportingService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DfareportingService</returns>
        public static DfareportingService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Dfareporting Service", ex);
            }
        }
    }
}
