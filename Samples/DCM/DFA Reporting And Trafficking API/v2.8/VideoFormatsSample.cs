...
namespace GoogleSamplecSharpSample.Dfareportingv2_8.Methods
{
    ...
    public static class VideoFormatsSample
    {


        /// <summary>
        /// Gets one video format by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/videoFormats/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/videoFormats/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>VideoFormatsListResponseResponse</returns>
        public static VideoFormatsListResponse List(DfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.VideoFormats.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request VideoFormats.List failed.", ex);
            }
        }
