...
namespace GoogleSamplecSharpSample.Dfareportingv2_8.Methods
{
    ...
    public static class UserRolePermissionGroupsSample
    {


        /// <summary>
        /// Gets one user role permission group by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/userRolePermissionGroups/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/userRolePermissionGroups/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>UserRolePermissionGroupsListResponseResponse</returns>
        public static UserRolePermissionGroupsListResponse List(DfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.UserRolePermissionGroups.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request UserRolePermissionGroups.List failed.", ex);
            }
        }
