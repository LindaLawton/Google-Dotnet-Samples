...
namespace GoogleSamplecSharpSample.Dfareportingv2_8.Methods
{
    ...
    public static class SubaccountsSample
    {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/subaccounts/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/subaccounts/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/subaccounts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/subaccounts/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.8/reference/subaccounts/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
