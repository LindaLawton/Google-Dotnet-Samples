...
namespace GoogleSamplecSharpSample.Adexchangebuyerv1.2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AdexchangebuyerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AdexchangebuyerService</returns>
        public static AdexchangebuyerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Adexchangebuyer Service", ex);
            }
        }
    }
}
