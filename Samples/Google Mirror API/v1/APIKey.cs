...
namespace GoogleSamplecSharpSample.Mirrorv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid MirrorService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>MirrorService</returns>
        public static MirrorService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Mirror Service", ex);
            }
        }
    }
}
