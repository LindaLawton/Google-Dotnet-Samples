...
namespace GoogleSamplecSharpSample.Mirrorv1.Methods
{
    ...
    public static class LocationsSample
    {
        ...
        /// Documentation https://developers.google.com/mirror/v1/reference/locations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Mirror service.</param>  
        /// <returns>LocationsListResponseResponse</returns>
        public static LocationsListResponse List(MirrorService service)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Locations.List().Execute();
            }
            catch (Exception ex)
            {
