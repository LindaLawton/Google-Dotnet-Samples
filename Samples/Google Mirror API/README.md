...
These samples show how to access the [Google Mirror API](https://developers.google.com/glass) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
