...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/operations/get
        ...
        public static Operation Get(DeploymentmanageralphaService service, string project, string operation)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static OperationsListResponse List(DeploymentmanageralphaService service, string project, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Operations.List(project);
