...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Methods
{
    ...
    public static class ResourcesSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/resources/get
        ...
        public static Resource Get(DeploymentmanageralphaService service, string project, string deployment, string resource)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/resources/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static ResourcesListResponse List(DeploymentmanageralphaService service, string project, string deployment, ResourcesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
