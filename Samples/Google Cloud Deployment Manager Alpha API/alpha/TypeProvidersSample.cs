...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Methods
{
    ...
    public static class TypeProvidersSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/delete
        ...
        public static Operation Delete(DeploymentmanageralphaService service, string project, string typeProvider)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/getType
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static TypeInfo GetType(DeploymentmanageralphaService service, string project, string typeProvider, string type)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static TypeProvidersListResponse List(DeploymentmanageralphaService service, string project, TypeProvidersListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/listTypes
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static TypeProvidersListTypesResponse ListTypes(DeploymentmanageralphaService service, string project, string typeProvider, TypeProvidersListTypesOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        /// <param name="body">A valid Deploymentmanageralpha alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(DeploymentmanageralphaService service, string project, string typeProvider, TypeProvider body)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/typeProviders/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        /// <param name="body">A valid Deploymentmanageralpha alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Update(DeploymentmanageralphaService service, string project, string typeProvider, TypeProvider body)
        {
            try
            {
                // Initial validation.
