...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Methods
{
    ...
    public static class ManifestsSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/manifests/get
        ...
        public static Manifest Get(DeploymentmanageralphaService service, string project, string deployment, string manifest)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/manifests/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static ManifestsListResponse List(DeploymentmanageralphaService service, string project, string deployment, ManifestsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
