...
namespace GoogleSamplecSharpSample.Deploymentmanageralphaalpha.Methods
{
    ...
    public static class CompositeTypesSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/compositeTypes/delete
        ...
        public static Operation Delete(DeploymentmanageralphaService service, string project, string compositeType)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/compositeTypes/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        /// <returns>OperationResponse</returns>
        public static Operation Insert(DeploymentmanageralphaService service, string project, CompositeType body)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/compositeTypes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static CompositeTypesListResponse List(DeploymentmanageralphaService service, string project, CompositeTypesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/deploymentmanageralpha/alpha/reference/compositeTypes/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanageralpha service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        /// <param name="body">A valid Deploymentmanageralpha alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(DeploymentmanageralphaService service, string project, string compositeType, CompositeType body)
        {
            try
            {
                // Initial validation.
