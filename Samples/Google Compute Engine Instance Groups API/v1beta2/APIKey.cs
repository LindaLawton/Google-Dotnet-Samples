...
namespace GoogleSamplecSharpSample.Resourceviewsv1beta2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ResourceviewsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ResourceviewsService</returns>
        public static ResourceviewsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Resourceviews Service", ex);
            }
        }
    }
}
