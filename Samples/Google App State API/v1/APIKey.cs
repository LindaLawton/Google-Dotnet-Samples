...
namespace GoogleSamplecSharpSample.Appstatev1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AppstateService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AppstateService</returns>
        public static AppstateService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Appstate Service", ex);
            }
        }
    }
}
