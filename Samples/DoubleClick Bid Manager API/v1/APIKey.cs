...
namespace GoogleSamplecSharpSample.Doubleclickbidmanagerv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DoubleclickbidmanagerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DoubleclickbidmanagerService</returns>
        public static DoubleclickbidmanagerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Doubleclickbidmanager Service", ex);
            }
        }
    }
}
