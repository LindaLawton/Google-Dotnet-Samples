...
namespace GoogleSamplecSharpSample.Partnersv2.Methods
{
    ...
    public static class AnalyticsSample
    {

        public class AnalyticsListOptionalParms
        {
            ...
            /// A token identifying a page of results that the server returns.Typically, this is the value of `ListAnalyticsResponse.next_page_token`returned from the previous call toListAnalytics.Will be a date string in `YYYY-MM-DD` format representing the end dateof the date range of results to return.If unspecified or set to "", default value is the current date.
            public string PageToken { get; set; }  
            /// Requested page size. Server may return fewer analytics than requested.If unspecified or set to 0, default value is 30.Specifies the number of days in the date range when querying analytics.The `page_token` represents the end date of the date rangeand the start date is calculated using the `page_size` as the numberof days BEFORE the end date.Must be a non-negative integer.
        ...
        /// Documentation https://developers.google.com/partners/v2/reference/analytics/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Partners service.</param>  
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>ListAnalyticsResponseResponse</returns>
        public static ListAnalyticsResponse List(PartnersService service, AnalyticsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Analytics.List();

                // Applying optional parameters to the request.                
                request = (AnalyticsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Analytics.List failed.", ex);
            }
        }
