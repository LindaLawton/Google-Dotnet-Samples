...
These samples show how to access the [Google Identity and Access Management (IAM) API](https://cloud.google.com/iam/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
