...
namespace GoogleSamplecSharpSample.Iamv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid IamService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>IamService</returns>
        public static IamService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Iam Service", ex);
            }
        }
    }
}
