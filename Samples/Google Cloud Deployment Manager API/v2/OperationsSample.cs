...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/deploymentmanager/v2/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Deploymentmanager service.</param>  
        /// <param name="project">The project ID for this request.</param>
        ...
        public static OperationsListResponse List(DeploymentmanagerService service, string project, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
