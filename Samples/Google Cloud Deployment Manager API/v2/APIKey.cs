...
namespace GoogleSamplecSharpSample.Deploymentmanagerv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid DeploymentmanagerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>DeploymentmanagerService</returns>
        public static DeploymentmanagerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Deploymentmanager Service", ex);
            }
        }
    }
}
