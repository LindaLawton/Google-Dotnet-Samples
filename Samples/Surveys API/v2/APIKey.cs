...
namespace GoogleSamplecSharpSample.Surveysv2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SurveysService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SurveysService</returns>
        public static SurveysService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Surveys Service", ex);
            }
        }
    }
}
