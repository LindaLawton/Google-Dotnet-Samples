...
These samples show how to access the [Google Cloud Functions API](https://cloud.google.com/functions) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
