...
namespace GoogleSamplecSharpSample.Cloudfunctionsv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudfunctionsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudfunctionsService</returns>
        public static CloudfunctionsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudfunctions Service", ex);
            }
        }
    }
}
