...
namespace GoogleSamplecSharpSample.Cloudbuildv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudbuildService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudbuildService</returns>
        public static CloudbuildService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudbuild Service", ex);
            }
        }
    }
}
