...
namespace GoogleSamplecSharpSample.Cloudbuildv1.Methods
{
    ...
    public static class OperationsSample
    {
        ...
        /// Documentation https://developers.google.com/cloudbuild/v1/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudbuild service.</param>  
        ...
        public static ListOperationsResponse List(CloudbuildService service, string name, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
