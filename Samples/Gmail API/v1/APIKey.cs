...
namespace GoogleSamplecSharpSample.Gmailv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GmailService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GmailService</returns>
        public static GmailService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Gmail Service", ex);
            }
        }
    }
}
