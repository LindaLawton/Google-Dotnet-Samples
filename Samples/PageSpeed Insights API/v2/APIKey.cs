...
namespace GoogleSamplecSharpSample.Pagespeedonlinev2.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PagespeedonlineService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PagespeedonlineService</returns>
        public static PagespeedonlineService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Pagespeedonline Service", ex);
            }
        }
    }
}
