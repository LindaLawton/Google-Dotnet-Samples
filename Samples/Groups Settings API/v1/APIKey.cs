...
namespace GoogleSamplecSharpSample.Groupssettingsv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid GroupssettingsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>GroupssettingsService</returns>
        public static GroupssettingsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Groupssettings Service", ex);
            }
        }
    }
}
