...
namespace GoogleSamplecSharpSample.Cloudkmsv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid CloudkmsService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>CloudkmsService</returns>
        public static CloudkmsService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Cloudkms Service", ex);
            }
        }
    }
}
