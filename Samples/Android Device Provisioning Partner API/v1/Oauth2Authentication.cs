...
namespace GoogleSamplecSharpSample.Androidprovisioningpartnerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AndroidprovisioningpartnerService used to make requests against the Androidprovisioningpartner API</returns>
        public static AndroidprovisioningpartnerService GetAndroidprovisioningpartnerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Androidprovisioningpartner service failed.", ex);
            }
        }
        ...
        /// <returns>AndroidprovisioningpartnerService used to make requests against the Androidprovisioningpartner API</returns>
        private static AndroidprovisioningpartnerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Androidprovisioningpartner API service.
                return new AndroidprovisioningpartnerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Androidprovisioningpartner Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
