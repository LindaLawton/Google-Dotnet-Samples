...
namespace GoogleSamplecSharpSample.Androidprovisioningpartnerv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AndroidprovisioningpartnerService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AndroidprovisioningpartnerService</returns>
        public static AndroidprovisioningpartnerService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Androidprovisioningpartner Service", ex);
            }
        }
    }
}
