...
namespace GoogleSamplecSharpSample.Playmoviesv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid PlaymoviesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>PlaymoviesService</returns>
        public static PlaymoviesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Playmovies Service", ex);
            }
        }
    }
}
