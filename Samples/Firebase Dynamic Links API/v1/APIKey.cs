...
namespace GoogleSamplecSharpSample.Firebasedynamiclinksv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid FirebasedynamiclinksService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>FirebasedynamiclinksService</returns>
        public static FirebasedynamiclinksService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Firebasedynamiclinks Service", ex);
            }
        }
    }
}
