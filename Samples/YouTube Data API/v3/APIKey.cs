...
namespace GoogleSamplecSharpSample.Youtubev3.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid YoutubeService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>YoutubeService</returns>
        public static YoutubeService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Youtube Service", ex);
            }
        }
    }
}
