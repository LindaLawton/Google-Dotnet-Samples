...
# Unoffical Google Identity Toolkit API Samples for .NET  
...
These samples show how to access the [Google Identity Toolkit API](https://developers.google.com/identity-toolkit/v3/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
