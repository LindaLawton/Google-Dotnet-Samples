...
namespace GoogleSamplecSharpSample.Identitytoolkitv3.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid IdentitytoolkitService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>IdentitytoolkitService</returns>
        public static IdentitytoolkitService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Identitytoolkit Service", ex);
            }
        }
    }
}
