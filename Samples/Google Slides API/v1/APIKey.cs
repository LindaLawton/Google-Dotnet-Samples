...
namespace GoogleSamplecSharpSample.Slidesv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SlidesService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SlidesService</returns>
        public static SlidesService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Slides Service", ex);
            }
        }
    }
}
