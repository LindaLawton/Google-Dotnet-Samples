...
These samples show how to access the [Google Slides API](https://developers.google.com/slides/) with the Offical [Google .Net client library](https://github.com/google/google-api-dotnet-client)
