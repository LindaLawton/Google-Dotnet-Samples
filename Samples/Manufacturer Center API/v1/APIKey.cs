...
namespace GoogleSamplecSharpSample.Manufacturercenterv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid ManufacturercenterService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>ManufacturercenterService</returns>
        public static ManufacturercenterService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Manufacturercenter Service", ex);
            }
        }
    }
}
