...
namespace GoogleSamplecSharpSample.Searchconsolev1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SearchconsoleService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SearchconsoleService</returns>
        public static SearchconsoleService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Searchconsole Service", ex);
            }
        }
    }
}
