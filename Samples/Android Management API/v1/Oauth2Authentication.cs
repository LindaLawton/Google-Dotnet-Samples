...
namespace GoogleSamplecSharpSample.Androidmanagementv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AndroidmanagementService used to make requests against the Androidmanagement API</returns>
        public static AndroidmanagementService GetAndroidmanagementService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Androidmanagement service failed.", ex);
            }
        }
        ...
        /// <returns>AndroidmanagementService used to make requests against the Androidmanagement API</returns>
        private static AndroidmanagementService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Androidmanagement API service.
                return new AndroidmanagementService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Androidmanagement Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
