...
namespace GoogleSamplecSharpSample.Androidmanagementv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static AndroidmanagementService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AndroidmanagementService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Androidmanagement Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Androidmanagement service.
                    return new AndroidmanagementService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Androidmanagement Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountAndroidmanagementFailed", ex);
            }
        }
    }
}