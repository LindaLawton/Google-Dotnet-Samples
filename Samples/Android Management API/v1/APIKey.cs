...
namespace GoogleSamplecSharpSample.Androidmanagementv1.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid AndroidmanagementService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>AndroidmanagementService</returns>
        public static AndroidmanagementService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Androidmanagement Service", ex);
            }
        }
    }
}
