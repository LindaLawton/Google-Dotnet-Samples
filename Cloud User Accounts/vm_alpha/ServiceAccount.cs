...
namespace GoogleSamplecSharpSample.Clouduseraccountsvm_alpha.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ClouduseraccountsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ClouduseraccountsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Clouduseraccounts Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Clouduseraccounts service.
                    return new ClouduseraccountsService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Clouduseraccounts Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountClouduseraccountsFailed", ex);
            }
        }
    }
}