...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TargetPoolAggregatedListResponse</returns>
        ...
        /// <returns>OperationResponse</returns>
        public static Operation Delete(computeService service, string project, string region, string targetPool)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.TargetPools.Delete(project, region, targetPool).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="project">Project ID for this request.</param>
        /// <param name="region">Name of the region scoping this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TargetPoolListResponse</returns>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation RemoveHealthCheck(computeService service, string project, string region, string targetPool, TargetPoolsRemoveHealthCheckRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.TargetPools.RemoveHealthCheck(body, project, region, targetPool).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation RemoveInstance(computeService service, string project, string region, string targetPool, TargetPoolsRemoveInstanceRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.TargetPools.RemoveInstance(body, project, region, targetPool).Execute();
            }
            catch (Exception ex)
            {
