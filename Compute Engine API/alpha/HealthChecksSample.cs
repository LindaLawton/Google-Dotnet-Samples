...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class HealthChecksSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/delete
        ...
        public static Operation Delete(computeService service, string project, string healthCheck)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HealthChecks.Delete(project, healthCheck).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>HealthCheckListResponse</returns>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(computeService service, string project, string healthCheck, HealthCheck body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HealthChecks.Patch(body, project, healthCheck).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/healthChecks/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Update(computeService service, string project, string healthCheck, HealthCheck body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HealthChecks.Update(body, project, healthCheck).Execute();
            }
            catch (Exception ex)
            {
