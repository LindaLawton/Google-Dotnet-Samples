...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class GlobalAddressesSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalAddresses/delete
        ...
        public static Operation Delete(computeService service, string project, string address)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.GlobalAddresses.Delete(project, address).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalAddresses/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalAddresses/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <returns>OperationResponse</returns>
        public static Operation Insert(computeService service, string project, Address body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.GlobalAddresses.Insert(body, project).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalAddresses/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/globalAddresses/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
