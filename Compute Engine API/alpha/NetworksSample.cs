...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class NetworksSample
    {
        ...
        /// <returns>OperationResponse</returns>
        public static Operation Delete(computeService service, string project, string network)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Networks.Delete(project, network).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Insert(computeService service, string project, Network body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Networks.Insert(body, project).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>NetworkListResponse</returns>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation RemovePeering(computeService service, string project, string network, NetworksRemovePeeringRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Networks.RemovePeering(body, project, network).Execute();
            }
            catch (Exception ex)
            {
