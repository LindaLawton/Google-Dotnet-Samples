...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class HttpsHealthChecksSample
    {
        ...
        public static Operation Delete(computeService service, string project, string httpsHealthCheck)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HttpsHealthChecks.Delete(project, httpsHealthCheck).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>HttpsHealthCheckListResponse</returns>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(computeService service, string project, string httpsHealthCheck, HttpsHealthCheck body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HttpsHealthChecks.Patch(body, project, httpsHealthCheck).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Update(computeService service, string project, string httpsHealthCheck, HttpsHealthCheck body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.HttpsHealthChecks.Update(body, project, httpsHealthCheck).Execute();
            }
            catch (Exception ex)
            {
