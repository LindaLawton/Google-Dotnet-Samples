...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class TargetTcpProxiesSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/targetTcpProxies/delete
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/targetTcpProxies/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/targetTcpProxies/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/targetTcpProxies/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static TestPermissionsResponse TestIamPermissions(ComputeService service, string project, string resource, TestPermissionsRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.TargetTcpProxies.TestIamPermissions(body, project, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request TargetTcpProxies.TestIamPermissions failed.", ex);
            }
        }
