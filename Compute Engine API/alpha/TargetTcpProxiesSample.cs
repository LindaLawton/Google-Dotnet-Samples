...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class TargetTcpProxiesSample
    {
        ...
        public static Operation Delete(computeService service, string project, string targetTcpProxy)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.TargetTcpProxies.Delete(project, targetTcpProxy).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TargetTcpProxyListResponse</returns>
