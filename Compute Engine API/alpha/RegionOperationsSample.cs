...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class RegionOperationsSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionOperations/delete
        ...
        public static void Delete(computeService service, string project, string region, string operation)
        {
            try
            {
                ...
                // Make the request.
                return service.RegionOperations.Delete(project, region, operation).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionOperations/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionOperations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
