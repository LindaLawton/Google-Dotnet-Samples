...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        public static Operation Delete(computeService service, string project, string region, string subnetwork)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Subnetworks.Delete(project, region, subnetwork).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="project">Project ID for this request.</param>
        /// <param name="region">Name of the region scoping this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SubnetworkListResponse</returns>
