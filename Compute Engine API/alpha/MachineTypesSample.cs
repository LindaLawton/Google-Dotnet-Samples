...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class MachineTypesSample
    {

        public class MachineTypesAggregatedListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/machineTypes/aggregatedList
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>MachineTypeAggregatedListResponse</returns>
        public static MachineTypeAggregatedList AggregatedList(computeService service, string project, MachineTypesAggregatedListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.MachineTypes.AggregatedList(project);

                // Applying optional parameters to the request.                
                request = (MachineTypesResource.AggregatedListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request MachineTypes.AggregatedList failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/machineTypes/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class MachineTypesListOptionalParms
        {
            /// Sets a filter expression for filtering listed resources, in the form filter={expression}. Your {expression} must be in the format: field_name comparison_string literal_string.
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/machineTypes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="zone">The name of the zone for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>MachineTypeListResponse</returns>
        public static MachineTypeList List(computeService service, string project, string zone, MachineTypesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.MachineTypes.List(project, zone);

                // Applying optional parameters to the request.                
                request = (MachineTypesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request MachineTypes.List failed.", ex);
            }
        }
