...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class InstanceGroupsSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/addInstances
        ...
        public static Operation AddInstances(computeService service, string project, string zone, string instanceGroup, InstanceGroupsAddInstancesRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.InstanceGroups.AddInstances(body, project, zone, instanceGroup).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/aggregatedList
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>InstanceGroupAggregatedListResponse</returns>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <returns>OperationResponse</returns>
        public static Operation Delete(computeService service, string project, string zone, string instanceGroup)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.InstanceGroups.Delete(project, zone, instanceGroup).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Insert(computeService service, string project, string zone, InstanceGroup body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.InstanceGroups.Insert(body, project, zone).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="zone">The name of the zone where the instance group is located.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>InstanceGroupListResponse</returns>
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/listInstances
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>InstanceGroupsListInstancesResponse</returns>
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/removeInstances
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation RemoveInstances(computeService service, string project, string zone, string instanceGroup, InstanceGroupsRemoveInstancesRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.InstanceGroups.RemoveInstances(body, project, zone, instanceGroup).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/setNamedPorts
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SetNamedPorts(computeService service, string project, string zone, string instanceGroup, InstanceGroupsSetNamedPortsRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.InstanceGroups.SetNamedPorts(body, project, zone, instanceGroup).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/instanceGroups/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static TestPermissionsResponse TestIamPermissions(computeService service, string project, string zone, string resource, TestPermissionsRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.InstanceGroups.TestIamPermissions(body, project, zone, resource).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request InstanceGroups.TestIamPermissions failed.", ex);
            }
        }
