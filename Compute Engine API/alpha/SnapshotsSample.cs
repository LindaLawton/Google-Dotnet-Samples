...
For more information, see Deleting snaphots. 
        ...
        public static Operation Delete(computeService service, string project, string snapshot)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Snapshots.Delete(project, snapshot).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SnapshotListResponse</returns>
