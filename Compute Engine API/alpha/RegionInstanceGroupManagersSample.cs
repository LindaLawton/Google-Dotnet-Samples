...
namespace GoogleSamplecSharpSample.Computealpha.Methods
{
    ...
    public static class RegionInstanceGroupManagersSample
    {
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionInstanceGroupManagers/deleteOverrides
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid Compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation DeleteOverrides(ComputeService service, string project, string region, string instanceGroupManager, RegionInstanceGroupManagersDeleteOverridesRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionInstanceGroupManagers.DeleteOverrides(body, project, region, instanceGroupManager).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request RegionInstanceGroupManagers.DeleteOverrides failed.", ex);
            }
        }
        ...
        public class RegionInstanceGroupManagersListOverridesOptionalParms
        {
            /// Sets a filter {expression} for filtering listed resources. Your {expression} must be in the format: field_name comparison_string literal_string.The field_name is the name of the field you want to compare. Only atomic field types are supported (string, number, boolean). The comparison_string must be either eq (equals) or ne (not equals). The literal_string is the string value to filter to. The literal value must be valid for the type of field you are filtering by (string, number, boolean). For string fields, the literal value is interpreted as a regular expression using RE2 syntax. The literal value must match the entire field.For example, to filter for instances that do not have a name of example-instance, you would use name ne example-instance.You can filter on nested fields. For example, you could filter on instances that have set the scheduling.automaticRestart field to true. Use filtering on nested fields to take advantage of labels to organize and search for results based on label values.To filter on multiple expressions, provide each separate expression within parentheses. For example, (scheduling.automaticRestart eq true) (zone eq us-central1-f). Multiple expressions are treated as AND expressions, meaning that resources must match all expressions to pass the filters.
            public string Filter { get; set; }  
            /// The maximum number of results per page that should be returned. If the number of available results is larger than maxResults, Compute Engine returns a nextPageToken that can be used to get the next page of results in subsequent list requests. Acceptable values are 0 to 500, inclusive. (Default: 500)
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionInstanceGroupManagers/listOverrides
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="instanceGroupManager">The name of the managed instance group. It should conform to RFC1035.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>RegionInstanceGroupManagersListOverridesResponseResponse</returns>
        public static RegionInstanceGroupManagersListOverridesResponse ListOverrides(ComputeService service, string project, string region, string instanceGroupManager, RegionInstanceGroupManagersListOverridesOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.RegionInstanceGroupManagers.ListOverrides(project, region, instanceGroupManager);

                // Applying optional parameters to the request.                
                request = (RegionInstanceGroupManagersResource.ListOverridesRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request RegionInstanceGroupManagers.ListOverrides failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionInstanceGroupManagers/updateOverrides
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="body">A valid Compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation UpdateOverrides(ComputeService service, string project, string region, string instanceGroupManager, RegionInstanceGroupManagersUpdateOverridesRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionInstanceGroupManagers.UpdateOverrides(body, project, region, instanceGroupManager).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request RegionInstanceGroupManagers.UpdateOverrides failed.", ex);
            }
        }
