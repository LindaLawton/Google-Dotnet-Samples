...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class RegionDisksSample
    {
        ...
        public static Operation Delete(computeService service, string project, string region, string disk)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionDisks.Delete(project, region, disk).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="body">A valid compute alpha body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Resize(computeService service, string project, string region, string disk, RegionDisksResizeRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionDisks.Resize(body, project, region, disk).Execute();
            }
            catch (Exception ex)
            {
