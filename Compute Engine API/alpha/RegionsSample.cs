...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class RegionsSample
    {


        /// <summary>
        /// Returns the specified Region resource. Get a list of available regions by making a list() request. 
        /// Documentation https://developers.google.com/compute/alpha/reference/regions/get
        ...
        public static Region Get(computeService service, string project, string region)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Regions.Get(project, region).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Regions.Get failed.", ex);
            }
        }

        public class RegionsListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regions/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>RegionListResponse</returns>
        public static RegionList List(computeService service, string project, RegionsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Regions.List(project);

                // Applying optional parameters to the request.                
                request = (RegionsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Regions.List failed.", ex);
            }
        }
