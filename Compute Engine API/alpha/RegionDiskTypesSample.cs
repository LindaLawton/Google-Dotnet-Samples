...
namespace GoogleSamplecSharpSample.computealpha.Methods
{
    ...
    public static class RegionDiskTypesSample
    {


        /// <summary>
        /// Returns the specified regional disk type. Get a list of available disk types by making a list() request. 
        /// Documentation https://developers.google.com/compute/alpha/reference/regionDiskTypes/get
        ...
        public static DiskType Get(computeService service, string project, string region, string diskType)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionDiskTypes.Get(project, region, diskType).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request RegionDiskTypes.Get failed.", ex);
            }
        }

        public class RegionDiskTypesListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/alpha/reference/regionDiskTypes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="region">The name of the region for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>RegionDiskTypeListResponse</returns>
        public static RegionDiskTypeList List(computeService service, string project, string region, RegionDiskTypesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.RegionDiskTypes.List(project, region);

                // Applying optional parameters to the request.                
                request = (RegionDiskTypesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request RegionDiskTypes.List failed.", ex);
            }
        }
