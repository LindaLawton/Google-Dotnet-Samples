...
namespace GoogleSamplecSharpSample.Computev1.Methods
{
    ...
    public static class RegionCommitmentsSample
    {
        ...
        public static Operation Insert(ComputeService service, string project, string region, Commitment body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RegionCommitments.Insert(body, project, region).Execute();
            }
            catch (Exception ex)
            {
