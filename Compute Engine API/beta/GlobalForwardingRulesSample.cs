...
namespace GoogleSamplecSharpSample.computebeta.Methods
{
    ...
    public static class GlobalForwardingRulesSample
    {
        ...
        public static Operation Delete(computeService service, string project, string forwardingRule)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.GlobalForwardingRules.Delete(project, forwardingRule).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="body">A valid compute beta body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation SetTarget(computeService service, string project, string forwardingRule, TargetReference body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.GlobalForwardingRules.SetTarget(body, project, forwardingRule).Execute();
            }
            catch (Exception ex)
            {
