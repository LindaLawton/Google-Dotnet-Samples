...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>BackendServiceAggregatedListResponse</returns>
        ...
        public static Operation Delete(computeService service, string project, string backendService)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.BackendServices.Delete(project, backendService).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="body">A valid compute beta body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Insert(computeService service, string project, BackendService body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.BackendServices.Insert(body, project).Execute();
            }
            catch (Exception ex)
            {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// <param name="body">A valid compute beta body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(computeService service, string project, string backendService, BackendService body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.BackendServices.Patch(body, project, backendService).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="body">A valid compute beta body.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Update(computeService service, string project, string backendService, BackendService body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.BackendServices.Update(body, project, backendService).Execute();
            }
            catch (Exception ex)
            {
