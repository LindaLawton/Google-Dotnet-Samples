...
namespace GoogleSamplecSharpSample.Computebeta.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ComputeService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ComputeService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Compute Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Compute Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ComputeService failed" + ex.Message);
