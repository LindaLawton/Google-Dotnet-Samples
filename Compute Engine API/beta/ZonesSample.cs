...
namespace GoogleSamplecSharpSample.computebeta.Methods
{
    ...
    public static class ZonesSample
    {


        /// <summary>
        /// Returns the specified Zone resource. Get a list of available zones by making a list() request. 
        /// Documentation https://developers.google.com/compute/beta/reference/zones/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="zone">Name of the zone resource to return.</param>
        /// <returns>ZoneResponse</returns>
        public static Zone Get(computeService service, string project, string zone)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Zones.Get(project, zone).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Zones.Get failed.", ex);
            }
        }

        public class ZonesListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/zones/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ZoneListResponse</returns>
        public static ZoneList List(computeService service, string project, ZonesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Zones.List(project);

                // Applying optional parameters to the request.                
                request = (ZonesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Zones.List failed.", ex);
            }
        }
