...
namespace GoogleSamplecSharpSample.Computebeta.Methods
{
    ...
    public static class AutoscalersSample
    {
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/aggregatedList
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>AutoscalerAggregatedListResponse</returns>
        ...
        public class AutoscalersDeleteOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public static Operation Delete(ComputeService service, string project, string zone, string autoscaler, AutoscalersDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Autoscalers.Delete(project, zone, autoscaler);

                // Applying optional parameters to the request.                
                request = (AutoscalersResource.DeleteRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class AutoscalersInsertOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Insert(ComputeService service, string project, string zone, Autoscaler body, AutoscalersInsertOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Autoscalers.Insert(body, project, zone);

                // Applying optional parameters to the request.                
                request = (AutoscalersResource.InsertRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="zone">Name of the zone for this request.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>AutoscalerListResponse</returns>
        ...
        public class AutoscalersPatchOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(ComputeService service, string project, string zone, Autoscaler body, AutoscalersPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Autoscalers.Patch(body, project, zone);

                // Applying optional parameters to the request.                
                request = (AutoscalersResource.PatchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        /// Documentation https://developers.google.com/compute/beta/reference/autoscalers/testIamPermissions
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Compute service.</param>  
        /// <param name="project">Project ID for this request.</param>
