...
namespace GoogleSamplecSharpSample.Computebeta.Methods
{
    ...
    public static class RegionBackendServicesSample
    {
        ...
        public class RegionBackendServicesDeleteOptionalParms
        {
        ...
        public static Operation Delete(ComputeService service, string project, string region, string backendService, RegionBackendServicesDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.RegionBackendServices.Delete(project, region, backendService);

                // Applying optional parameters to the request.                
                request = (RegionBackendServicesResource.DeleteRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        public class RegionBackendServicesInsertOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Insert(ComputeService service, string project, string region, BackendService body, RegionBackendServicesInsertOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.RegionBackendServices.Insert(body, project, region);

                // Applying optional parameters to the request.                
                request = (RegionBackendServicesResource.InsertRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        public class RegionBackendServicesPatchOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Patch(ComputeService service, string project, string region, string backendService, BackendService body, RegionBackendServicesPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.RegionBackendServices.Patch(body, project, region, backendService);

                // Applying optional parameters to the request.                
                request = (RegionBackendServicesResource.PatchRequest)SampleHelpers.ApplyOptionalParms(request, optional);
        ...
        public class RegionBackendServicesUpdateOptionalParms
        {
            /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
            public string RequestId { get; set; }  
