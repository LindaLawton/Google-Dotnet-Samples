...
namespace GoogleSamplecSharpSample.Computebeta.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ComputeService used to make requests against the Compute API</returns>
        public static ComputeService GetComputeService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Compute service failed.", ex);
            }
        }
        ...
        /// <returns>ComputeService used to make requests against the Compute API</returns>
        private static ComputeService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
