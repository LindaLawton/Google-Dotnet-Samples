...
namespace GoogleSamplecSharpSample.Partnersv2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static PartnersService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new PartnersService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Partners Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Partners service.
                    return new PartnersService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Partners Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountPartnersFailed", ex);
            }
        }
    }
}