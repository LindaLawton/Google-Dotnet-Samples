...
namespace GoogleSamplecSharpSample.Partnersv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PartnersService used to make requests against the Partners API</returns>
        public static PartnersService GetPartnersService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Partners service failed.", ex);
            }
        }
        ...
        /// <returns>PartnersService used to make requests against the Partners API</returns>
        private static PartnersService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Partners API service.
                return new PartnersService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Partners Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
