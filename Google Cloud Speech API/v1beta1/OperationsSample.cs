...
//     Build date: 01/02/2017 22:34:32
...
// About 
// 
// Unoffical sample for the speech v1beta1 API for C#. 
// This sample is designed to be used with the Google .Net client library. (https://github.com/google/google-api-dotnet-client)
// 
// API Description: Google Cloud Speech API.
...
namespace GoogleSamplecSharpSample.speechv1beta1.Methods
{
...
service. 
        /// Documentation https://developers.google.com/speech/v1beta1/reference/operations/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated speech service.</param>  
        /// <param name="name">The name of the operation resource.</param>
        /// <returns>OperationResponse</returns>
        public static Operation Get(speechService service, string name)
        {
            try
            {
                // Initial validation.
...
to use different resource name schemes, such as `users/*/operations`. 
        /// Documentation https://developers.google.com/speech/v1beta1/reference/operations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated speech service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ListOperationsResponseResponse</returns>
        public static ListOperationsResponse List(speechService service, OperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
...
`google.rpc.Code.UNIMPLEMENTED`. 
        /// Documentation https://developers.google.com/speech/v1beta1/reference/operations/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated speech service.</param>  
        /// <param name="name">The name of the operation resource to be deleted.</param>
        /// <returns>EmptyResponse</returns>
        public static Empty Delete(speechService service, string name)
        {
            try
            {
                // Initial validation.
...
corresponding to `Code.CANCELLED`. 
        /// Documentation https://developers.google.com/speech/v1beta1/reference/operations/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated speech service.</param>  
