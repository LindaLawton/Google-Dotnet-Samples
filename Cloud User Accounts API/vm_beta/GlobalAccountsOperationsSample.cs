...
//     Build date: 01/02/2017 22:32:15
...
namespace GoogleSamplecSharpSample.CloudUserAccountsvm_beta.Methods
{
    ...
    public static class GlobalAccountsOperationsSample
    {


        /// <summary>
        /// Deletes the specified operation resource. 
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/globalAccountsOperations/delete
        ...
        public static void Delete(CloudUserAccountsService service, string project, string operation)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.GlobalAccountsOperations.Delete(project, operation).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request GlobalAccountsOperations.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/globalAccountsOperations/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        public class GlobalAccountsOperationsListOptionalParms
        {
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/globalAccountsOperations/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>OperationListResponse</returns>
        public static OperationList List(CloudUserAccountsService service, string project, GlobalAccountsOperationsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.GlobalAccountsOperations.List(project);

                // Applying optional parameters to the request.                
                request = (GlobalAccountsOperationsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request GlobalAccountsOperations.List failed.", ex);
            }
        }
