...
namespace GoogleSamplecSharpSample.CloudUserAccountsvm_beta.Methods
{
    ...
    public static class GroupsSample
    {
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/addMember
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
...
Currently, only sorting by name or creationTimestamp desc is supported.
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
        ...
        /// Documentation https://developers.google.com/clouduseraccounts/vm_beta/reference/groups/removeMember
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudUserAccounts service.</param>  
        /// <param name="project">Project ID for this request.</param>
