...
namespace GoogleSamplecSharpSample.Cloudkmsv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudkmsService used to make requests against the Cloudkms API</returns>
        public static CloudkmsService GetCloudkmsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudkms service failed.", ex);
            }
        }
        ...
        /// <returns>CloudkmsService used to make requests against the Cloudkms API</returns>
        private static CloudkmsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudkms API service.
                return new CloudkmsService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudkms Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
