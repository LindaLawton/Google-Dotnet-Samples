...
namespace GoogleSamplecSharpSample.Cloudkmsv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CloudkmsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CloudkmsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Cloudkms Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Cloudkms service.
                    return new CloudkmsService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Cloudkms Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCloudkmsFailed", ex);
            }
        }
    }
}