...
namespace GoogleSamplecSharpSample.Youtubev3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>YoutubeService used to make requests against the Youtube API</returns>
        public static YoutubeService GetYoutubeService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Youtube service failed.", ex);
            }
        }
        ...
        /// <returns>YoutubeService used to make requests against the Youtube API</returns>
        private static YoutubeService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
