...
namespace GoogleSamplecSharpSample.bigqueryv2.Methods
{
    ...
    public static class TablesSample
    {
        ...
        public static Table Get(bigqueryService service, string projectId, string datasetId, string tableId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Tables.Get(projectId, datasetId, tableId).Execute();
            }
            catch (Exception ex)
            {
