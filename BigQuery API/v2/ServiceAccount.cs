...
namespace GoogleSamplecSharpSample.Bigqueryv2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static BigqueryService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new BigqueryService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Bigquery Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Bigquery Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account BigqueryService failed" + ex.Message);
