...
namespace GoogleSamplecSharpSample.bigqueryv2.Methods
{
    ...
    public static class DatasetsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(bigqueryService service, string projectId, string datasetId, DatasetsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DatasetListResponse</returns>
