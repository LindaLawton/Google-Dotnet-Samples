...
namespace GoogleSamplecSharpSample.bigqueryv2.Methods
{
    ...
    public static class TabledataSample
    {
        ...
        public class TabledataListOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TableDataListResponse</returns>
