...
namespace GoogleSamplecSharpSample.Bigqueryv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>BigqueryService used to make requests against the Bigquery API</returns>
        public static BigqueryService GetBigqueryService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Bigquery service failed.", ex);
            }
        }
        ...
        /// <returns>BigqueryService used to make requests against the Bigquery API</returns>
        private static BigqueryService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
