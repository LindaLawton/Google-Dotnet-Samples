...
namespace GoogleSamplecSharpSample.Slidesv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SlidesService used to make requests against the Slides API</returns>
        public static SlidesService GetSlidesService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Slides service failed.", ex);
            }
        }
        ...
        /// <returns>SlidesService used to make requests against the Slides API</returns>
        private static SlidesService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
