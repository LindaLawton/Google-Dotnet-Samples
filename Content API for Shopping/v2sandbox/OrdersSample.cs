...
//     Build date: 01/02/2017 22:32:24
...
// About 
// 
// Unoffical sample for the ShoppingContent v2sandbox API for C#. 
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.ShoppingContent.v2sandbox/ 
// Install Command: PM>  Install-Package Google.Apis.ShoppingContent.v2sandbox
//
//------------------------------------------------------------------------------  
using Google.Apis.ShoppingContent.v2sandbox;
using Google.Apis.ShoppingContent.v2sandbox.Data;
using System;

namespace GoogleSamplecSharpSample.ShoppingContentv2sandbox.Methods
{
    ...
    public static class OrdersSample
    {
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/acknowledge
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/cancel
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/createtestorder
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/custombatch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="body">A valid ShoppingContent v2sandbox body.</param>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
...
Known issue: All List calls will return all Orders without limit regardless of the value of this field.
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>OrdersListResponseResponse</returns>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/refund
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/returnlineitem
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        ...
        /// Documentation https://developers.google.com/shoppingcontent/v2sandbox/reference/orders/shiplineitems
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
