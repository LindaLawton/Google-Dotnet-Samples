...
namespace GoogleSamplecSharpSample.ShoppingContentv2.Methods
{
    ...
    public static class ShippingsettingsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ShippingsettingsCustomBatchResponseResponse</returns>
        ...
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ShippingsettingsListResponseResponse</returns>
