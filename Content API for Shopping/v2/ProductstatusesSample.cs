...
namespace GoogleSamplecSharpSample.ShoppingContentv2.Methods
{
    ...
    public static class ProductstatusesSample
    {
        ...
        public static ProductStatus Get(ShoppingContentService service, string merchantId, string productId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Productstatuses.Get(merchantId, productId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="service">Authenticated ShoppingContent service.</param>  
        /// <param name="merchantId">The ID of the managing account.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ProductstatusesListResponseResponse</returns>
