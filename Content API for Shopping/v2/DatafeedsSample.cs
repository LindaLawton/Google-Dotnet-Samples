...
namespace GoogleSamplecSharpSample.ShoppingContentv2.Methods
{
    ...
    public static class DatafeedsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DatafeedsCustomBatchResponseResponse</returns>
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(ShoppingContentService service, string merchantId, string datafeedId, DatafeedsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// <param name="merchantId">NA</param>
        /// <param name="body">A valid ShoppingContent v2 body.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DatafeedResponse</returns>
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>DatafeedsListResponseResponse</returns>
