...
namespace GoogleSamplecSharpSample.ShoppingContentv2.Methods
{
    ...
    public static class ProductsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(ShoppingContentService service, string merchantId, string productId, ProductsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
