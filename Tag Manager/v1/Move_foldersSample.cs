...
namespace GoogleSamplecSharpSample.Tagmanagerv1.Methods
{
    ...
    public static class Move_foldersSample
    {
        ...
        public static void Update(TagmanagerService service, string accountId, string containerId, string folderId, Folder body, Move_foldersUpdateOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
