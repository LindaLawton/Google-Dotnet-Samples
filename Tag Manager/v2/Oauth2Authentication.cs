...
namespace GoogleSamplecSharpSample.Tagmanagerv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>TagmanagerService used to make requests against the Tagmanager API</returns>
        public static TagmanagerService GetTagmanagerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Tagmanager service failed.", ex);
            }
        }
        ...
        /// <returns>TagmanagerService used to make requests against the Tagmanager API</returns>
        private static TagmanagerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Tagmanager API service.
                return new TagmanagerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Tagmanager Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
