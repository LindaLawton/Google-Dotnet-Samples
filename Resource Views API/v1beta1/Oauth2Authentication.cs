...
namespace GoogleSamplecSharpSample.Resourceviewsv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ResourceviewsService used to make requests against the Resourceviews API</returns>
        public static ResourceviewsService GetResourceviewsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Resourceviews service failed.", ex);
            }
        }
        ...
        /// <returns>ResourceviewsService used to make requests against the Resourceviews API</returns>
        private static ResourceviewsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Resourceviews API service.
