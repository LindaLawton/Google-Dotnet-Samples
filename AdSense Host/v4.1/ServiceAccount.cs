...
namespace GoogleSamplecSharpSample.Adsensehostv4.1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static AdsensehostService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AdsensehostService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Adsensehost Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Adsensehost service.
                    return new AdsensehostService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Adsensehost Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountAdsensehostFailed", ex);
            }
        }
    }
}