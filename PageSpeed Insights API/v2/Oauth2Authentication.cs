...
// About 
// 
// Unoffical sample for the Pagespeedonline v2 API for C#. 
...
namespace GoogleSamplecSharpSample.Pagespeedonlinev2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PagespeedonlineService used to make requests against the Pagespeedonline API</returns>
        public static PagespeedonlineService GetPagespeedonlineService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Pagespeedonline service failed.", ex);
            }
        }
        ...
        /// <returns>PagespeedonlineService used to make requests against the Pagespeedonline API</returns>
        private static PagespeedonlineService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Pagespeedonline API service.
                return new PagespeedonlineService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Pagespeedonline Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
