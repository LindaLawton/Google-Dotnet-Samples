...
namespace GoogleSamplecSharpSample.Fusiontablesv2.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static FusiontablesService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { FusiontablesService.Scope.FusiontablesReadonly,	//View your Fusion Tables
                                                 FusiontablesService.Scope.Fusiontables};       	//Manage your Fusion Tables
                ...
                return new FusiontablesService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Fusiontables Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account FusiontablesService failed" + ex.Message);
                throw new Exception("CreateServiceAccountFusiontablesFailed", ex);
			}
        }
        ...
        public static FusiontablesService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
