...
namespace GoogleSamplecSharpSample.Fusiontablesv2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static FusiontablesService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new FusiontablesService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Fusiontables Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Fusiontables service.
                    return new FusiontablesService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Fusiontables Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account FusiontablesService failed" + ex.Message);
