...
namespace GoogleSamplecSharpSample.fusiontablesv2.Methods
{
    ...
    public static class TaskSample
    {
        ...
        /// Documentation https://developers.google.com/fusiontables/v2/reference/task/delete
        ...
        public static void Delete(fusiontablesService service, string tableId, string taskId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Task.Delete(tableId, taskId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Task.Delete failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/fusiontables/v2/reference/task/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fusiontables service.</param>  
        /// <param name="tableId">Table to which the task belongs.</param>
        /// <param name="taskId">The identifier of the task to get.</param>
        ...
        public class TaskListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/fusiontables/v2/reference/task/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fusiontables service.</param>  
        /// <param name="tableId">Table whose tasks are being listed.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TaskListResponse</returns>
        public static TaskList List(fusiontablesService service, string tableId, TaskListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Task.List(tableId);

                // Applying optional parameters to the request.                
                request = (TaskResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Task.List failed.", ex);
            }
        }
