...
namespace GoogleSamplecSharpSample.fusiontablesv1.Methods
{
    ...
    public static class TemplateSample
    {
        ...
        /// <summary>
        /// Deletes a template 
        /// Documentation https://developers.google.com/fusiontables/v1/reference/template/delete
        ...
        public static void Delete(fusiontablesService service, string tableId, int templateId)
        {
            try
            {
                ...
                // Make the request.
                return service.Template.Delete(tableId, templateId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/template/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fusiontables service.</param>  
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TemplateListResponse</returns>
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/template/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fusiontables service.</param>  
        ...
        /// Documentation https://developers.google.com/fusiontables/v1/reference/template/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fusiontables service.</param>  
        /// <param name="tableId">Table to which the updated template belongs</param>
