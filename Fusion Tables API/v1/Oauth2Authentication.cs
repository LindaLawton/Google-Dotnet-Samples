...
namespace GoogleSamplecSharpSample.Fusiontablesv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>FusiontablesService used to make requests against the Fusiontables API</returns>
        public static FusiontablesService GetFusiontablesService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Fusiontables service failed.", ex);
            }
        }
        ...
        /// <returns>FusiontablesService used to make requests against the Fusiontables API</returns>
        private static FusiontablesService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Fusiontables API service.
