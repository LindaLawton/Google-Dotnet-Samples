...
namespace GoogleSamplecSharpSample.Groupssettingsv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GroupssettingsService used to make requests against the Groupssettings API</returns>
        public static GroupssettingsService GetGroupssettingsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Groupssettings service failed.", ex);
            }
        }
        ...
        /// <returns>GroupssettingsService used to make requests against the Groupssettings API</returns>
        private static GroupssettingsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Groupssettings API service.
