...
//     Build date: 01/02/2017 22:33:02
...
namespace GoogleSamplecSharpSample.Groupssettingsv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static GroupssettingsService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { GroupssettingsService.Scope.AppsGroupsSettings};	//View and manage the settings of a Google Apps Group
                ...
                return new GroupssettingsService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Groupssettings Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account GroupssettingsService failed" + ex.Message);
                throw new Exception("CreateServiceAccountGroupssettingsFailed", ex);
			}
        }
        ...
        public static GroupssettingsService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
