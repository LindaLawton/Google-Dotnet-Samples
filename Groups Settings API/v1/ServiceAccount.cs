...
namespace GoogleSamplecSharpSample.Groupssettingsv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static GroupssettingsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new GroupssettingsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Groupssettings Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Groupssettings service.
                    return new GroupssettingsService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Groupssettings Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account GroupssettingsService failed" + ex.Message);
