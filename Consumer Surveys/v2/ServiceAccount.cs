...
namespace GoogleSamplecSharpSample.Consumersurveysv2.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ConsumersurveysService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ConsumersurveysService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Consumersurveys Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Consumersurveys service.
                    return new ConsumersurveysService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Consumersurveys Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountConsumersurveysFailed", ex);
            }
        }
    }
}