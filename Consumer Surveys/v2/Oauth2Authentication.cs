...
namespace GoogleSamplecSharpSample.Consumersurveysv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ConsumersurveysService used to make requests against the Consumersurveys API</returns>
        public static ConsumersurveysService GetConsumersurveysService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Consumersurveys service failed.", ex);
            }
        }
        ...
        /// <returns>ConsumersurveysService used to make requests against the Consumersurveys API</returns>
        private static ConsumersurveysService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Consumersurveys API service.
                return new ConsumersurveysService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Consumersurveys Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
