...
namespace GoogleSamplecSharpSample.Appstatev1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AppstateService used to make requests against the Appstate API</returns>
        public static AppstateService GetAppstateService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Appstate service failed.", ex);
            }
        }
        ...
        /// <returns>AppstateService used to make requests against the Appstate API</returns>
        private static AppstateService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Appstate API service.
                return new AppstateService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Appstate Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
