...
namespace GoogleSamplecSharpSample.Surveysv2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static SurveysService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new SurveysService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Surveys Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Surveys Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account SurveysService failed" + ex.Message);
