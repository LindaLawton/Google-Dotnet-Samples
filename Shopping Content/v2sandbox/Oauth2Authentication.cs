...
namespace GoogleSamplecSharpSample.Shoppingcontentv2sandbox.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ShoppingcontentService used to make requests against the Shoppingcontent API</returns>
        public static ShoppingcontentService GetShoppingcontentService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Shoppingcontent service failed.", ex);
            }
        }
        ...
        /// <returns>ShoppingcontentService used to make requests against the Shoppingcontent API</returns>
        private static ShoppingcontentService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Shoppingcontent API service.
                return new ShoppingcontentService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Shoppingcontent Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
