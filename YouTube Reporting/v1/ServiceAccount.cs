...
namespace GoogleSamplecSharpSample.Youtubereportingv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static YoutubereportingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new YoutubereportingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Youtubereporting Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Youtubereporting service.
                    return new YoutubereportingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Youtubereporting Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountYoutubereportingFailed", ex);
            }
        }
    }
}