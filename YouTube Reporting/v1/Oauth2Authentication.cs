...
namespace GoogleSamplecSharpSample.Youtubereportingv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>YoutubereportingService used to make requests against the Youtubereporting API</returns>
        public static YoutubereportingService GetYoutubereportingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Youtubereporting service failed.", ex);
            }
        }
        ...
        /// <returns>YoutubereportingService used to make requests against the Youtubereporting API</returns>
        private static YoutubereportingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Youtubereporting API service.
                return new YoutubereportingService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Youtubereporting Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
