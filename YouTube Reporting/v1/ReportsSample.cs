...
namespace GoogleSamplecSharpSample.Youtubereportingv1.Methods
{
    ...
    public static class ReportsSample
    {
        ...
        {
            /// If set, only reports whose start time is smaller than the specifieddate/time are returned.
            public string StartTimeBefore { get; set; }  
            /// If set, only reports created after the specified date/time are returned.
            public string CreatedAfter { get; set; }  
            /// If set, only reports whose start time is greater than or equal thespecified date/time are returned.
            public string StartTimeAtOrAfter { get; set; }  
            /// A token identifying a page of results the server should return. Typically,this is the value ofListReportsResponse.next_page_tokenreturned in response to the previous call to the `ListReports` method.
