...
namespace GoogleSamplecSharpSample.Resellerv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ResellerService used to make requests against the Reseller API</returns>
        public static ResellerService GetResellerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Reseller service failed.", ex);
            }
        }
        ...
        /// <returns>ResellerService used to make requests against the Reseller API</returns>
        private static ResellerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
