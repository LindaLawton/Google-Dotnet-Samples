...
namespace GoogleSamplecSharpSample.Resellerv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static ResellerService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { ResellerService.Scope.AppsOrderReadonly,	//Manage users on your domain
                                                 ResellerService.Scope.AppsOrder};       	//Manage users on your domain
                ...
                return new ResellerService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Reseller Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account ResellerService failed" + ex.Message);
                throw new Exception("CreateServiceAccountResellerFailed", ex);
			}
        }
        ...
        public static ResellerService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
