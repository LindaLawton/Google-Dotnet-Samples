...
namespace GoogleSamplecSharpSample.Resellerv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ResellerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ResellerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Reseller Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Reseller service.
                    return new ResellerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Reseller Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ResellerService failed" + ex.Message);
