...
namespace GoogleSamplecSharpSample.Servicemanagementv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ServicemanagementService used to make requests against the Servicemanagement API</returns>
        public static ServicemanagementService GetServicemanagementService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Servicemanagement service failed.", ex);
            }
        }
        ...
        /// <returns>ServicemanagementService used to make requests against the Servicemanagement API</returns>
        private static ServicemanagementService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Servicemanagement API service.
                return new ServicemanagementService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Servicemanagement Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
