...
namespace GoogleSamplecSharpSample.Servicemanagementv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ServicemanagementService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ServicemanagementService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Servicemanagement Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Servicemanagement service.
                    return new ServicemanagementService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Servicemanagement Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountServicemanagementFailed", ex);
            }
        }
    }
}