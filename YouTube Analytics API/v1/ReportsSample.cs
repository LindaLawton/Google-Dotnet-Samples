...
namespace GoogleSamplecSharpSample.YouTubeAnalyticsv1.Methods
{
    ...
    public static class ReportsSample
    {
        ...
        /// <param name="ids">Identifies the YouTube channel or content owner for which you are retrieving YouTube Analytics data.
...
- To request data for a YouTube CMS content owner, set the ids parameter value to contentOwner==OWNER_NAME, where OWNER_NAME is the CMS name of the content owner.</param>
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ResultTableResponse</returns>
