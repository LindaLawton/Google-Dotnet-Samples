...
namespace GoogleSamplecSharpSample.Cloudruntimeconfigv1beta1.Methods
{
    ...
    public static class WaitersSample
    {
        ...
        /// <param name="parent">The path to the configuration for which you want to get a list of waiters.The configuration must exist beforehand; the path must by in the format:`projects/[PROJECT_ID]/configs/[CONFIG_NAME]`</param>
        ...
        /// </summary>
        /// <param name="service">Authenticated Cloudruntimeconfig service.</param>  
        /// <param name="parent">The path to the configuration that will own the waiter.The configuration must exist beforehand; the path must by in the format:`projects/[PROJECT_ID]/configs/[CONFIG_NAME]`.</param>
