...
namespace GoogleSamplecSharpSample.Cloudruntimeconfigv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudruntimeconfigService used to make requests against the Cloudruntimeconfig API</returns>
        public static CloudruntimeconfigService GetCloudruntimeconfigService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudruntimeconfig service failed.", ex);
            }
        }
        ...
        /// <returns>CloudruntimeconfigService used to make requests against the Cloudruntimeconfig API</returns>
        private static CloudruntimeconfigService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudruntimeconfig API service.
                return new CloudruntimeconfigService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudruntimeconfig Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
