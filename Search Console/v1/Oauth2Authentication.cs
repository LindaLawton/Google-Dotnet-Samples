...
namespace GoogleSamplecSharpSample.Searchconsolev1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SearchconsoleService used to make requests against the Searchconsole API</returns>
        public static SearchconsoleService GetSearchconsoleService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Searchconsole service failed.", ex);
            }
        }
        ...
        /// <returns>SearchconsoleService used to make requests against the Searchconsole API</returns>
        private static SearchconsoleService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Searchconsole API service.
                return new SearchconsoleService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Searchconsole Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
