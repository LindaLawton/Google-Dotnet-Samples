...
namespace GoogleSamplecSharpSample.Appsactivityv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>AppsactivityService used to make requests against the Appsactivity API</returns>
        public static AppsactivityService GetAppsactivityService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Appsactivity service failed.", ex);
            }
        }
        ...
        /// <returns>AppsactivityService used to make requests against the Appsactivity API</returns>
        private static AppsactivityService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Appsactivity API service.
