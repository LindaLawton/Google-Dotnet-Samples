...
{
    class ManagementAccountsSample
    {
		/// <summary>
        /// Lists all accounts to which the user has access.
		/// Documentation: https://developers.google.com/analytics//v3/accounts/list
		/// </summary>
		/// <param name="service">Valid authentcated AnalyticsService</param>
		/// <returns>Accounts </returns>
	    public static Accounts List(AnalyticsService service)
	    {
