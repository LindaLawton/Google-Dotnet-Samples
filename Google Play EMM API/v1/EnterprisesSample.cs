...
namespace GoogleSamplecSharpSample.AndroidEnterprisev1.Methods
{
    ...
    public static class EnterprisesSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void AcknowledgeNotificationSet(AndroidEnterpriseService service, EnterprisesAcknowledgeNotificationSetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>EnterpriseResponse</returns>
        ...
        public static void Delete(AndroidEnterpriseService service, string enterpriseId)
        {
            try
            {
                ...
                // Make the request.
                return service.Enterprises.Delete(enterpriseId).Execute();
            }
            catch (Exception ex)
            {
...
Beware that this means that the URL will be parsed, the parameter added and then a new URL formatted, i.e. there may be some minor formatting changes and, more importantly, the URL must be well-formed so that it can be parsed.
        ...
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>SignupInfoResponse</returns>
...
Once the service account is bound to the enterprise, it can be managed using the serviceAccountKeys resource. 
        ...
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ServiceAccountResponse</returns>
...
If no notifications are present, an empty notification list is returned. Subsequent requests may return more notifications once they become available. 
        ...
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>NotificationSetResponse</returns>
        ...
        public static void Unenroll(AndroidEnterpriseService service, string enterpriseId)
        {
            try
            {
                ...
                // Make the request.
                return service.Enterprises.Unenroll(enterpriseId).Execute();
            }
            catch (Exception ex)
            {
