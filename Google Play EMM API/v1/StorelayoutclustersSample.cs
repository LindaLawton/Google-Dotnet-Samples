...
namespace GoogleSamplecSharpSample.AndroidEnterprisev1.Methods
{
    ...
    public static class StorelayoutclustersSample
    {
        ...
        public static void Delete(AndroidEnterpriseService service, string enterpriseId, string pageId, string clusterId)
        {
            try
            {
                ...
                // Make the request.
                return service.Storelayoutclusters.Delete(enterpriseId, pageId, clusterId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/storelayoutclusters/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        public static StoreCluster Get(AndroidEnterpriseService service, string enterpriseId, string pageId, string clusterId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Storelayoutclusters.Get(enterpriseId, pageId, clusterId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Storelayoutclusters.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/storelayoutclusters/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        /// <returns>StoreClusterResponse</returns>
        public static StoreCluster Insert(AndroidEnterpriseService service, string enterpriseId, string pageId, StoreCluster body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Storelayoutclusters.Insert(body, enterpriseId, pageId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Storelayoutclusters.Insert failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/storelayoutclusters/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        /// <param name="pageId">The ID of the page.</param>
        /// <returns>StoreLayoutClustersListResponseResponse</returns>
        public static StoreLayoutClustersListResponse List(AndroidEnterpriseService service, string enterpriseId, string pageId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Storelayoutclusters.List(enterpriseId, pageId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Storelayoutclusters.List failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/storelayoutclusters/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        /// <param name="body">A valid AndroidEnterprise v1 body.</param>
        /// <returns>StoreClusterResponse</returns>
        public static StoreCluster Patch(AndroidEnterpriseService service, string enterpriseId, string pageId, string clusterId, StoreCluster body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Storelayoutclusters.Patch(body, enterpriseId, pageId, clusterId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Storelayoutclusters.Patch failed.", ex);
            }
        }
