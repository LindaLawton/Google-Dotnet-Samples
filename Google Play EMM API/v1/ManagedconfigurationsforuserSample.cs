...
namespace GoogleSamplecSharpSample.AndroidEnterprisev1.Methods
{
    ...
    public static class ManagedconfigurationsforuserSample
    {
        ...
        public static void Delete(AndroidEnterpriseService service, string enterpriseId, string userId, string managedConfigurationForUserId)
        {
            try
            {
                ...
                // Make the request.
                return service.Managedconfigurationsforuser.Delete(enterpriseId, userId, managedConfigurationForUserId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/androidenterprise/v1/reference/managedconfigurationsforuser/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated AndroidEnterprise service.</param>  
        /// <param name="enterpriseId">The ID of the enterprise.</param>
        ...
        public static ManagedConfiguration Get(AndroidEnterpriseService service, string enterpriseId, string userId, string managedConfigurationForUserId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Managedconfigurationsforuser.Get(enterpriseId, userId, managedConfigurationForUserId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Managedconfigurationsforuser.Get failed.", ex);
            }
        }
