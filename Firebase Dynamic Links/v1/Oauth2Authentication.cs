...
namespace GoogleSamplecSharpSample.Firebasedynamiclinksv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>FirebasedynamiclinksService used to make requests against the Firebasedynamiclinks API</returns>
        public static FirebasedynamiclinksService GetFirebasedynamiclinksService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Firebasedynamiclinks service failed.", ex);
            }
        }
        ...
        /// <returns>FirebasedynamiclinksService used to make requests against the Firebasedynamiclinks API</returns>
        private static FirebasedynamiclinksService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Firebasedynamiclinks API service.
                return new FirebasedynamiclinksService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Firebasedynamiclinks Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
