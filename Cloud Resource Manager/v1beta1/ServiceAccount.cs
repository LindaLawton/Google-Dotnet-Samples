...
namespace GoogleSamplecSharpSample.Cloudresourcemanagerv1beta1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static CloudresourcemanagerService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new CloudresourcemanagerService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Cloudresourcemanager Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Cloudresourcemanager service.
                    return new CloudresourcemanagerService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Cloudresourcemanager Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountCloudresourcemanagerFailed", ex);
            }
        }
    }
}