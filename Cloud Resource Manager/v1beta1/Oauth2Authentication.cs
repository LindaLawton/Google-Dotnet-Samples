...
namespace GoogleSamplecSharpSample.Cloudresourcemanagerv1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudresourcemanagerService used to make requests against the Cloudresourcemanager API</returns>
        public static CloudresourcemanagerService GetCloudresourcemanagerService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudresourcemanager service failed.", ex);
            }
        }
        ...
        /// <returns>CloudresourcemanagerService used to make requests against the Cloudresourcemanager API</returns>
        private static CloudresourcemanagerService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudresourcemanager API service.
                return new CloudresourcemanagerService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudresourcemanager Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
