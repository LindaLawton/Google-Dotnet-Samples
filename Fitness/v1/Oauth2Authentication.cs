...
namespace GoogleSamplecSharpSample.Fitnessv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>FitnessService used to make requests against the Fitness API</returns>
        public static FitnessService GetFitnessService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Fitness service failed.", ex);
            }
        }
        ...
        /// <returns>FitnessService used to make requests against the Fitness API</returns>
        private static FitnessService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
