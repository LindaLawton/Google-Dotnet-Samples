...
namespace GoogleSamplecSharpSample.fitnessv1.Methods
{
    ...
    public static class DatasetSample
    {
        ...
        /// Documentation https://developers.google.com/fitness/v1/reference/dataset/aggregate
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated fitness service.</param>  
        /// <param name="userId">Aggregate data for the person identified. Use me to indicate the authenticated user. Only me is supported at this time.</param>
        /// <param name="body">A valid fitness v1 body.</param>
        /// <returns>AggregateResponseResponse</returns>
        public static AggregateResponse Aggregate(fitnessService service, string userId, AggregateRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Dataset.Aggregate(body, userId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Dataset.Aggregate failed.", ex);
            }
        }
