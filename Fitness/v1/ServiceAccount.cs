...
namespace GoogleSamplecSharpSample.Fitnessv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static FitnessService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new FitnessService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Fitness Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Fitness Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account FitnessService failed" + ex.Message);
