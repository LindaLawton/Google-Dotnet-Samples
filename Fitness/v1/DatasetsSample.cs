...
namespace GoogleSamplecSharpSample.fitnessv1.Methods
{
    ...
    public static class DatasetsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(fitnessService service, string userId, string dataSourceId, string datasetId, DatasetsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
