...
namespace GoogleSamplecSharpSample.Adexchangebuyerv1_4.Methods
{
    ...
    public static class BillingInfoSample
    {


        /// <summary>
        /// Returns the billing information for one account specified by account ID. 
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/billingInfo/get
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/billingInfo/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adexchangebuyer service.</param>  
