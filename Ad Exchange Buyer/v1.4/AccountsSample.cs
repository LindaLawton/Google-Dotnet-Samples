...
namespace GoogleSamplecSharpSample.Adexchangebuyerv1_4.Methods
{
    ...
    public static class AccountsSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/accounts/get
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/accounts/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adexchangebuyer service.</param>  
        ...
        public class AccountsPatchOptionalParms
        {
            ...
            public bool? ConfirmUnsafeAccountChange { get; set; }  
        
        }
 
        /// <summary>
        /// Updates an existing account. This method supports patch semantics. 
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/accounts/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adexchangebuyer service.</param>  
        /// <param name="id">The account id</param>
        ...
        /// <returns>AccountResponse</returns>
        public static Account Patch(AdexchangebuyerService service, int? id, Account body, AccountsPatchOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Accounts.Patch(body, id);
