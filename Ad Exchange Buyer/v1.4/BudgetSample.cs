...
namespace GoogleSamplecSharpSample.Adexchangebuyerv1_4.Methods
{
    ...
    public static class BudgetSample
    {
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/budget/get
        ...
        /// Documentation https://developers.google.com/adexchangebuyer/v1.4/reference/budget/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Adexchangebuyer service.</param>  
        /// <param name="accountId">The account id associated with the budget being updated.</param>
