...
namespace GoogleSamplecSharpSample.Siteverificationv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SiteverificationService used to make requests against the Siteverification API</returns>
        public static SiteverificationService GetSiteverificationService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Siteverification service failed.", ex);
            }
        }
        ...
        /// <returns>SiteverificationService used to make requests against the Siteverification API</returns>
        private static SiteverificationService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Siteverification API service.
