...
namespace GoogleSamplecSharpSample.Kgsearchv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>KgsearchService used to make requests against the Kgsearch API</returns>
        public static KgsearchService GetKgsearchService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Kgsearch service failed.", ex);
            }
        }
        ...
        /// <returns>KgsearchService used to make requests against the Kgsearch API</returns>
        private static KgsearchService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Kgsearch API service.
                return new KgsearchService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Kgsearch Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
