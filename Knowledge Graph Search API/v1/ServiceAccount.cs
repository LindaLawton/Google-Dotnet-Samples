...
namespace GoogleSamplecSharpSample.Kgsearchv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static KgsearchService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new KgsearchService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Kgsearch Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Kgsearch service.
                    return new KgsearchService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Kgsearch Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountKgsearchFailed", ex);
            }
        }
    }
}