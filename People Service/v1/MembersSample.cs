...
namespace GoogleSamplecSharpSample.Peopleservicev1.Methods
{
    ...
    public static class MembersSample
    {
        ...
        /// Documentation https://developers.google.com/peopleservice/v1/reference/members/modify
        ...
        /// <param name="body">A valid Peopleservice v1 body.</param>
        /// <returns>ModifyContactGroupMembersResponseResponse</returns>
        public static ModifyContactGroupMembersResponse Modify(PeopleserviceService service, string resourceName, ModifyContactGroupMembersRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Members.Modify(body, resourceName).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Members.Modify failed.", ex);
            }
        }
