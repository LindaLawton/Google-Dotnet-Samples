...
namespace GoogleSamplecSharpSample.Peopleservicev1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static PeopleserviceService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new PeopleserviceService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Peopleservice Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Peopleservice service.
                    return new PeopleserviceService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Peopleservice Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountPeopleserviceFailed", ex);
            }
        }
    }
}