...
namespace GoogleSamplecSharpSample.Peopleservicev1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PeopleserviceService used to make requests against the Peopleservice API</returns>
        public static PeopleserviceService GetPeopleserviceService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Peopleservice service failed.", ex);
            }
        }
        ...
        /// <returns>PeopleserviceService used to make requests against the Peopleservice API</returns>
        private static PeopleserviceService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Peopleservice API service.
