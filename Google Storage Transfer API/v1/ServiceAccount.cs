...
namespace GoogleSamplecSharpSample.Storagetransferv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static StoragetransferService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new StoragetransferService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Storagetransfer Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Storagetransfer service.
                    return new StoragetransferService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Storagetransfer Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account StoragetransferService failed" + ex.Message);
