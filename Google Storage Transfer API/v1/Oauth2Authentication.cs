...
{  
    public static class Oauth2Example 
    {
        ...
        public static StoragetransferService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { StoragetransferService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
            ...
            {
                Console.WriteLine("Create Oauth2 account StoragetransferService failed" + ex.Message);
                throw new Exception("CreateServiceAccountStoragetransferFailed", ex);
			}
        }
        ...
        public static StoragetransferService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
