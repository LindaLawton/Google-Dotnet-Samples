...
namespace GoogleSamplecSharpSample.Mirrorv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static MirrorService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new MirrorService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Mirror Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Mirror Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account MirrorService failed" + ex.Message);
