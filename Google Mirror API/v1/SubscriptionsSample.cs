...
namespace GoogleSamplecSharpSample.mirrorv1.Methods
{
    ...
    public static class SubscriptionsSample
    {
        ...
        /// Documentation https://developers.google.com/mirror/v1/reference/subscriptions/delete
        ...
        /// Documentation https://developers.google.com/mirror/v1/reference/subscriptions/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated mirror service.</param>  
        /// <param name="body">A valid mirror v1 body.</param>
        /// <returns>SubscriptionResponse</returns>
        public static Subscription Insert(mirrorService service, Subscription body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Subscriptions.Insert(body).Execute();
            }
            catch (Exception ex)
            {
