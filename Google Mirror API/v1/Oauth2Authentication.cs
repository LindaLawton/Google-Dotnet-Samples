...
namespace GoogleSamplecSharpSample.Mirrorv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>MirrorService used to make requests against the Mirror API</returns>
        public static MirrorService GetMirrorService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Mirror service failed.", ex);
            }
        }
        ...
        /// <returns>MirrorService used to make requests against the Mirror API</returns>
        private static MirrorService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
