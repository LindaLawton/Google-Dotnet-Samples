...
namespace GoogleSamplecSharpSample.Mirrorv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static MirrorService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { MirrorService.Scope.GlassLocation,	//View your location
                                                 MirrorService.Scope.GlassTimeline};	//View and manage your Glass timeline
                ...
                return new MirrorService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Mirror Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account MirrorService failed" + ex.Message);
                throw new Exception("CreateServiceAccountMirrorFailed", ex);
			}
        }
        ...
        public static MirrorService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
