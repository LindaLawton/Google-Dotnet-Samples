...
namespace GoogleSamplecSharpSample.Streetviewpublishv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>StreetviewpublishService used to make requests against the Streetviewpublish API</returns>
        public static StreetviewpublishService GetStreetviewpublishService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Streetviewpublish service failed.", ex);
            }
        }
        ...
        /// <returns>StreetviewpublishService used to make requests against the Streetviewpublish API</returns>
        private static StreetviewpublishService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Streetviewpublish API service.
                return new StreetviewpublishService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Streetviewpublish Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
