...
namespace GoogleSamplecSharpSample.Streetviewpublishv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static StreetviewpublishService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new StreetviewpublishService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Streetviewpublish Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Streetviewpublish service.
                    return new StreetviewpublishService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Streetviewpublish Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountStreetviewpublishFailed", ex);
            }
        }
    }
}