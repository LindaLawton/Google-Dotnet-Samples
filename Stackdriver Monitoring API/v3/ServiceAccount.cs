...
namespace GoogleSamplecSharpSample.Monitoringv3.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static MonitoringService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new MonitoringService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Monitoring Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Monitoring Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account MonitoringService failed" + ex.Message);
