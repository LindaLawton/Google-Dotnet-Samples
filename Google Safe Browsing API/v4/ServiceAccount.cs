...
namespace GoogleSamplecSharpSample.Safebrowsingv4.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static SafebrowsingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new SafebrowsingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Safebrowsing Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Safebrowsing service.
                    return new SafebrowsingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Safebrowsing Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountSafebrowsingFailed", ex);
            }
        }
    }
}