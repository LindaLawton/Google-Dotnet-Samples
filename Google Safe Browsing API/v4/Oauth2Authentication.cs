...
namespace GoogleSamplecSharpSample.Safebrowsingv4.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SafebrowsingService used to make requests against the Safebrowsing API</returns>
        public static SafebrowsingService GetSafebrowsingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Safebrowsing service failed.", ex);
            }
        }
        ...
        /// <returns>SafebrowsingService used to make requests against the Safebrowsing API</returns>
        private static SafebrowsingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Safebrowsing API service.
                return new SafebrowsingService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Safebrowsing Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
