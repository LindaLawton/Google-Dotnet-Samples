...
namespace GoogleSamplecSharpSample.Safebrowsingv4.Methods
{
    ...
    public static class EncodedUpdatesSample
    {

        public class EncodedUpdatesGetOptionalParms
        {
            /// The version of the client implementation.
            public string ClientVersion { get; set; }  
            /// A client ID that uniquely identifies the client implementation of the SafeBrowsing API.
        ...
        /// <summary>
        ///  
        /// Documentation https://developers.google.com/safebrowsing/v4/reference/encodedUpdates/get
        ...
        public static FetchThreatListUpdatesResponse Get(SafebrowsingService service, string encodedRequest, EncodedUpdatesGetOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.EncodedUpdates.Get(encodedRequest);

                // Applying optional parameters to the request.                
                request = (EncodedUpdatesResource.GetRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request EncodedUpdates.Get failed.", ex);
            }
        }
