...
namespace GoogleSamplecSharpSample.Safebrowsingv4.Auth
{
    ...
    {
        /// <summary>
        /// Get a valid SafebrowsingService for a public API Key.
        /// </summary>
        /// <param name="apiKey">API key from Google Developer console</param>
		/// <returns>SafebrowsingService</returns>
        public static SafebrowsingService GetService(string apiKey)
        {
            try
            {
            ...
            {
                throw new Exception("Failed to create new Safebrowsing Service", ex);
            }
        }
    }
}
