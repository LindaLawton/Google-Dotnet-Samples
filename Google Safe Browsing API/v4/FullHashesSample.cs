...
namespace GoogleSamplecSharpSample.Safebrowsingv4.Methods
{
    ...
    public static class FullHashesSample
    {


        /// <summary>
        /// Finds the full hashes that match the requested hash prefixes. 
        /// Documentation https://developers.google.com/safebrowsing/v4/reference/fullHashes/find
        ...
        public static FindFullHashesResponse Find(SafebrowsingService service, FindFullHashesRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.FullHashes.Find(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request FullHashes.Find failed.", ex);
            }
        }
