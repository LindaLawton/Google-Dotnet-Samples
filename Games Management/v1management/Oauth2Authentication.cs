...
namespace GoogleSamplecSharpSample.Gamesmanagementv1management.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GamesmanagementService used to make requests against the Gamesmanagement API</returns>
        public static GamesmanagementService GetGamesmanagementService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Gamesmanagement service failed.", ex);
            }
        }
        ...
        /// <returns>GamesmanagementService used to make requests against the Gamesmanagement API</returns>
        private static GamesmanagementService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Gamesmanagement API service.
                return new GamesmanagementService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Gamesmanagement Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
