...
namespace GoogleSamplecSharpSample.Gamesmanagementv1management.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static GamesmanagementService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new GamesmanagementService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Gamesmanagement Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Gamesmanagement service.
                    return new GamesmanagementService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Gamesmanagement Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountGamesmanagementFailed", ex);
            }
        }
    }
}