...
namespace GoogleSamplecSharpSample.Cloudbuildv1.Methods
{
    ...
    public static class BuildsSample
    {
        ...
        public class BuildsListOptionalParms
        {
        ...
        /// <returns>ListBuildsResponseResponse</returns>
        ...
        /// Documentation https://developers.google.com/cloudbuild/v1/reference/builds/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Cloudbuild service.</param>  
        /// <param name="projectId">ID of the project.</param>
        /// <param name="id">ID of the build.</param>
        /// <returns>BuildResponse</returns>
        public static Build Get(CloudbuildService service, string projectId, string id)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Builds.Get(projectId, id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Builds.Get failed.", ex);
            }
        }
