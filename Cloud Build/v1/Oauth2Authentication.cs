...
namespace GoogleSamplecSharpSample.Cloudbuildv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudbuildService used to make requests against the Cloudbuild API</returns>
        public static CloudbuildService GetCloudbuildService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudbuild service failed.", ex);
            }
        }
        ...
        /// <returns>CloudbuildService used to make requests against the Cloudbuild API</returns>
        private static CloudbuildService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudbuild API service.
                return new CloudbuildService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudbuild Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
