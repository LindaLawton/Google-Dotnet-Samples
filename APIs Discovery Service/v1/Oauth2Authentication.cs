...
namespace GoogleSamplecSharpSample.Discoveryv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DiscoveryService used to make requests against the Discovery API</returns>
        public static DiscoveryService GetDiscoveryService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Discovery service failed.", ex);
            }
        }
        ...
        /// <returns>DiscoveryService used to make requests against the Discovery API</returns>
        private static DiscoveryService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Discovery API service.
                return new DiscoveryService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Discovery Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
