...
namespace GoogleSamplecSharpSample.Discoveryv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static DiscoveryService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DiscoveryService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Discovery Service account Authentication Sample",
                    });
                }
            ...
            {                
                throw new Exception("CreateServiceAccountDiscoveryFailed", ex);
            }
        }
    }
}