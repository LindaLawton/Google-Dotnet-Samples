...
namespace GoogleSamplecSharpSample.Monitoringv3.Methods
{
    ...
    public static class MetricDescriptorsSample
    {
        ...
        /// Documentation https://developers.google.com/monitoring/v3/reference/metricDescriptors/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Monitoring service.</param>  
        /// <param name="name">The metric descriptor on which to execute the request. The format is "projects/{project_id_or_number}/metricDescriptors/{metric_id}". An example value of {metric_id} is "compute.googleapis.com/instance/disk/read_bytes_count".</param>
        /// <returns>MetricDescriptorResponse</returns>
        public static MetricDescriptor Get(MonitoringService service, string name)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.MetricDescriptors.Get(name).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request MetricDescriptors.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/monitoring/v3/reference/metricDescriptors/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Monitoring service.</param>  
        ...
        public static ListMetricDescriptorsResponse List(MonitoringService service, string name, MetricDescriptorsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.MetricDescriptors.List(name);
        ...
        /// Documentation https://developers.google.com/monitoring/v3/reference/metricDescriptors/create
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Monitoring service.</param>  
        /// <param name="name">The project on which to execute the request. The format is "projects/{project_id_or_number}".</param>
        ...
        /// <returns>MetricDescriptorResponse</returns>
        public static MetricDescriptor Create(MonitoringService service, string name, MetricDescriptor body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.MetricDescriptors.Create(body, name).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/monitoring/v3/reference/metricDescriptors/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Monitoring service.</param>  
        /// <param name="name">The metric descriptor on which to execute the request. The format is "projects/{project_id_or_number}/metricDescriptors/{metric_id}". An example of {metric_id} is: "custom.googleapis.com/my_test_metric".</param>
        /// <returns>EmptyResponse</returns>
        public static Empty Delete(MonitoringService service, string name)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.MetricDescriptors.Delete(name).Execute();
            }
            catch (Exception ex)
            {
