...
namespace GoogleSamplecSharpSample.Monitoringv3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>MonitoringService used to make requests against the Monitoring API</returns>
        public static MonitoringService GetMonitoringService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Monitoring service failed.", ex);
            }
        }
        ...
        /// <returns>MonitoringService used to make requests against the Monitoring API</returns>
        private static MonitoringService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
