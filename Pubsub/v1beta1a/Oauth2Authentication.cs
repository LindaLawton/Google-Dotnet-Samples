...
namespace GoogleSamplecSharpSample.Pubsubv1beta1a.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>PubsubService used to make requests against the Pubsub API</returns>
        public static PubsubService GetPubsubService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Pubsub service failed.", ex);
            }
        }
        ...
        /// <returns>PubsubService used to make requests against the Pubsub API</returns>
        private static PubsubService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
