...
// About 
// 
// Unoffical sample for the CloudNaturalLanguage v1beta1 API for C#. 
...
//
// Discovery Doc  https://www.googleapis.com/discovery/v1/apis/CloudNaturalLanguage/v1beta1/rest
//
//------------------------------------------------------------------------------
// Installation
//
...
// NuGet package:
//
// Location: https://www.nuget.org/packages/Google.Apis.CloudNaturalLanguage.v1beta1/ 
// Install Command: PM>  Install-Package Google.Apis.CloudNaturalLanguage.v1beta1
//
//------------------------------------------------------------------------------  
using Google.Apis.CloudNaturalLanguage.v1beta1;
using Google.Apis.CloudNaturalLanguage.v1beta1.Data;
using System;

namespace GoogleSamplecSharpSample.CloudNaturalLanguagev1beta1.Methods
{
    ...
    public static class DocumentsSample
    {
        ...
        /// Documentation https://developers.google.com/cloudnaturallanguage/v1beta1/reference/documents/analyzeSentiment
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudNaturalLanguage service.</param>  
        /// <param name="body">A valid CloudNaturalLanguage v1beta1 body.</param>
...
properties. 
        /// Documentation https://developers.google.com/cloudnaturallanguage/v1beta1/reference/documents/analyzeSyntax
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudNaturalLanguage service.</param>  
        /// <param name="body">A valid CloudNaturalLanguage v1beta1 body.</param>
...
analyzeEntities, and analyzeSyntax provide in one call. 
        /// Documentation https://developers.google.com/cloudnaturallanguage/v1beta1/reference/documents/annotateText
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudNaturalLanguage service.</param>  
        /// <param name="body">A valid CloudNaturalLanguage v1beta1 body.</param>
...
entity types, salience, mentions for each entity, and other properties. 
        /// Documentation https://developers.google.com/cloudnaturallanguage/v1beta1/reference/documents/analyzeEntities
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated CloudNaturalLanguage service.</param>  
        /// <param name="body">A valid CloudNaturalLanguage v1beta1 body.</param>
