...
namespace GoogleSamplecSharpSample.Speechv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SpeechService used to make requests against the Speech API</returns>
        public static SpeechService GetSpeechService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Speech service failed.", ex);
            }
        }
        ...
        /// <returns>SpeechService used to make requests against the Speech API</returns>
        private static SpeechService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
