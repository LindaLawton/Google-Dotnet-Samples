...
namespace GoogleSamplecSharpSample.Genomicsv1alpha2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static GenomicsService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new GenomicsService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Genomics Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Genomics Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account GenomicsService failed" + ex.Message);
