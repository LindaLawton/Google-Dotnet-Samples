...
namespace GoogleSamplecSharpSample.Genomicsv1alpha2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>GenomicsService used to make requests against the Genomics API</returns>
        public static GenomicsService GetGenomicsService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Genomics service failed.", ex);
            }
        }
        ...
        /// <returns>GenomicsService used to make requests against the Genomics API</returns>
        private static GenomicsService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
