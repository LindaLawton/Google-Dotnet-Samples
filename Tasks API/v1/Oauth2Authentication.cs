...
namespace GoogleSamplecSharpSample.Tasksv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static TasksService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { TasksService.Scope.TasksReadonly,	//View your tasks
                ...
                return new TasksService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Tasks Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account TasksService failed" + ex.Message);
                throw new Exception("CreateServiceAccountTasksFailed", ex);
			}
        }
        ...
        public static TasksService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
