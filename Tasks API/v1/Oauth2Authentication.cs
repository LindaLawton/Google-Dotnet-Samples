...
namespace GoogleSamplecSharpSample.Tasksv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>TasksService used to make requests against the Tasks API</returns>
        public static TasksService GetTasksService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Tasks service failed.", ex);
            }
        }
        ...
        /// <returns>TasksService used to make requests against the Tasks API</returns>
        private static TasksService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
