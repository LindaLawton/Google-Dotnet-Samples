...
namespace GoogleSamplecSharpSample.Tasksv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static TasksService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new TasksService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Tasks Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Tasks Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account TasksService failed" + ex.Message);
