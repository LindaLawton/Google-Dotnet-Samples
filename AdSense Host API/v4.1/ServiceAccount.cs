...
namespace GoogleSamplecSharpSample.AdSense Hostv4.1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static AdSense HostService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AdSense HostService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "AdSense Host Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  AdSense Host service.
                    return new AdSense HostService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "AdSense Host Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account AdSense HostService failed" + ex.Message);
