...
{  
    public static class Oauth2Example 
    {
        ...
        public static AdSense HostService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { AdSense HostService.Scope.Adsensehost};	//View and manage your AdSense host data and associated accounts
                ...
                return new AdSense HostService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "AdSense Host Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account AdSense HostService failed" + ex.Message);
                throw new Exception("CreateServiceAccountAdSense HostFailed", ex);
			}
        }
        ...
        public static AdSense HostService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
