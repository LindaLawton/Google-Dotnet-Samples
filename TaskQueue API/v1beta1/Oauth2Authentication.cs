...
namespace GoogleSamplecSharpSample.Taskqueuev1beta1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>TaskqueueService used to make requests against the Taskqueue API</returns>
        public static TaskqueueService GetTaskqueueService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Taskqueue service failed.", ex);
            }
        }
        ...
        /// <returns>TaskqueueService used to make requests against the Taskqueue API</returns>
        private static TaskqueueService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
