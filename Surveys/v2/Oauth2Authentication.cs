...
namespace GoogleSamplecSharpSample.Surveysv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SurveysService used to make requests against the Surveys API</returns>
        public static SurveysService GetSurveysService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Surveys service failed.", ex);
            }
        }
        ...
        /// <returns>SurveysService used to make requests against the Surveys API</returns>
        private static SurveysService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
