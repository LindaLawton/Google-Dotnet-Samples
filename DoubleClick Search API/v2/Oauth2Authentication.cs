...
//     Build date: 01/02/2017 22:32:45
...
{  
    public static class Oauth2Example 
    {
        ...
        public static DoubleclicksearchService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { DoubleclicksearchService.Scope.Doubleclicksearch};	//View and manage your advertising data in DoubleClick Search
                ...
                return new DoubleclicksearchService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Doubleclicksearch Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account DoubleclicksearchService failed" + ex.Message);
                throw new Exception("CreateServiceAccountDoubleclicksearchFailed", ex);
			}
        }
        ...
        public static DoubleclicksearchService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
