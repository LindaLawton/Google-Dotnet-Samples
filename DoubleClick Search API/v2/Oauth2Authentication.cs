...
namespace GoogleSamplecSharpSample.Doubleclicksearchv2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DoubleclicksearchService used to make requests against the Doubleclicksearch API</returns>
        public static DoubleclicksearchService GetDoubleclicksearchService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Doubleclicksearch service failed.", ex);
            }
        }
        ...
        /// <returns>DoubleclicksearchService used to make requests against the Doubleclicksearch API</returns>
        private static DoubleclicksearchService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Doubleclicksearch API service.
