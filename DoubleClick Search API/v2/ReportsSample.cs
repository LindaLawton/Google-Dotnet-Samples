    ...
    public static class ReportsSample
    {
        ...
        public static void GetFile(doubleclicksearchService service, string reportId, int reportFragment)
        {
            try
            {
                ...
                // Make the request.
                return service.Reports.GetFile(reportId, reportFragment).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/doubleclicksearch/v2/reference/reports/request
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated doubleclicksearch service.</param>  
        /// <param name="body">A valid doubleclicksearch v2 body.</param>
        /// <returns>ReportResponse</returns>
        public static Report Request(doubleclicksearchService service, ReportRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Reports.Request(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Reports.Request failed.", ex);
            }
        }
