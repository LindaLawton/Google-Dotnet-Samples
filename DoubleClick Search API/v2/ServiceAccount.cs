...
namespace GoogleSamplecSharpSample.Doubleclicksearchv2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static DoubleclicksearchService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DoubleclicksearchService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Doubleclicksearch Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Doubleclicksearch service.
                    return new DoubleclicksearchService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Doubleclicksearch Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account DoubleclicksearchService failed" + ex.Message);
