...
namespace GoogleSamplecSharpSample.Servicecontrolv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>ServicecontrolService used to make requests against the Servicecontrol API</returns>
        public static ServicecontrolService GetServicecontrolService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Servicecontrol service failed.", ex);
            }
        }
        ...
        /// <returns>ServicecontrolService used to make requests against the Servicecontrol API</returns>
        private static ServicecontrolService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Servicecontrol API service.
                return new ServicecontrolService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Servicecontrol Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
