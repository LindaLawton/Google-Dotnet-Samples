...
namespace GoogleSamplecSharpSample.Servicecontrolv1.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static ServicecontrolService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ServicecontrolService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Servicecontrol Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Servicecontrol service.
                    return new ServicecontrolService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Servicecontrol Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountServicecontrolFailed", ex);
            }
        }
    }
}