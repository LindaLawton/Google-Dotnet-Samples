...
namespace GoogleSamplecSharpSample.Cloudmonitoringv2beta2.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>CloudmonitoringService used to make requests against the Cloudmonitoring API</returns>
        public static CloudmonitoringService GetCloudmonitoringService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Cloudmonitoring service failed.", ex);
            }
        }
        ...
        /// <returns>CloudmonitoringService used to make requests against the Cloudmonitoring API</returns>
        private static CloudmonitoringService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Cloudmonitoring API service.
                return new CloudmonitoringService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Cloudmonitoring Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
