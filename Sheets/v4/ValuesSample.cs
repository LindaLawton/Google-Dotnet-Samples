...
namespace GoogleSamplecSharpSample.Sheetsv4.Methods
{
    ...
    public static class ValuesSample
    {
        ...
        public class ValuesGetOptionalParms
        {
            ...
            /// How dates, times, and durations should be represented in the output.This is ignored if value_render_option isFORMATTED_VALUE.The default dateTime render option is [DateTimeRenderOption.SERIAL_NUMBER].
        ...
        /// <returns>ValueRangeResponse</returns>
        ...
        public class ValuesUpdateOptionalParms
        {
            ...
            /// Determines how dates, times, and durations in the response should berendered. This is ignored if response_value_render_option isFORMATTED_VALUE.The default dateTime render option is [DateTimeRenderOption.SERIAL_NUMBER].
            public string ResponseDateTimeRenderOption { get; set; }  
            /// Determines if the update response should include the valuesof the cells that were updated. By default, responsesdo not include the updated values.If the range to write was larger than than the range actually written,the response will include all values in the requested range (excludingtrailing empty rows and columns).
        ...
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>UpdateValuesResponseResponse</returns>
        ...
        /// <param name="spreadsheetId">The ID of the spreadsheet to retrieve data from.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>BatchGetValuesResponseResponse</returns>
        ...
        public class ValuesAppendOptionalParms
        {
            ...
            /// Determines how dates, times, and durations in the response should berendered. This is ignored if response_value_render_option isFORMATTED_VALUE.The default dateTime render option is [DateTimeRenderOption.SERIAL_NUMBER].
            public string ResponseDateTimeRenderOption { get; set; }  
            /// Determines if the update response should include the valuesof the cells that were appended. By default, responsesdo not include the updated values.
            public bool? IncludeValuesInResponse { get; set; }  
        ...
        /// <param name="service">Authenticated Sheets service.</param>  
        /// <param name="spreadsheetId">The ID of the spreadsheet to update.</param>
        /// <param name="range">The A1 notation of a range to search for a logical table of data.Values will be appended after the last row of the table.</param>
        /// <param name="body">A valid Sheets v4 body.</param>
        /// <param name="optional">Optional paramaters.</param>
        /// <returns>AppendValuesResponseResponse</returns>
