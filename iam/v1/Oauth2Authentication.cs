...
namespace GoogleSamplecSharpSample.Iamv1.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>IamService used to make requests against the Iam API</returns>
        public static IamService GetIamService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Iam service failed.", ex);
            }
        }
        ...
        /// <returns>IamService used to make requests against the Iam API</returns>
        private static IamService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
