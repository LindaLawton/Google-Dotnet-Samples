...
namespace GoogleSamplecSharpSample.Storagev1beta2.Auth
{
    ...
    {
        public static StorageService GetService(string apiKey)
        {
            try
            {
                ...
                {
                    ApiKey = apiKey,
                    ApplicationName = "Storage API key example",
                });
            }
            catch (Exception ex)
            {
                throw new Exception("Failed to create new Storage Service", ex);
            }
        }
    }
}
