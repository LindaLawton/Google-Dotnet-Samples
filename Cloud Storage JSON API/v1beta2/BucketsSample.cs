...
namespace GoogleSamplecSharpSample.storagev1beta2.Methods
{
    ...
    public static class BucketsSample
    {
        ...
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/delete
        ...
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        ...
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="project">A valid API project identifier.</param>
        ...
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// <summary>
        /// Updates a bucket. 
        /// Documentation https://developers.google.com/storage/v1beta2/reference/buckets/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
