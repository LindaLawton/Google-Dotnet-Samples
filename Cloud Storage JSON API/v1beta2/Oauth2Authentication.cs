...
namespace GoogleSamplecSharpSample.Storagev1beta2.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static StorageService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { StorageService.Scope.DevstorageFull_Control,	//Manage your data and permissions in Google Cloud Storage
