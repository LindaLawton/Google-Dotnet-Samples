...
namespace GoogleSamplecSharpSample.Storagev1beta2.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static StorageService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new StorageService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Storage Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Storage Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account StorageService failed" + ex.Message);
