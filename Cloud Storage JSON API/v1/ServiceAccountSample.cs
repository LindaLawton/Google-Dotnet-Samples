...
namespace GoogleSamplecSharpSample.Storagev1.Methods
{
    ...
    public static class ServiceAccountSample
    {


        /// <summary>
        /// Get the email address of this project's GCS service account. 
        /// Documentation https://developers.google.com/storage/v1/reference/serviceAccount/get
        ...
        public static ServiceAccount Get(StorageService service, string projectId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.ServiceAccount.Get(projectId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ServiceAccount.Get failed.", ex);
            }
        }
