...
namespace GoogleSamplecSharpSample.storagev1.Methods
{
    ...
    public static class ObjectAccessControlsSample
    {
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/delete
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Delete(storageService service, string bucket, string object, string entity, ObjectAccessControlsDeleteOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        /// <param name="object">Name of the object. For information about how to URL encode object names to be path safe, see Encoding URI Path Parts.</param>
        /// <param name="entity">The entity holding the permission. Can be user-userId, user-emailAddress, group-groupId, group-emailAddress, allUsers, or allAuthenticatedUsers.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ObjectAccessControlResponse</returns>
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// Documentation https://developers.google.com/storage/v1/reference/objectAccessControls/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
