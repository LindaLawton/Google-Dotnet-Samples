...
namespace GoogleSamplecSharpSample.storagev1beta1.Methods
{
    ...
    public static class BucketsSample
    {
        ...
        /// Documentation https://developers.google.com/storage/v1beta1/reference/buckets/delete
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        public static void Delete(storageService service, string bucket)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Buckets.Delete(bucket).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/storage/v1beta1/reference/buckets/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="body">A valid storage v1beta1 body.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>BucketResponse</returns>
        public static Bucket Insert(storageService service, Bucket body, BucketsInsertOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Buckets.Insert(body);
        ...
        /// Documentation https://developers.google.com/storage/v1beta1/reference/buckets/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        ...
        public static Buckets List(storageService service, string projectId, BucketsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// Documentation https://developers.google.com/storage/v1beta1/reference/buckets/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
        ...
        /// <summary>
        /// Updates a bucket. 
        /// Documentation https://developers.google.com/storage/v1beta1/reference/buckets/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated storage service.</param>  
        /// <param name="bucket">Name of a bucket.</param>
