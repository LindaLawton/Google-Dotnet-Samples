...
//     Build date: 01/02/2017 22:33:20
...
namespace GoogleSamplecSharpSample.iamv1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static iamService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { iamService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new iamService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "iam Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account iamService failed" + ex.Message);
                throw new Exception("CreateServiceAccountiamFailed", ex);
			}
        }
        ...
        public static iamService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
