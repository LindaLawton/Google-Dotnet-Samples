...
namespace GoogleSamplecSharpSample.iamv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static iamService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new iamService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "iam Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  iam service.
                    return new iamService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "iam Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account iamService failed" + ex.Message);
