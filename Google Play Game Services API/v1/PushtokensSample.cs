...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class PushtokensSample
    {

        public class PushtokensRemoveOptionalParms
        {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Remove(GamesService service, PushTokenId body, PushtokensRemoveOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        public class PushtokensUpdateOptionalParms
        {
            /// The last-seen mutation timestamp.
            public string ConsistencyToken { get; set; }  
        ...
        /// Documentation https://developers.google.com/games/v1/reference/pushtokens/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="body">A valid Games v1 body.</param>
        /// <param name="optional">Optional paramaters.</param>        public static void Update(GamesService service, PushToken body, PushtokensUpdateOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                // Building the initial request.
                var request = service.Pushtokens.Update(body);

                // Applying optional parameters to the request.                
                request = (PushtokensResource.UpdateRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Pushtokens.Update failed.", ex);
            }
        }
