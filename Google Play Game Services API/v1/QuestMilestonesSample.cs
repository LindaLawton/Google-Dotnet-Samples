...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class QuestMilestonesSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        public static void Claim(GamesService service, string questId, string milestoneId, string requestId, QuestMilestonesClaimOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
