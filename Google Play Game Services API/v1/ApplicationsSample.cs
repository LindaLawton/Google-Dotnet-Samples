...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class ApplicationsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ApplicationResponse</returns>
        ...
        /// </summary>
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="optional">Optional paramaters.</param>        public static void Played(GamesService service, ApplicationsPlayedOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="applicationId">The application ID from the Google Play developer console.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>ApplicationVerifyResponseResponse</returns>
