...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class RoomsSample
    {
        ...
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="roomId">The ID of the room.</param>
        /// <param name="optional">Optional paramaters.</param>        public static void Dismiss(GamesService service, string roomId, RoomsDismissOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
        ...
        /// </summary>
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>RoomListResponse</returns>
        ...
        /// <param name="roomId">The ID of the room.</param>
        /// <param name="body">A valid Games v1 body.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>RoomStatusResponse</returns>
