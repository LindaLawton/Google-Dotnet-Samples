...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class EventsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>PlayerEventListResponseResponse</returns>
        ...
        /// </summary>
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>EventDefinitionListResponseResponse</returns>
