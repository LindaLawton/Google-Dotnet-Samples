...
namespace GoogleSamplecSharpSample.Gamesv1.Methods
{
    ...
    public static class LeaderboardsSample
    {
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LeaderboardResponse</returns>
        ...
        /// </summary>
        /// <param name="service">Authenticated Games service.</param>  
        /// <param name="optional">Optional paramaters.</param>        /// <returns>LeaderboardListResponseResponse</returns>
