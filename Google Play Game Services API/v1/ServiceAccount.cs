...
namespace GoogleSamplecSharpSample.Gamesv1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static GamesService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new GamesService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Games Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Games service.
                    return new GamesService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Games Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account GamesService failed" + ex.Message);
