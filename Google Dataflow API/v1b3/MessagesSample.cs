...
namespace GoogleSamplecSharpSample.Dataflowv1b3.Methods
{
    ...
    public static class MessagesSample
    {
        ...
        public class MessagesListOptionalParms
        {
            ...
            /// If supplied, this should be the value of next_page_token returnedby an earlier call. This will cause the next page of results tobe returned.
            public string PageToken { get; set; }  
            /// If specified, determines the maximum number of messages toreturn.  If unspecified, the service may choose an appropriatedefault, or may return an arbitrarily large number of results.
        ...
        /// <returns>ListJobMessagesResponseResponse</returns>
        public static ListJobMessagesResponse List(DataflowService service, string projectId, string jobId, MessagesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Messages.List(projectId, jobId);
