...
namespace GoogleSamplecSharpSample.Dataflowv1b3.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static DataflowService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DataflowService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Dataflow Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Dataflow service.
                    return new DataflowService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Dataflow Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account DataflowService failed" + ex.Message);
