...
{  
    public static class Oauth2Example 
    {
        ...
        public static DataflowService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { DataflowService.Scope.Cloud-Platform,	//View and manage your data across Google Cloud Platform services
                                                 DataflowService.Scope.UserinfoEmail};	//View your email address
                ...
                return new DataflowService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Dataflow Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account DataflowService failed" + ex.Message);
                throw new Exception("CreateServiceAccountDataflowFailed", ex);
			}
        }
        ...
        public static DataflowService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
