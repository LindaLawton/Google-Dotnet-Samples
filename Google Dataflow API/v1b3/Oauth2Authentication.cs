...
namespace GoogleSamplecSharpSample.Dataflowv1b3.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DataflowService used to make requests against the Dataflow API</returns>
        public static DataflowService GetDataflowService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Dataflow service failed.", ex);
            }
        }
        ...
        /// <returns>DataflowService used to make requests against the Dataflow API</returns>
        private static DataflowService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
