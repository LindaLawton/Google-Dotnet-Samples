...
namespace GoogleSamplecSharpSample.Dataflowv1b3.Methods
{
    ...
    public static class WorkItemsSample
    {
        ...
        public static ReportWorkItemStatusResponse ReportStatus(DataflowService service, string projectId, string jobId, ReportWorkItemStatusRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.WorkItems.ReportStatus(body, projectId, jobId).Execute();
            }
            catch (Exception ex)
            {
        ...
        public static LeaseWorkItemResponse Lease(DataflowService service, string projectId, string jobId, LeaseWorkItemRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.WorkItems.Lease(body, projectId, jobId).Execute();
            }
            catch (Exception ex)
            {
