...
namespace GoogleSamplecSharpSample.Clouderrorreportingv1beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static ClouderrorreportingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new ClouderrorreportingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Clouderrorreporting Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Clouderrorreporting service.
                    return new ClouderrorreportingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Clouderrorreporting Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account ClouderrorreportingService failed" + ex.Message);
