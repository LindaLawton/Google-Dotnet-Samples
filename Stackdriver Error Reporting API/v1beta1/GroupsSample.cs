...
Fails if the group does not exist. 
        ...
        /// <param name="name">The group resource name.
Example: <code>projects/my-project-123/groups/my-groupid</code></param>
        ...
        /// </summary>
        /// <param name="service">Authenticated Clouderrorreporting service.</param>  
        /// <param name="groupName">[Required] The group resource name. Written as
...
Example: <code>projects/my-project-123/groups/my-group</code></param>
        /// <returns>ErrorGroupResponse</returns>
