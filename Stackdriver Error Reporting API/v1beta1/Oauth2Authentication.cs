...
{  
    public static class Oauth2Example 
    {
        ...
        public static ClouderrorreportingService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { ClouderrorreportingService.Scope.Cloud-Platform};	//View and manage your data across Google Cloud Platform services
                ...
                return new ClouderrorreportingService(new BaseClientService.Initializer()
                {
                    ...
                    ApplicationName = "Clouderrorreporting Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account ClouderrorreportingService failed" + ex.Message);
                throw new Exception("CreateServiceAccountClouderrorreportingFailed", ex);
			}
        }
        ...
        public static ClouderrorreportingService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
