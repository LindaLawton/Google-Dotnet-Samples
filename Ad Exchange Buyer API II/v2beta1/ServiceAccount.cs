...
namespace GoogleSamplecSharpSample.AdExchangeBuyerIIv2beta1.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static AdExchangeBuyerIIService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new AdExchangeBuyerIIService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "AdExchangeBuyerII Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  AdExchangeBuyerII service.
                    return new AdExchangeBuyerIIService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "AdExchangeBuyerII Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account AdExchangeBuyerIIService failed" + ex.Message);
