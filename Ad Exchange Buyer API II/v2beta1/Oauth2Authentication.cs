...
namespace GoogleSamplecSharpSample.AdExchangeBuyerIIv2beta1.Auth
{  
    public static class Oauth2Example 
    {
        ...
        public static AdExchangeBuyerIIService AuthenticateOauth(string clientSecretJson, string userName)
        {
            try
            {
                ...
                string[] scopes = new string[] { AdExchangeBuyerIIService.Scope.AdexchangeBuyer};	//Manage your Ad Exchange buyer account configuration
                ...
                return new AdExchangeBuyerIIService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "AdExchangeBuyerII Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
                Console.WriteLine("Create Oauth2 account AdExchangeBuyerIIService failed" + ex.Message);
                throw new Exception("CreateServiceAccountAdExchangeBuyerIIFailed", ex);
			}
        }
        ...
        public static AdExchangeBuyerIIService AuthenticateOauth(string clientId, string clientSecret, string userName)
        {
            try
            {
