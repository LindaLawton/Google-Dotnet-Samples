    ...
    public static class ScoresSample
    {
        ...
        public static void ResetAllForAllPlayers(GamesManagementService service)
        {
            try
            {
                ...
                // Make the request.
                return service.Scores.ResetAllForAllPlayers().Execute();
            }
            catch (Exception ex)
            {
        ...
        public static void ResetForAllPlayers(GamesManagementService service, string leaderboardId)
        {
            try
            {
                ...
                // Make the request.
                return service.Scores.ResetForAllPlayers(leaderboardId).Execute();
            }
            catch (Exception ex)
            {
        ...
        public static void ResetMultipleForAllPlayers(GamesManagementService service, ScoresResetMultipleForAllRequest body)
        {
            try
            {
                ...
                // Make the request.
                return service.Scores.ResetMultipleForAllPlayers(body).Execute();
            }
            catch (Exception ex)
            {
