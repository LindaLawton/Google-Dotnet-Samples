...
namespace GoogleSamplecSharpSample.GamesManagementv1management.Methods
{
    ...
    public static class RoomsSample
    {
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/rooms/reset
        ...
        public static void Reset(GamesManagementService service)
        {
            try
            {
                ...
                // Make the request.
                return service.Rooms.Reset().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Rooms.Reset failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/rooms/resetForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated GamesManagement service.</param>  
        public static void ResetForAllPlayers(GamesManagementService service)
        {
            try
            {
                ...
                // Make the request.
                return service.Rooms.ResetForAllPlayers().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Rooms.ResetForAllPlayers failed.", ex);
            }
        }
