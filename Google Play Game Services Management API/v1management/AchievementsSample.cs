...
namespace GoogleSamplecSharpSample.GamesManagementv1management.Methods
{
    ...
    public static class AchievementsSample
    {
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/achievements/resetAll
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated GamesManagement service.</param>  
        /// <returns>AchievementResetAllResponseResponse</returns>
        public static AchievementResetAllResponse ResetAll(GamesManagementService service)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Achievements.ResetAll().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Achievements.ResetAll failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/achievements/resetAllForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated GamesManagement service.</param>  
        public static void ResetAllForAllPlayers(GamesManagementService service)
        {
            try
            {
                ...
                // Make the request.
                return service.Achievements.ResetAllForAllPlayers().Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Achievements.ResetAllForAllPlayers failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/achievements/resetForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated GamesManagement service.</param>  
        /// <param name="achievementId">The ID of the achievement used by this method.</param>
        public static void ResetForAllPlayers(GamesManagementService service, string achievementId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Achievements.ResetForAllPlayers(achievementId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Achievements.ResetForAllPlayers failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/gamesmanagement/v1management/reference/achievements/resetMultipleForAllPlayers
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated GamesManagement service.</param>  
        /// <param name="body">A valid GamesManagement v1management body.</param>
        public static void ResetMultipleForAllPlayers(GamesManagementService service, AchievementResetMultipleForAllRequest body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Achievements.ResetMultipleForAllPlayers(body).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Achievements.ResetMultipleForAllPlayers failed.", ex);
            }
        }
