...
namespace GoogleSamplecSharpSample.AdSensev1_3.Methods
{
    ...
    public static class CustomchannelsSample
    {
        ...
        /// Documentation https://developers.google.com/adsense/v1.3/reference/customchannels/list
        ...
        public static CustomChannels List(AdSenseService service, string adClientId, string adUnitId, CustomchannelsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Customchannels.List(adClientId, adUnitId);
