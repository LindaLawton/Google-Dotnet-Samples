...
using Google.Apis.Dfareporting.v2.8;
...
namespace GoogleSamplecSharpSample.Dfareportingv2.8.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>DfareportingService used to make requests against the Dfareporting API</returns>
        public static DfareportingService GetDfareportingService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Dfareporting service failed.", ex);
            }
        }
        ...
        /// <returns>DfareportingService used to make requests against the Dfareporting API</returns>
        private static DfareportingService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Dfareporting API service.
