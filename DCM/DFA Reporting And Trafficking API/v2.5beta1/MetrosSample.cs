...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class MetrosSample
    {


        /// <summary>
        /// Retrieves a list of metros. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/metros/list
        ...
        /// <returns>MetrosListResponseResponse</returns>
        public static MetrosListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Metros.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Metros.List failed.", ex);
            }
        }
