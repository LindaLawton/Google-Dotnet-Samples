...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class UserProfilesSample
    {


        /// <summary>
        /// Gets one user profile by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/userProfiles/get
        ...
        public static UserProfile Get(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.UserProfiles.Get(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request UserProfiles.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/userProfiles/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
