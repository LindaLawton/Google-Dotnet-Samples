...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class RemarketingListSharesSample
    {


        /// <summary>
        /// Gets one remarketing list share by remarketing list ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/remarketingListShares/get
        ...
        public static RemarketingListShare Get(dfareportingService service, string profileId, string remarketingListId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RemarketingListShares.Get(profileId, remarketingListId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request RemarketingListShares.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/remarketingListShares/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/remarketingListShares/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <param name="body">A valid dfareporting v2.5beta1 body.</param>
        /// <returns>RemarketingListShareResponse</returns>
        public static RemarketingListShare Update(dfareportingService service, string profileId, RemarketingListShare body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.RemarketingListShares.Update(body, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request RemarketingListShares.Update failed.", ex);
            }
        }
