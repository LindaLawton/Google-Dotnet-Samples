...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class EventTagsSample
    {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/delete
        ...
        public static void Delete(dfareportingService service, string profileId, string id)
        {
            try
            {
                ...
                // Make the request.
                return service.EventTags.Delete(profileId, id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/get
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>EventTagsListResponseResponse</returns>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/eventTags/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
