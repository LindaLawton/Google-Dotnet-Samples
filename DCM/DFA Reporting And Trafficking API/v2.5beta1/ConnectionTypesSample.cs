...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class ConnectionTypesSample
    {


        /// <summary>
        /// Gets one connection type by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/connectionTypes/get
        ...
        /// <returns>ConnectionTypeResponse</returns>
        public static ConnectionType Get(dfareportingService service, string profileId, string id)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.ConnectionTypes.Get(profileId, id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ConnectionTypes.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/connectionTypes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>ConnectionTypesListResponseResponse</returns>
        public static ConnectionTypesListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.ConnectionTypes.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request ConnectionTypes.List failed.", ex);
            }
        }
