...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class CreativesSample
    {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/creatives/get
        ...
        public static Creative Get(dfareportingService service, string profileId, string id)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Creatives.Get(profileId, id).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/creatives/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// <returns>CreativeResponse</returns>
        public static Creative Insert(dfareportingService service, string profileId, Creative body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Creatives.Insert(body, profileId).Execute();
            }
            catch (Exception ex)
            {
        ...
        public class CreativesListOptionalParms
        {
            ...
            public string CreativeFieldIds { get; set; }  
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/creatives/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CreativesListResponseResponse</returns>
        public static CreativesListResponse List(dfareportingService service, string profileId, CreativesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Creatives.List(profileId);
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/creatives/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/creatives/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <param name="body">A valid dfareporting v2.5beta1 body.</param>
        /// <returns>CreativeResponse</returns>
        public static Creative Update(dfareportingService service, string profileId, Creative body)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Creatives.Update(body, profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Creatives.Update failed.", ex);
            }
        }
