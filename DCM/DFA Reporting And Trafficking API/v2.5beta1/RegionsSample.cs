...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class RegionsSample
    {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/regions/list
        ...
        /// <returns>RegionsListResponseResponse</returns>
        public static RegionsListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Regions.List(profileId).Execute();
            }
            catch (Exception ex)
            {
