...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class PostalCodesSample
    {


        /// <summary>
        /// Gets one postal code by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/postalCodes/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/postalCodes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>PostalCodesListResponseResponse</returns>
        public static PostalCodesListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.PostalCodes.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request PostalCodes.List failed.", ex);
            }
        }
