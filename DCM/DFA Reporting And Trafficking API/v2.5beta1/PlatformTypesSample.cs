...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class PlatformTypesSample
    {


        /// <summary>
        /// Gets one platform type by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/platformTypes/get
        ...
        /// <returns>PlatformTypeResponse</returns>
        public static PlatformType Get(dfareportingService service, string profileId, string id)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.PlatformTypes.Get(profileId, id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request PlatformTypes.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/platformTypes/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
