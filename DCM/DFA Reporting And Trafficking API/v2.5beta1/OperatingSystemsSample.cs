...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class OperatingSystemsSample
    {


        /// <summary>
        /// Gets one operating system by DART ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/operatingSystems/get
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/operatingSystems/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>OperatingSystemsListResponseResponse</returns>
        public static OperatingSystemsListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.OperatingSystems.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request OperatingSystems.List failed.", ex);
            }
        }
