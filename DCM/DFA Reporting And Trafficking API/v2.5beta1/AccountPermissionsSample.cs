...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class AccountPermissionsSample
    {


        /// <summary>
        /// Gets one account permission by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/accountPermissions/get
        ...
        /// <returns>AccountPermissionResponse</returns>
        public static AccountPermission Get(dfareportingService service, string profileId, string id)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.AccountPermissions.Get(profileId, id).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request AccountPermissions.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/accountPermissions/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>AccountPermissionsListResponseResponse</returns>
        public static AccountPermissionsListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.AccountPermissions.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request AccountPermissions.List failed.", ex);
            }
        }
