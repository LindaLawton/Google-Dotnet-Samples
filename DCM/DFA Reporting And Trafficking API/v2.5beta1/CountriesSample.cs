...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class CountriesSample
    {


        /// <summary>
        /// Gets one country by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/countries/get
        ...
        public static Country Get(dfareportingService service, string profileId, string dartId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Countries.Get(profileId, dartId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Countries.Get failed.", ex);
            }
        }
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/countries/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <returns>CountriesListResponseResponse</returns>
        public static CountriesListResponse List(dfareportingService service, string profileId)
        {
            try
            {
                // Initial validation.
                ...
                // Make the request.
                return service.Countries.List(profileId).Execute();
            }
            catch (Exception ex)
            {
                throw new Exception("Request Countries.List failed.", ex);
            }
        }
