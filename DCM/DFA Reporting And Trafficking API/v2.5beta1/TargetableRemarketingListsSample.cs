...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class TargetableRemarketingListsSample
    {


        /// <summary>
        /// Gets one remarketing list by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/targetableRemarketingLists/get
        ...
        public class TargetableRemarketingListsListOptionalParms
        {
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/targetableRemarketingLists/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        /// <param name="advertiserId">Select only targetable remarketing lists targetable by these advertisers.</param>
        /// <param name="optional">Optional paramaters.</param>        /// <returns>TargetableRemarketingListsListResponseResponse</returns>
        public static TargetableRemarketingListsListResponse List(dfareportingService service, string profileId, string advertiserId, TargetableRemarketingListsListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.TargetableRemarketingLists.List(profileId, advertiserId);

                // Applying optional parameters to the request.                
                request = (TargetableRemarketingListsResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request TargetableRemarketingLists.List failed.", ex);
            }
        }
