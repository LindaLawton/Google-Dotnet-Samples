...
namespace GoogleSamplecSharpSample.dfareportingv2_5beta1.Methods
{
    ...
    public static class CitiesSample
    {

        public class CitiesListOptionalParms
        {
            /// Select only cities from these countries.
            public string CountryDartIds { get; set; }  
            /// Select only cities with these DART IDs.
            public string DartIds { get; set; }  
            /// Select only cities with names starting with this prefix.
            public string NamePrefix { get; set; }  
            /// Select only cities from these regions.
            public string RegionDartIds { get; set; }  
        
        }
 
        /// <summary>
        /// Retrieves a list of cities, possibly filtered. 
        /// Documentation https://developers.google.com/dfareporting/v2.5beta1/reference/cities/list
        ...
        /// <param name="optional">Optional paramaters.</param>        /// <returns>CitiesListResponseResponse</returns>
        public static CitiesListResponse List(dfareportingService service, string profileId, CitiesListOptionalParms optional = null)
        {
            try
            {
                // Initial validation.
                ...
                var request = service.Cities.List(profileId);

                // Applying optional parameters to the request.                
                request = (CitiesResource.ListRequest)SampleHelpers.ApplyOptionalParms(request, optional);
            ...
            {
                throw new Exception("Request Cities.List failed.", ex);
            }
        }
