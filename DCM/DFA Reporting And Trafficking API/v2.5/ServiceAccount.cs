...
//
//------------------------------------------------------------------------------  
using Google.Apis.Dfareporting.v2.5
...
namespace GoogleSamplecSharpSample.Dfareportingv2.5.Auth
{
    ...
    public class static ServiceAccountExample
    {
        ...
        public static DfareportingService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath)
        {
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new DfareportingService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Dfareporting Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Dfareporting service.
                    return new DfareportingService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Dfareporting Authentication Sample",
                    });
                }
                else
                {
            ...
            {
                Console.WriteLine("Create service account DfareportingService failed" + ex.Message);
