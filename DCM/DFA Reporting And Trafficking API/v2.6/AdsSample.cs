...
namespace GoogleSamplecSharpSample.dfareportingv2_6.Methods
{
    ...
    public static class AdsSample
    {
        ...
        /// <summary>
        /// Gets one ad by ID. 
        /// Documentation https://developers.google.com/dfareporting/v2.6/reference/ads/get
        ...
        /// <summary>
        /// Inserts a new ad. 
        /// Documentation https://developers.google.com/dfareporting/v2.6/reference/ads/insert
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.6/reference/ads/list
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.6/reference/ads/patch
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
        ...
        /// Documentation https://developers.google.com/dfareporting/v2.6/reference/ads/update
        /// Generation Note: This does not always build corectly.  Google needs to standardise things I need to figuer out which ones are wrong.
        /// </summary>
        /// <param name="service">Authenticated dfareporting service.</param>  
        /// <param name="profileId">User profile ID associated with this request.</param>
