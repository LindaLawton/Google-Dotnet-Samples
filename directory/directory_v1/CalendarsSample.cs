...
namespace GoogleSamplecSharpSample.Directorydirectory_v1.Methods
{
    ...
    public static class CalendarsSample
    {
        ...
        /// <param name="customer">The unique ID for the customer's G Suite account. As an account administrator, you can also use the my_customer alias to represent your account's customer ID.</param>
        ...
        public static void Delete(DirectoryService service, string customer, string calendarResourceId)
        {
            try
            {
                ...
                // Make the request.
                 service.Calendars.Delete(customer, calendarResourceId).Execute();
            }
            catch (Exception ex)
            {
        ...
        /// <returns>CalendarResourcesResponse</returns>
