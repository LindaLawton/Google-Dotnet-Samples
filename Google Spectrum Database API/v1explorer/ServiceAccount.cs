...
namespace GoogleSamplecSharpSample.Spectrumv1explorer.Auth
{
    ...
    public static class ServiceAccountExample
    {
        ...
        public static SpectrumService AuthenticateServiceAccount(string serviceAccountEmail, string serviceAccountCredentialFilePath, string[] scopes)
		{
            try
            {
                ...
                if (Path.GetExtension(serviceAccountCredentialFilePath).ToLower() == ".json")
                {
                    ...
                    return new SpectrumService(new BaseClientService.Initializer()
                    {
                        ...
                        ApplicationName = "Spectrum Service account Authentication Sample",
                    });
                }
                ...
                {   // If its a P12 file
                    ...
                    // Create the  Spectrum service.
                    return new SpectrumService(new BaseClientService.Initializer()
                    {
                        HttpClientInitializer = credential,
                        ApplicationName = "Spectrum Authentication Sample",
                    });
                }
                else
                {
            ...
            {                
                throw new Exception("CreateServiceAccountSpectrumFailed", ex);
            }
        }
    }
}