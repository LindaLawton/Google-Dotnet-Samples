...
namespace GoogleSamplecSharpSample.Spectrumv1explorer.Auth
{
    public static class Oauth2Example
    {
        ...
        /// <returns>SpectrumService used to make requests against the Spectrum API</returns>
        public static SpectrumService GetSpectrumService(string clientSecretJson, string userName, string[] scopes)
        {
            try
            {
            ...
            {
                throw new Exception("Get Spectrum service failed.", ex);
            }
        }
        ...
        /// <returns>SpectrumService used to make requests against the Spectrum API</returns>
        private static SpectrumService GetService(UserCredential credential)
        {
            try
            {
                if (credential == null)
                ...
                // Create Spectrum API service.
                return new SpectrumService(new BaseClientService.Initializer()
                {
                    HttpClientInitializer = credential,
                    ApplicationName = "Spectrum Oauth2 Authentication Sample"
                });
            }
            catch (Exception ex)
            {
